...
Change Our component usage documentation typically contains three parts: usage
...
All accordion titles are set in sentence case. See the accordion content
...
| ---------------- | ---------------------- | -------- | ------------- |
| `Example: Title` | `Example: margin-left` | `16 / 1` | `$spacing-05` |
