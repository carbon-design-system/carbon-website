...
### Usage template: for components with 1 variant
...
The style template helps describes how a component looks, including visual
specifications such as color, typography, and structure.
...
<AnchorLink>Structure</AnchorLink> <AnchorLink>Modifiers</AnchorLink>
<AnchorLink>Size</AnchorLink> <AnchorLink>States</AnchorLink>
...
<!--
Use a table to document additional color tokens for interactive states. You can reference this [table generator](https://www.tablesgenerator.com/markdown_tables) for easy table creation.
...
<!--
Content TK on Default/Flush images.
-->

## Typography

<!--
Begin this section with any brief content guidelines. Link out to additional content guidelines if needed.
...
<!--
Use a table to document states, pacing, and any other component-specific configurations. You can reference this [table generator](https://www.tablesgenerator.com/markdown_tables) for easy table creation.

Add supporting images to this section, with at least one image showing how color is applied within the component and another showing structure and spacing measurements. Images are accompanied by a descriptive caption below the image and used in conjunction with the spec charts. Note we used fixed images in the Structure section.
...
<!--
You main need to provide additional specs for component variants or default versus flush alignment. For each variant name a new section and give it a name. For example: Default alignment structure.
-->
...
<!--
In the style tab, provide a table of component size names and height. Be sure to cross-link this to the size section in the usage tab, In the usage tab, list any component sizes that are available and provide some guidance about how to choose the best size for the use case. Other topics that may be covered here include considerations around maximum heights, maximum widths, and responsive resizing.
