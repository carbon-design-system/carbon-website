...
<AnchorLink>Color</AnchorLink> <AnchorLink>Interactive
states</AnchorLink><AnchorLink>Typography</AnchorLink>
...
<!--
Use a table to document properties and color tokens for interactive states. You can reference this [table generator](https://www.tablesgenerator.com/markdown_tables) for easy table creation. You may also choose to include images for default and flush alignment.
...
<!--
In the size section, provide a table of component size names and height. Be sure to cross-link this to the size section in the usage tab, which is where you should provide guidance about how to choose the best size for the use case.
