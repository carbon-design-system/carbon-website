...
Replace the headings and explanations of the template with your content.

## Guidance for working in Markdown

This file is written in Markdown, which we use for our design system website files. We've included some basic Markdown styles here but we also have a [cheatsheet](https://gatsby-theme-carbon.now.sh/components/markdown) with a few more formatting tips. 
...
Use visuals throughout your written commentary to illustrate your guidance.
