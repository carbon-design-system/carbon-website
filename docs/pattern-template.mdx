...
This file is written in Markdown, which makes writing for the web simple. To learn more about Markdown, check out our [cheatsheet](https://gatsby-theme-carbon.now.sh/components/markdown).
