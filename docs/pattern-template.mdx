...
## First steps to contributing a pattern
...
This issue will be the staging ground for the pattern contribution, and you should expect the Carbon core team and the community to weigh in with suggestions. We encourage you to surface work in progress. If you’re not able to complete all of the parts yourself, someone in the community may be able to help.
...
---
title: [Pattern name]
description: [Explains what the pattern is in one or two sentences.]
---

<PageDescription>

<!-- Explains what the pattern is in one or two sentences. -->
