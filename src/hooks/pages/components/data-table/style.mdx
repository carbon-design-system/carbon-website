...
Specific styling on the data table component can be toggled on/off based on user
or team preference.
...
choose certain elements and interactions.

### Row sizes

Short and Default are offered as **user preferences** that can be accessed from
...
The basic table style is the required base from which tables can be developed.
Basic tables are composed of a header row followed by rows of data below. At a
minimum, tables require three or more columns.
...
_Structure and spacing measurements for a basic and an enhanced data table | px
/ rem_
