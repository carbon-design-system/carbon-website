...
Always start numerical axis at zero for part-to-whole and comparisons charts,
such as bar and area chart. Truncating the Y axis can distortion the perception,
...
are intended to communicate trends and not relative size of the difference. In
these cases, cropping the Y axis helps users more easily identify the direction
of change.
...
Never change axis ticks increments to accomodate data availability. If any form
