...
- Identify and align components/patterns/content that are multiproduct or
  universal.
- Ensure consistent design standards across different implementations of Carbon,
  for example a button in Carbon React looks the same as a button in Carbon
  Angular.
- Help project teams refine their scope of work. Highlight projects of
  particularly high potential business value. Help projects add collaborators
