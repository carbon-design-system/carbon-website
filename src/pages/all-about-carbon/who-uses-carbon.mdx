...
- See what issues are being tackled
  [right now](https://github.com/orgs/carbon-design-system/projects/39/views/11).
...
Carbon also extends IBM iX's capabilities, allowing iX customers to implement
and customize Carbon, showcasing its adaptability as a white-label design
system.
