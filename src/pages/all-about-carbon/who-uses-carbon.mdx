...
- Visit the [Getting Started](/designing/get-started/) page on the Carbon
  website and install the Figma design kits.

- Visit the [Other Resources](/designing/design-resources/) page on the Carbon
  website to find other useful tools and plugins.
...
- Visit [Developing > Getting Started](/developing/get-started/) and install
