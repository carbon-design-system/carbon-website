...
<Caption>Before: order confirmation page prior to the redesign</Caption>
...
<Caption>After: order confirmation page after the redesign</Caption>
...
<Caption>
  Before: the order confirmation screen design that was handed off to developers{' '}
</Caption>
...
<Caption>
  After: the order confirmation screen after in production at the end of the
  sprint (plus two extra working days)
</Caption>
