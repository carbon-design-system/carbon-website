...
slowly and tactically. By adopting Carbon iteratively, they were able to see
...
<Caption>
  <span class="bx--type-semibold">After:</span> The order confirmation screen in
  production at the end of the sprint.
</Caption>
