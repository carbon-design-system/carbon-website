...
Do not use this pattern for adding or editing a resource.
...
construction, as it needs to account for many different use cases. Below is
an example of an inline creation.

![Example creating a tab inline](images/InlineCreateExample.gif)
...
![Anatomy of a create modal](images/ModalSingleStepAnatomy.png)

</Column>
</Row>

1. **Modal size & overlay:** 
   [Small size Modal](https://www.carbondesignsystem.com/components/modal/style#small).
...
![Alignment of a create modal](images/ModalSingleStepAlignment.png)
...
1. **Panel size & non-focus state:** Side panel is 480px wide and has no overlay. 
   This option supports a non-focus state execution. The user can create while 
   still referencing on-page items.
2. **Create title:** Title line for the create flow with an optional
   subtitle.
3. **Body:** Contains the information and/or controls needed to populate the
   task. It can include message text and components.
...
**Do:**
- Use when the user needs to have page context while populating the side 
  panel.

**Don't:**
- Don't use when the flow has high complexity and the user would benefit 
  from having a visible progress indicator.
...
![Anatomy of narrow tearsheets](images/Narrow-tearsheet-1.png)

</Column>
</Row>

1. **Tearsheet & overlay**: [Narrow tearsheet component](none yet) with screen
   overlay that obscures the on-page content.
...
![Narrow tearsheet alignment](images/Narrow-Tearsheet-2.png)
...
![Anatomy of a wide tearsheet](images/Wide-tearsheet-1.png)

</Column>
</Row>

1. **Tearsheet & overlay**: [Wide tearsheet component](none yet) with screen overlay
   that obscures the on-page content.
2. **Create title**: Title line for the create flow with an optional subtitle.
...
_Note: Coming soon from Carbon, 80px tall fluid buttons will be the new standard
...
![New carbon button heights in the wide tearsheet](images/Wide-tearsheet-3.png)

<Caption>New carbon button heights in the wide tearsheet</Caption>
</Column>
</Row>
<Row>
<Column colLg={8}>

![Alternative left panel width](images/Wide-tearsheet-4.png)

<Caption>Alternative left panel width</Caption>
</Column>
</Row>
<Row>
<Column colLg={8}>

![Toggle view - show all available actions](images/Wide-tearsheet-5.png)

<Caption>Toggle view - show all available actions</Caption>
</Column>
</Row>
<Row>
<Column colLg={8}>

![Toggle view - show all available actions warning modal](images/Wide-tearsheet-6.png)

<Caption>Toggle view - show all available actions warning modal</Caption>
</Column>
</Row>
...
![Wide tearsheet alignment](images/Wide-tearsheet-7.png)
...
**Don't:**
- Don't use the Wide tearsheet for low complexity create flows with only one step.

### Behaviors, structure and functionality

Wide tearsheet Create flows can include an optional Toggle to show all the steps on a
...
all options for a particular Create flow if it will enhance the user
experience.  
If the user toggles off the advanced options, show a modal alerting them that
...
![Full page anatomy](images/Full-page-1.png)
...
![Full page anatomy with new Carbon button size](images/Full-page-2.png)
...
![Full page alignment](images/Full-page-3.png)

</Column>
</Row>

**Do:**
- In Cloud and Cognitive, the Full-page create flow is the process the user 
...
The Modal, Narrow Tearsheet and Wide Tearsheet components in the create flow
will not have a close icon in the top right. This is to enforce the user's
decision to exit the create flow by clicking on the word "Cancel".
...
asset's details page. But when the user stays on the same page, show a success
...
Should follow the accessibility guidelines for [Modal](https://www.carbondesignsystem.com/components/modal/accessibility), Side panel, Narrow tearsheet, Wide tearsheet, [Forms](https://www.carbondesignsystem.com/patterns/forms-pattern#accessibility), and [Progress indicator](https://www.carbondesignsystem.com/components/progress-indicator/accessibility).
