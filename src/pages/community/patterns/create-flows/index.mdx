...
title: Create flows
description:
  To create is to generate a new resource. Creating is distinct from 
  adding, but the two are often confused. To add a resource is to 
  include a resource that already exists. This pattern focuses on how to 
  place the user in a flow when there's a need for creating a new 
  resource.
---
...
variations in one of the following formats: Modal, Side panel, Narrow
tearsheet, Wide tearsheet, and Full page.
...
<img
  src="/images/WideTearsheetAnimated.gif"
  alt="Wide tearsheet animated Create flow"
  title="Wide tearsheet animated Create flow"
  style="padding:3rem; background-color:#e0e0e0"
></img>
...
<img
  src="/images/WideTearsheetShowAllOptionsAnimated.gif"
  alt="Wide tearsheet animated options toggle"
  title="Wide tearsheet animated options toggle"
  style="padding:3rem; background-color:#e0e0e0"
></img>
