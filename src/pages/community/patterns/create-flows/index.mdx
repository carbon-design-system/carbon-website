...
1. **Tearsheet & overlay**: Narrow tearsheet component with screen
...
1. **Tearsheet & overlay**: Wide tearsheet component with screen overlay
...
![Upcoming 80px fluid button height in the wide tearsheet](images/Wide-tearsheet-3.png)
...
![Alternative left panel width of 320px](images/Wide-tearsheet-4.png)
...
![Toggle view - show all available options](images/Wide-tearsheet-5.png)
...
![Toggle view - hide all available options warning modal](images/Wide-tearsheet-6.png)

<Caption>Toggle view - hide all available options warning modal</Caption>
</Column>
</Row>
...
- Omit the progress indicator to use with single step creations that require more 
  space, such as those with interactive selections, diagrams, or tables.
...
![Upcoming 80px fluid button height in the Full-page flow](images/Full-page-2.png)
...
create flow will not have a close icon in the top right. This is to enforce
the user's decision to exit the create flow by clicking on the word "Cancel".
...
[Modal](https://www.carbondesignsystem.com/components/modal/accessibility), 
Side panel, Narrow tearsheet, Wide tearsheet, 
