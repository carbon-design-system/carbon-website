...
![Example of an inline create](/images/InlineCreateExample.gif)
![Example of an inline create](/images/inline-create-example.png)
...
![Wide tearsheet alignment](images/WideTearsheetAnatomyt.jpg)
