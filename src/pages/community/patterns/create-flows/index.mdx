...
| Type             | Usage       | Context     |
| ---------------- | ----------- | ----------- |
| Inline           | `text here` | `text here` |
| Modal            | `text here` | `text here` |
| Side-panel       | `text here` | `text here` |
| Narrow tearsheet | `text here` | `text here` |
| Wide tearsheet   | `text here` | `text here` |
| Full page        | `text here` | `text here` |
...
<img
  src="/images/SidePanelAnatomy.jpg"
  alt="Anatomy of a create side panel"
  title="Anatomy of a create side panel"
  style="padding:3rem; background-color:#e0e0e0"
/>
...
<img
  src="/images/SidePanelAlignment.jpg"
  alt="Alignment of a create side panel"
  title="Alignment of a create side panel"
  style="padding:3rem; background-color:#e0e0e0"
/>
