...
The keyboard behaviour of an upload or import interaction depends on how many
...
3. The user clicks “enter” to launch the Import modal.
...
3. If enabled, on `tab`, focus is applied to the primary button (e.g. "Save",
...
In some usecases, there are a maximum number of allowed files. In this situation
