...
<Caption>Annotate the header, even if your design matches the default Carbon UI shell header behavior.</Caption>
...
<Caption>Annotate if the design modifies the default keyboard or component interaction.</Caption>
