...
![ui shell header](images/header-style-1.jpg)
...
![Menu trigger interactive states](images/header-style-5.jpg)
...
![Menu item interactive states](images/header-style-6.jpg)
...
![Sub-menu interactive states](images/header-style-7.jpg)
...
![Header action interactive states](images/header-style-8.jpg)
...
![ui shell header spec](images/header-style-2.jpg)

<Caption>
  Structure and spacing measurements for UI shell header | px | rem
</Caption>

![ui shell header submenu spec](images/header-style-3.jpg)
...
![responsive behavior example](images/header-style-4.jpg)
