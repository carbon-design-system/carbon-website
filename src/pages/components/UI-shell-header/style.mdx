...
| Class                           | Property         | Color value    |
| ------------------------------- | ---------------- | -------------- |
| `.bx--header__menu-item`        | text color       | Gray 10        |
| `.bx--header__menu-item`        | svg              | Gray 10        |
| `.bx--header__menu-item:hover`  | background color | Gray 100-hover |
| `.bx--header__menu-item:hover`  | text color       | White          |
| `.bx--header__menu-item:hover`  | svg              | White          |
| `.bx--header__menu-item:focus`  | border           | White          |
| `.bx--header__menu-item:active` | background color | Gray 80        |
| `.bx--header__menu-item:active` | text color       | White          |
| `.bx--header__menu-item:active` | svg              | White          |
