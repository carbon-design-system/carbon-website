...
<Column colMd={4} colLg={4}>
  <DoDontExample type="do" caption="Header utilities are right aligned with no gaps">
...
<Column colMd={4} colLg={4} >
  <DoDontExample caption="Header utilities with a gap between the account and help icons.">
