...
![UI shell header](images/zones-platform.jpg)
...
![UI shell components.](images/shell-usage-1.jpg)
...
![Primary header](images/header-usage-2.jpg)
...
![Example of header icons right aligned with no gaps.](images/header-usage-5.jpg)

  </DoDont>
  <DoDont type="dont" caption="Header utilities with a gap between the account and help icons.">

![Example of the header icons with a gap between the account and help icons.](images/header-usage-6.jpg)
...
![icon placement.](images/header-usage-4.jpg)
...
![An example of the header responding to different screen sizes.](images/header-usage-3.jpg)
