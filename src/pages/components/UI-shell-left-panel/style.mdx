...
![UI shell side-nav example.](images/left-nav-style-1.jpg)
...
![Link states](images/left-nav-style-4.jpg)
...
![Sub-menu states](images/left-nav-style-4.jpg)
...
![ui shell side-nav](images/left-nav-style-2.jpg)

<Caption>
  Structure and spacing measurements for the side-nav | px | rem.
</Caption>

![ui shell side-nav with icons](images/left-nav-style-3.jpg)
