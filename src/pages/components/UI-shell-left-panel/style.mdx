...
|               | Hover    | background color | `$backgound-hover`     |
|               |          | text color       | `$text-primary`        |
|               | Focus    | border           | `$focus`               |
|               | Active   | background color | `$background-active`   |
|               |          | text color       | `$text-primary`        |
...
| ------------- | ------------------ | -------------- | ---------------- |
| Link          | 14 / 0.875         | SemiBold / 600 | `$heading-01`    |
| Sub-menu      | 14 / 0.875         | SemiBold / 600 | `$heading-01`    |
| Sub-menu item | 14 / 0.875         | Regular / 400  | `$body-short-01` |
