...
### Annotate name for switcher button, where necessary
  ...
  Designers may need to change the icon-only switcher button's name to match the right panel's scope. Depending on the context of the design, common button names include "Switch site" or "App switcher".
