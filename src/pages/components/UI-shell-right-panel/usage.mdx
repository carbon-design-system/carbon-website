...
![Header panel and switcher.](images/right-panel-usage-1.jpg)
...
![Example of the switcher icon being used correctly.](images/right-panel-usage-2.jpg)

  </DoDont>
  <DoDont type="dont" colLg={6}  caption="Do not position other icons to the right of the switcher.">

![The switcher icon is not positioned to the far right.](images/right-panel-usage-3.jpg)
...
![The switcher not using the switcher icon.](images/right-panel-usage-4.jpg)
