...
<Caption>Accordions and interactive elements in the expanded content are in the tab order and keyboard operable.</Caption>
...
The collapsed or expanded state of the accordions is [programmatically set](https://www.ibm.com/able/requirements/requirements/#4_1_2) by default, eliminating the need for designers to provide [text equivalents](https://www.ibm.com/able/toolkit/design/content/text-equivalents/) for the chevron icons.
...
<Caption>If accordion titles act as headings, annotate for development.</Caption>
