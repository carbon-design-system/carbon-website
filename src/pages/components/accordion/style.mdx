...
<Caption>
  Examples of enabled, hover, focus, and disabled states for default accordion
  alignment.
</Caption>
...
![flush accordio alignment interactive states](images/accordion-style-2.png)

</Column>
</Row>

<Caption>
  Examples of enabled, hover, focus, and disabled states for flush accordion
  alignment.
</Caption>
...
<Caption>
  Structure and spacing measurements default accordion alignment. | px / rem
</Caption>
