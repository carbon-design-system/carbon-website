...
| `:hover`             | text color       | `$button-tertiary` |
...
| ------------------ | ----------------- | ---------------------- |
| _Full bleed_       | 64 / 4            | 14px / \$body-short-01 |
| _Default_          | 48 / 3            | 14px / \$body-short-01 |
| _Large expressive_ | 48 / 3            | 16px / \$body-short-02 |
| _Field_            | 40 / 2.5          | 14px / \$body-short-01 |
| _Small_            | 32 / 2            | 14px / \$body-short-01 |
