...
| Icon               | svg              | `$icon-01`     |
| Container          | background-color | Transparent    |
| Container:hover    | background-color | `$hover-ui`    |
| Container:active   | background-color | `$active-ui`   |
| Container:focus    | border           | `$focus`       |
| Container:selected | background-color | `$selected-ui` |
| Icon:disabled      | svg              | `$disabled-02` |
