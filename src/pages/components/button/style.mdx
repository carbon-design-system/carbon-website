...
There are seven button sizes: extra small, small, medium, large (productive),
large (expressive), extra large, and 2XL. The large (expressive) button is used
in editorial and digital marketing experiences. See
