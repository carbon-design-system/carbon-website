...
**Buttons are used primarily for actions.** Examples include **Add**, **Save**, **Delete**, and **Sign up**. Each page can have one or two primary buttons. Any remaining calls-to-action should be represented as secondary buttons.
...
\*\* Be sure that the side panel buttons are visible without scrolling, whether at the top, the bottom without scrolling, or sticky and at the bottom of the view if the content is longer than the viewport.

### Non-modal forms

When presenting an in-page form, align single Primary or Secondary / Primary button groups to the left. Form buttons should align with the form controls regardless of the user‘s window width.
