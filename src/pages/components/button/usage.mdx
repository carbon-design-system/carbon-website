...
Do not use buttons as navigational elements. Instead, use [links](/components/link/usage) when the desired action is to take the user to a new page.
...
- Use right-justified buttons if the primary response advances the user through a multistep configuration such as a wizard.
