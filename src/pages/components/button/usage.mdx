...
_Note: Experimenting with stacked fluid buttons would require an override to the
existing code._
...
use case. Carbon recommends the following combination of button groups.
...
Button groups can consist of different button variants depending on the product
use case. Carbon recommends avoiding the following combination of button groups.
