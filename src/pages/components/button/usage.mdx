...
![Button sizes](images/button_usage_3-with-lgExp.png)
...
| _Large expressive_ | 48/3            | Use when the body copy is 16px, or larger, such as in a marketing experience's lead space. This button works well with the expressive type set.                                                                                                                                    |
