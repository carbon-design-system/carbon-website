...
The button is available in seven different sizes: extra small, small, medium,
large (productive), large (expressive), extra large, and 2XL. The table below
adds more context around the use case for each size. For guidance on button
heights as well as type sizes and tokens,
