...
see [Sizes](/components/button/style#sizes.mdx) in the Style tab.
...
These rules apply to buttons with a visible container. For buttons that don’t 
...
_Note: We recommend following this guidance for both the toolbar and the batch 
actions toolbar as well._
...
first approach involves using the [narrow gutter mode](https://carbondesignsystem.com/elements/2x-grid/usage/#gutter-modes). 
...
of its container with a programmatic 16px gutter between them.

<DoDontRow>
<DoDont
type="do"
colMd={6} colLg={6}
caption="Example of hanging buttons in a button group.">

![Example of hanging buttons in a button group.](images/button_usage_bg_11.png)

</DoDont>
<DoDont
colMd={6} colLg={6}
type="do"
caption="The button group is treated as one element on the grid to achieve a 16px gutter between the two, without the gutter hang.">

![The button group is treated as one element on the grid to achieve a 16px gutter between the two, without the gutter hang.](images/button_usage_bg_12.png)
...
Button groups can consist of different button variants depending on the product use case.
Carbon recommends avoiding the following combination of button groups.
...
![Do not use primary and danger ghost buttons together.](images/button_usage_bg_15.png)

  </DoDont>
  <DoDont type="dont" caption="Do not use the secondary button in conjunction with non-primary buttons.">

![Do not use the secondary button in conjunction with non-primary buttons.](images/button_usage_bg_16.png)
...
![Do not use tertiary and danger ghost buttons together.](images/button_usage_bg_17.png)

  </DoDont>
  <DoDont type="dont" caption="Do not use tertiary and danger tertiary buttons together.">

![Do not use tertiary and danger tertiary buttons together.](images/button_usage_bg_18.png)
