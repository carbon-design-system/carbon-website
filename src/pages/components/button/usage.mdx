...
Use the Secondary/Primary ordering convention in all cases. While research has shown that the performance differences between Secondary/Primary and Primary/Secondary ordering are negligible, mantaining consistency throughout a product, offering, or platform is crucial; we proscribe the the Secondary/Primary order as our required guidance, and it's already reflected in dozens of offerings already in production. 

<Row>
<Column colLg={8}>

![Secondary/Primary button order in Modals](images/button-usage-3.png)

<Caption>Secondary/Primary button order in a modal</Caption>

##Button alignment

There are three types of button alignment in our system; full bleed/full justified for modals/Side panels, Left Justified for forms on their own page (not in a modal or side panel), and Right Justified for Button Pairs where the Primary response in the Secondary/Primary pairing advances the flow to a subsequent state (such as a multi step configuration/"wizard".
...
If there is a third action in the modal such as "Back", place this within the modal itself rather than in line with the Secondary/Primary buttons.
...
<Caption>Secondary/Primary button pair with tertiary action in a modal</Caption>
...
![Secondary/Primary button order in Side panels](images/button-usage-6.png)

<Caption>Single Button, Secondary/Primary button pair, and Secondary/Primary button pair with tertiary action in a side panel</Caption>

</Column>
</Row>

###Non-modal forms
When presenting an in-page form, align single Primary or Secondary/Primary button groups **Left** so they are in line with the form cotrols regardless of the user's window width.

<Row>
<Column colLg={8}>

![Secondary/Primary button order in Forms](images/button-usage-6.png)
...
![Primary or Secondary/Primary button order in a wizard](images/button-usage-7.png)

<Caption>Single Button, Secondary/Primary button pair in a wizard</Caption>
