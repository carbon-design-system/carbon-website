...
<Title>Button groups combinations with Primary button</Title>
...
| Number of buttons | Recommended combination of button groups                                                                                                                                                                                                                                                                                                         |
| ------------------| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
...
| 3                 | <UnorderedList><ListItem>Primary, Secondary and Tertiary button</ListItem><ListItem>Primary, Secondary and Ghost button</ListItem><ListItem>Primary and 2 Secondary buttons</ListItem><ListItem>Primary and 2 Tertiary buttons</ListItem><ListItem>Primary and Danger info??</ListItem></UnorderedList>                                          |

</Column>
</Row>

<Title>Button groups combinations without Primary button</Title>
...
| 3                 | <UnorderedList><ListItem>3 Tertiary buttons</ListItem></UnorderedList>                                                                                   |
