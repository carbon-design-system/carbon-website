...
The button is available in six different sizes: small, medium, large
(productive), large (expressive), extra large, and 2XL. The table below adds
more context around the use case for each size. For guidance on button heights
as well as type sizes and tokens,
see [Sizes](/components/button/style#sizes.mdx) on the Style tab.

Carbon does not recommend mixing different button sizes in #Button groups.
...
![Example of a fixed width primary button in a layout.](images/button_usage_bg_1.png)

<Caption>Example of a fixed width primary button in a layout.</Caption>

</Column>
</Row>

#### Hanging vs non-hanging button alignment
...
components and button directly affecting each other. 

Non-hanging button alignment is when the button container is aligned to the grid. 
These rules apply for buttons with a visible container, for buttons that don’t 
have a visible container in the default state such as ghost button and danger 
ghost button, refer to [ghost button](/components/button/usage/#ghost-button) 
alignment.

<DoDontRow>
  <DoDont type="do" caption="Example of a fixed width button’s hanging alignment.">

![Example of a fixed width button’s hanging alignment.](images/button_usage_bg_2.png)

  </DoDont>
  <DoDont type="do" caption="Example of a fixed width button’s non-hanging alignment.">

![Example of a fixed width button’s non-hanging alignment.](images/button_usage_bg_3.png)
...
![Example of a fluid width primary button matching the width of a card in a layout.](images/button_usage_bg_4.png)

<Caption>Example of a fluid width primary button matching the width of a card in a layout.</Caption>
...
![Example of button groups in a UI.](images/button_usage_bg_5.png)

<Caption>Example of button groups in a UI.</Caption>
...
type="do"
colMd={6} colLg={6}
caption="Do use menu buttons to group meaningful actions being applied to the same data.">

![Do use menu buttons to group meaningful actions being applied to the same data.](images/button_usage_bg_6.png)

</DoDont>
<DoDont
colMd={6} colLg={6}
type="dont"
caption="Do not use many individual buttons applying to the same data.">

![Do not use many individual buttons applying to the same data.](images/button_usage_bg_7.png)
...
When using groups of related buttons (not including ghost buttons), they 
should all be the same width. The width of all the buttons is usually 
determined by the longest button label.

_Note: We recommend following this guidance for toolbar and batch actions toolbar as well._

<Row>
<Column colLg={8}>

![Example of button width in button groups.](images/button_usage_bg_8.png)

<Caption>Example of button width in button groups.</Caption>
...
![Do apply the same width to all buttons in a group, even if they don’t bleed.](images/button_usage_bg_9.png)

  </DoDont>
  <DoDont type="dont" caption="Do not make buttons in a group different widths.">

![Do not make buttons in a group different widths.](images/button_usage_bg_10.png)

  </DoDont>
</DoDontRow>

#### Hanging vs non-hanging fluid width button group alignment

This can be achieved in one of two ways, both of which are acceptable. The 
first approach involves using the narrow gutter mode. In this situation, 
each button would be set individually on the column grid.  
...
Some products don’t want to hang their buttons into the gutter, but still 
want a 16px distance between buttons. This can be achieved while maintaining 
same-width buttons by treating the button group as a single object (rather 
than two separate entities) on the grid. Each button will essentially span 50% 
of their container with a programmatic 16px gutter between them.

<DoDontRow>
<DoDont
type="do"
colMd={6} colLg={6}
caption="Example of hanging buttons in a button groups.">

![Example of hanging buttons in a button groups.](images/button_usage_bg_11.png)

</DoDont>
<DoDont
colMd={6} colLg={6}
type="do"
caption="Here the button group is treated as one element on the grid to achieve a 16px gutter between the two, without the gutter hang.">

![Here the button group is treated as one element on the grid to achieve a 16px gutter between the two, without the gutter hang.](images/button_usage_bg_12.png)
...
_Note: experimenting with stacked fluid buttons would require an override to the existing code._
...
Carbon recommends the following combination of button groups.

<Title>Button groups with a primary button</Title>

<Row className="table--component-checklist">
<Column colMd={8} colLg={8} noGutterSm>

| Number of buttons | Recommended combniations                                                                                                                                                                                                                                                                                                                         |
| ------------------| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 2                 | <UnorderedList><ListItem>Primary and secondary button</ListItem><ListItem>Primary and tertiary button</ListItem><ListItem>Primary and ghost button</ListItem><ListItem>Primary and danger tertiary button</ListItem><ListItem>Danger primary and secondary button</ListItem><ListItem>Danger primary and ghost button</ListItem></UnorderedList> |
| 3                 | <UnorderedList><ListItem>Primary, secondary and tertiary button</ListItem><ListItem>Primary, secondary and ghost button</ListItem><ListItem>Primary and 2 secondary buttons</ListItem><ListItem>Primary and 2 tertiary buttons</ListItem><ListItem>Primary, tertiary and danger tertiary</ListItem></UnorderedList>                              |

</Column>
</Row>

<Title>Button groups without a primary button</Title>
...
| Number of buttons | Recommended combniations                                                                                                                                 |
| ------------------| -------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2                 | <UnorderedList><ListItem>2 Tertiary buttons</ListItem><ListItem>Tertiary and ghost button</ListItem><ListItem>2 Ghost buttons</ListItem></UnorderedList> |
| 3                 | <UnorderedList><ListItem>3 Tertiary buttons</ListItem><ListItem>2 Tertiary and 1 danger tertiary button</ListItem></UnorderedList>                                                                                   |
...
Button groups can consist of different button variants depending on the product use case.
Carbon recommends to avoid the following combination of button groups.

<DoDontRow>
  <DoDont type="dont" caption="Do not use two high-emphasis buttons in a button group.">

![Do not use two high-emphasis buttons in a button group.](images/button_usage_bg_13.png)

  </DoDont>
  <DoDont type="dont" caption="Do not use two high-emphasis buttons in a button group.">

![Do not use two high-emphasis buttons in a button group.](images/button_usage_bg_14.png)

  </DoDont>
</DoDontRow>

<DoDontRow>
  <DoDont type="dont" caption="Do not use the secondary button in conjunction with non-primary buttons.">

![Do not use the secondary button in conjunction with non-primary buttons.](images/button_usage_bg_15.png)

  </DoDont>
  <DoDont type="dont" caption="Do not use tertiary and danger tertiary buttons together.">

![Do not use tertiary and danger tertiary buttons together.](images/button_usage_bg_16.png)

  </DoDont>
</DoDontRow>

<DoDontRow>
  <DoDont type="dont" caption="Do not use primary and danger ghost buttons together.">

![Do not use primary and danger ghost buttons together.](images/button_usage_bg_17.png)

  </DoDont>
  <DoDont type="dont" caption="Do not use tertiary and danger ghost buttons together.">

![Do not use tertiary and danger ghost buttons together.](images/button_usage_bg_18.png)
...
- There is insufficient space and multiple actions, therefore a toolbar using
  ...
  the [toolbars pattern](https://pages.github.ibm.com/carbon/ibm-products/components/toolbar/usage/)
  for more details.
