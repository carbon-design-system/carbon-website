...
<Captions>Carbon checkboxes retain expected interactions.</Caption>
...
<Captions>Carbon handles the accessibility of grouped checkboxes.</Captions>
...
<Captions>Annotate if there is meaningful navigation order in rows of checkboxes.</Captions>
