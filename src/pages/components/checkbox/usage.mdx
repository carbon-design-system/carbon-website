...
Checking a child checkbox, if at least one other child checkbox remains unchecked, will automatically check the parent checkbox in the indeterminate state. Unchecking a child checkbox, when all other children checkboxes remain checked, will switch the parent checkbox from the default checked state to the indeterminate state.
