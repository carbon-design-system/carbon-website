...
Checking the parent checkbox will automatically check all its nested children checkboxes. Unchecking the parent checkbox will automatically uncheck all the children checkboxes.

<Row>
<Column colLg={8}>

![Checking the parent checkbox.](images/nested-all-selected.png)
...
![Unchecking the parent checkbox.](images/nested-all-unselected.png)

</Column>
</Row>

Checking a child checkbox, if at least one other child checkbox remains unchecked, will automatically check the parent checkbox in the indeterminate state.

<Row>
<Column colLg={8}>

![Checking a child checkbox.](images/nested-one-selected.png)

</Column>
</Row>

Unchecking a child checkbox, when all other children checkboxes remain checked, will switch the parent checkbox from the default checked state to the indeterminate state.

<Row>
<Column colLg={8}>

![Unchecking a child checkbox.](images/nested-one-unselected.png)
