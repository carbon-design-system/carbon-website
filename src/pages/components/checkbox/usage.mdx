...
Used to filter data either on a page, in a menu, or within a component. Checkboxes are found in our Multiselect dropdown to select multiple items and in Data table for batch editing purposes.
