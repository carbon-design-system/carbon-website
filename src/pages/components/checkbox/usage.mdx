...
Users can trigger an item by clicking on the checkbox input directly or by clicking on the checkbox label. Having both regions interactive creates a more accessible click target.
