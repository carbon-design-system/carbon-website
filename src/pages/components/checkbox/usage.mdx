...
JAWS: Users can trigger a state change by pressing `Spacebar` key while the checkbox input has screen reader focus.

NVDA: Users can trigger a state change by pressing `Spacebar` key while the checkbox input has screen reader focus.
