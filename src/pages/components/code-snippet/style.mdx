...
| `.bx--snippet-button:active`                    | active           | `$active-ui`      |
| `.bx--snippet--light`                           | background-color | `$field-02`       |
| `.bx--snippet--light .bx--snippet-button:hover` | background-color | `$hover-ui-light` |
...
| `.bx--snippet--inline:active` | active           | `$active-ui`      |
| `.bx--snippet--light`         | background-color | `$hover-ui-light` |
