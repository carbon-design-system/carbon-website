...
| [Multi-line](#multiline)    | Multiple lines of code with the ability to show more or less strings. |
...
Use mutli-line code snippets for displaying multiple lines of code.
...
A ghost button can be added to a multi-line code snippet to show more or fewer lines of code. Use this functionality if your layout is tight on space.
