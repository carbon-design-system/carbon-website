...
<h3
  class="AutolinkHeader-module--header--1G1tm AutolinkHeader-module--header--1G1tm Markdown-module--h3--Gwbvh Markdown-module--h3--Gwbvh"
  id="overflow-content-header">
  Overflow content
  <a
    href="#overflow-content"
    class="bx--link AutolinkHeader-module--anchor--36UpA AutolinkHeader-module--left-anchor--1SDoO Link-module--link--PAAZ2"
    aria-label="Overflow content permalink">
    <svg
      focusable="false"
  ...
  <a
    ...
    href="#overflow-contentobject-object"
    aria-label="Overflow content[object Object] permalink">
    <svg
      focusable="false"
      preserveAspectRatio="xMidYMid meet"
      xmlns="http://www.w3.org/2000/svg"
