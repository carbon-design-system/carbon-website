...
cards, sidebars, and disclosure situations.

These lists allow one column of information with multiple list item rows. The
list header area and individual list items can have inline actions and include
interactive elements.

#### When to use

— Use on a page inside of small spaces or in disclosure situations. — Use when
including interactive elements or inline actions. — To logically group items
that follow the same content structure.
...
— A list title is a descriptive name for the group of list items. — List titles
should be short and clear, ranging from one to three words to describe the list
item group. — Use sentence-case capitalization.

#### List item

— List item text can vary but the structure of the content should be similar per
row in the same contained list. — List item text can have multiple lines of
concise content, but should not contain multiple paragraphs of lengthy
information. — Use sentence-case capitalization.
...
The on page list styling has no visible background header with fixed
...
The disclosed list styling has a background layer underneath the header. Each
header has a smaller height than the on page list styling to take up less real
estate in the smaller and scrollable spaces it usually appears in.
