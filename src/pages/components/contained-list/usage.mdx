...
Contained lists can have decorative icons in rows positioned before the text in
each row to help visually describe the list item, category, or status. These
icons are non-interactive elements and are used for visual purposes only. Icons
