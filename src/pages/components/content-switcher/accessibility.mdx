...
![Tab to content switcher then operate with arrow keys](images/content-switcher-accessibility-1.png)
...
![Space and Enter keys select whatever manual content switcher tab has focus](images/content-switcher-accessibility-2.png)
...
wireframe, so designers must annotate which variant the team has decided to
...
![Two switchers, one with a pink annotation reading "auto", the other with an annotation "manual"](images/content-switcher-accessibility-3.png)
