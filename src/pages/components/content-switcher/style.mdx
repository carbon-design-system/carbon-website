...
![Example of default content switcher states](images/content-switcher-style-color.png)
...
![Structure and spacing measurements for icon content switcher in px and rem](images/content-switcher-style-4.png)
