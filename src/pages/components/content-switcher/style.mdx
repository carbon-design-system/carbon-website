...
![Selected and unselected states of the content switcher](images/contentswitcher-usage-4.png)
...
![Example of default content switcher states](images/content-switcher-style-color-text.png)

</Tab>

<Tab label="Icon">

![Example of icon content switcher states](images/content-switcher-style-color-icon.png)
