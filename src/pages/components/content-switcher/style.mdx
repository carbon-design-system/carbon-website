...
![Example of default content switcher enabled state](images/content-switcher-style-color-text.png)

</Tab>

<Tab label="Icon">

![Example of icon content switcher enabled state](images/content-switcher-style-color-icon.png)
...
![Example of default content switcher interactive states](images/content-switcher-style-interactive-color-text.png)

</Tab>

<Tab label="Icon">

![Example of icon content switcher interactive states](images/content-switcher-style-interactive-color-icon.png)
