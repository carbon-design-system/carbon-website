...
| Variant     | Purpose                                                                                                                                            |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| _Default_   | Uses a text label to represent the content inside each tab.                                                                                        |
| _Icon only_ | Uses an icon to represent the content inside each tab. They are often used when space is limited or if icons can adequately describe the sections. |
...
![Anatomy of an icon only content switcher.](images/contentswitcher-usage-2.png)

</Column>
</Row>

1. **Selected content tab:** Only one content tab can be selected at a time and
   one tab must always be selected.
2. **Content tab:** Selectable container for each content view.
3. **Icon:** Visual representation of the content view.
4. **Tooltip:** Contextual information that describes the icon and content view.
...
The overall width of the content switcher can be content-driven or grid aware.
In either case, each content tab in the group should be the same width.
