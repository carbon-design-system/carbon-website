...
| Variant                 | Purpose                                                                                                                                            |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| _Content switcher_      | Uses a label text to represent the content inside each tab.                                                                                        |
...
4. **Content view:** Consists of a specific component(s) that is usually right
   below the content switcher. Its view changes based on the selection.
...
![Height options for the default content switcher](images/content-switcher-usage-sizes.png)

</Tab>

<Tab label="Icon">

![Height options for the icon content switcher](images/content-switcher-usage-size-icon.png)
...
![Do base content tab width on the longest label text.](images/content-switcher-usage-size-do.png)

  </DoDont>
  <DoDont type="dont" caption="Do not use a different width for each content tab.">

![Do not use a different width for each content tab.](images/content-switcher-usage-size-dont.png)
...
![An example of a content-driven width content switcher.](images/content-switcher-usage-size-content.png)
...
![An example of a content switcher aligning to the grid.](images/content-switcher-usage-size-grid.png)
...
![Example shows the overflow text in a content switcher’s tab.](images/content-switcher-usage-overflow.png)
...
Users can activate the content switcher by pressing the tab and then navigating
...
![IBM Cloud Platform Prototype](/images/content-switcher-usage-responsive.gif)
...
![Text and icon content switchers with their clickable areas](images/content-switcher-usage-clickable.png)
...
Use icons instead of a label text to indicate alternative views of similar or
