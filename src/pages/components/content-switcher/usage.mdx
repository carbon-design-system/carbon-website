...
<AnchorLink>Icon variant</AnchorLink>
...
![Height options for the icon content switcher](images/content-switcher-usage-sizes-icon.png)
...
![Do base content tab width on the longest text label.](images/content-switcher-usage-alignment-do.png)

  </DoDont>
  <DoDont type="dont" caption="Do not flush align the switcher to the edges of containers.">

![Do not use a different width for each content tab.](images/content-switcher-usage-alignment-dont.png)
...
![An example of a content switcher aligning to the grid.](images/content-switcher-alignment-3.png)
...
![An example of a content-driven width content switcher.](images/content-switcher-alignment-2.png)
...
The icon content switcher variant uses an icon instead of to text label to
...
![Example of an icon switcher in a mobile setting.](images/content-switcher-icon-reponsive.png)
