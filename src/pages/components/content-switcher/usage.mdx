...
![An example of a content switcher's text aligning to the grid.](images/content-switcher-usage-size-grid.png)
...
| _Hove_r_     | When the user hovers the cursor over an unselected content tab.                                                                                                              |
