...
![he Status column header has a 'sorted ascending' icon, and the Rule column header has focus and shows a sortable icon](images/data-table-accessibility-3.png)
