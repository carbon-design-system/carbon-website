...
Column widths can vary by content and only requires a minimum spacing between
...
The small batch actioin bar is paired with the short and compact row sizes.
