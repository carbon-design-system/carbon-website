...
![Data table: row styling](images/data-table-style-1.jpg)
...
![Data table: background colors](images/data-table-style-2.jpg)
...
![Data table: row styling](images/data-table-style-3.jpg)
