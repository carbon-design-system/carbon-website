...
>
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datatable--usage',
      Angular:
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datatable-selection--usage',
      Angular:
        'https://angular.carbondesignsystem.com/?path=/story/components-table--basic',
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datatable-expansion--usage',
      Angular:
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datatable-batch-actions--usage',
      Angular:
...
[row sizes](/components/data-table/style/#rows): tall, normal, short, compact.
...
Carbon’s [React Storybook](http://v10-react.carbondesignsystem.com/?path=/story/datatable--with-sorting).
