...
present in the entire container. The AI variants of a data table function the
same as the normal variants except for the addition of the AI slug, which is
...
present in all aspects of the data table. If content belonging to only a row or
column of the data table is generated by AI, then only those respective row/s
and column/s should receive the AI presence styling along with the AI slug, not
the entire data table. Additionlly, if data table cells have content generated
by AI, then those cells have an in-line AI slug next to them. These cells do not
get any AI layering.
...
![Example of a data table generated by AI](images/usage-ai-presence-datatable-w.png)
