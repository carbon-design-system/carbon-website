...
The data table is available in five different
row sizes: extra large, large, medium, small, extra small.
...
of the table. Extra large row heights are only recommended if your data is expected to
...
The tall toolbar should only be paired with the large and extra large row heights and
