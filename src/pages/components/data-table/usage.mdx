...
![data table multi select](images/datatable-expand.png)
...
Actions applied to the chosen selected items are found in the default table
toolbar or batch action mode.
...
performing the same inline action across multiple table items.
