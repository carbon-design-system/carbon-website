...
Experimental slug (aka AI label) is now available for
...
AI explainability feature when AI is present in the component. See the
[AI presence](/components/data-table/usage/#ai-presence) section for more
details.
...
![Example of a data table cell generated by AI represneted by the in-line AI label](images/usage-ai-presence-inline-datatable.png)
