...
[pagination](/components/pagination/code) component for further guidelines.
...
[small search](/components/search/code) conventions. Search should be closed by
...
Each row is accompanied by an [overflow menu](/components/overflow-menu/code)
