...
![basic data table](images/data-table-usage-1.jpg)
...
![data table with pagination](images/data-table-usage-2.jpg)
...
![data table with search](images/data-table-usage-3.jpg)
...
![Data table with sorting](images/data-table-usage-13.jpg)
...
![Table toolbar](images/data-table-usage-6.jpg)
...
![Batch action mode](images/data-table-usage-7.jpg)
...
![Overflow menu example](images/data-table-usage-8.jpg)
...
![Inline actions without overflow](images/data-table-usage-10.jpg)
...
![Persistent overflow icon example](images/data-table-usage-9.jpg)
...
![Expandable data table with one row expanded.](images/data-table-usage-11.jpg)
...
![Expandabling all rows with skeleton states](images/data-table-usage-12.jpg)
