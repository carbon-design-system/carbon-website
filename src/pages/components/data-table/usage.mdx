...
| Type           | Purpose                                                                                                                                                                |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Basic          | The basic data table is shipped with a base style that is only a title, headers, and table rows.                                                                       |
| Zebra          | The zebra data table features alternating colored rows to make scanning horizontal information easier for the user.                                                    |
| With selection | Batch actions are functions that may be performed on multiple items within a table. This type of table enables the user to select individual rows and apply an action. |
| With expansion | The expandable data table is useful for presenting large amounts of data in a small space by collapsing the extra information.                                         |
