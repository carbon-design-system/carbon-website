...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="React"
    href="https://v10-react.carbondesignsystem.com/?path=/story/components-datepicker--simple"
    >
...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
      ...
      href="https://web-components.carbondesignsystem.com/?path=/story/components-date-picker--default"
      >
...
>
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datepicker--simple',
      Angular:
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datepicker--single',
      Angular:
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-datepicker--range',
      Angular:
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-timepicker--default',
      Angular:
