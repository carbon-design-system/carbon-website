...
The interactive state color example shown below is specificaly for text input.
...
![Enabled state of default date picker with AI presence](images/date-picker-usage-AI-presence-default-style.png)

</Tab>

<Tab label="Fluid">

![Enabled state of fluid date picker with AI presence](images/date-picker-usage-AI-presence-fluid-style.png)
