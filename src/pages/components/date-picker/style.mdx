...
<Caption>Date picker calendar color example.</Caption>
...
The time picker is made up of the text input and select input components. See
the [text input](https://carbondesignsystem.com/components/text-input/style) and
[select input](https://carbondesignsystem.com/components/select/style) style
