...
<Caption>Example of date picker input states.</Caption>
...
<Caption>
  Examplea of a single date calendar picker (left) and a date range calendar
  picker (right).
</Caption>
...
<Caption>Sizes for date picker inputs | px / rem</Caption>
