...
The time picker is made up of text input and select input components. See the
[text input](https://carbondesignsystem.com/components/text-input/style) and
[select input](https://carbondesignsystem.com/components/select/style) style
tabs for more details on color and interactive states.
