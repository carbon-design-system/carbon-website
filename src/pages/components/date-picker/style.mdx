...
![Enabled state of default date picker with AI presence](images/date-picker-AI-default-style.png)

</Tab>

<Tab label="Fluid">

![Enabled state of fluid date picker with AI presence](images/date-picker-AI-fluid-style.png)
