...
- The date format can be displayed differently depending on your location. For
  ...
  The date picker uses flat picker, which accepts a date format and locale prop
  that allows you to change how the date is displayed and lets you change the
