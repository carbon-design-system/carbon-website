...
<Caption>
  Example of different ways to suggest the proper date format in helper text on
  the left or in a label on the right.
</Caption>
...
<Caption>
  Example of different ways to format dates, with the American English format on
  the left and the International Standard format on the right.
</Caption>
