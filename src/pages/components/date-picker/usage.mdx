...
#### Simple date input and calendar picker
...
![Default date picker states](images/simple-date-input-states-default.png)

</Tab>

<Tab label="Fluid">

![Fluid date picker states](images/simple-date-input-states-fluid.png)
