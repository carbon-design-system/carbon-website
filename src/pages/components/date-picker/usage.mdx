...
The time picker input is a combination of a
[text input](/components/text-input/usage) and
[select inputs](/components/select/usage) and has the same interactive state and
behaviors. See the [style tab](/components/time-picker/style) for more details.
...
[text input](https://carbondesignsystem.com/components/text-input/usage/) and
[selects](https://carbondesignsystem.com/components/select/usage/) which have
the same interactive states and behaviors. See the
[style tab](https://carbondesignsystem.com/components/date-picker/style) for
more details.
...
![Default time picker states](images/time-picker-style-states-default.png)

</Tab>

<Tab label="Fluid">

![Fluid date picker states](images/time-picker-style-states-fluid.png)
