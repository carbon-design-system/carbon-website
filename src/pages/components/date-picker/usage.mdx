...
<A11yStatus layout="cards" components={['Date picker', 'Fluid date picker']} />
...
<<<<<<< HEAD
![Enabled state of default date picker with AI presence](images/date-picker-AI-presence-default-usage.png)
=======
![Enabled state of default date picker with AI presence](images/date-picker-usage-AI-presence-default-usage.png)

> > > > > > > 900afbe9d86a4e5b36daa9504d3040256c746f3d
...
<<<<<<< HEAD
![Enabled state of fluid date picker with AI presence](images/date-picker-AI-presence-fluid-usage.png)
=======
![Enabled state of fluid date picker with AI presence](images/date-picker-usage-AI-presence-fluid-usage.png)
...
<<<<<<< HEAD
![Enabled state of default date picker with AI presence](images/date-picker-revert-to-AI-default-usage.png)
=======
![Enabled state of default date picker with AI presence](images/date-picker-usage-revert-to-AI-default-usage.png)
...
<<<<<<< HEAD
![Enabled state of fluid date picker with AI presence](images/date-picker-revert-to-AI-fluid-usage.png)
=======
![Enabled state of fluid date picker with AI presence](images/date-picker-usage-revert-to-AI-fluid-usage.png)
