...
[AI presence](/components/date-picker/usage/#ai-presence) section for more
details.
...
![Default date picker with AI presence](images/date-picker-AI-presence-default-usage.png)

</Tab>

<Tab label="Fluid">

![Fluid date picker with AI presence](images/date-picker-AI-presence-fluid-usage.png)
...
![Default date picker with AI revert](images/date-picker-revert-to-AI-default-usage.png)

</Tab>

<Tab label="Fluid">

![Fluid date picker with AI revert](images/date-picker-revert-to-AI-fluid-usage.png)
