...
- Depending on the usecase, dates can be formatted to be localized. If you
  choose to localize your date entry fields, it is recommended to also localize
  any static dates in the same UI.
