...
![Dropdown interaction](images/dropdown-accessibility-2.png)
...
![Multiselect interaction](images/dropdown-accessibility-3.png)
...
a text input and a dropdown. `Enter` or `Down arrow` will open the list of
...
will clear the input and collapse the list. Pressing `Enter` will select a
highlighted option and collapse the combobox. (If nothing is highlighted in the
list, pressing `Enter` will just toggle the combobox open and closed.) `Space`
...
![Combobox interaction](images/dropdown-accessibility-4.png)
