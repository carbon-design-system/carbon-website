...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="React"
    href="https://v10-react.carbondesignsystem.com/?path=/story/components-dropdown--default"
    >
...
>
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-dropdown--default',
      Angular:
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-combobox--combobox',
      Angular:
        'https://angular.carbondesignsystem.com/?path=/story/components-dropdown--basic',
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-multiselect--default',
      Angular:
        'https://angular.carbondesignsystem.com/?path=/story/components-dropdown--basic',
  ...
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-multiselect--filterable',
      Angular:
        'https://angular.carbondesignsystem.com/?path=/story/components-dropdown--basic',
