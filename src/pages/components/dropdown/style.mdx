...
![Default dropdown and combobox states](images/dropdown-style-dropdown-default-states.png)

</Tab>

<Tab label="Fluid">

![Fluid dropdown and combo-box states](images/dropdown-style-dropdown-fluid-states.png)
...
<Caption>Dropdown and combobox states</Caption>
...
![Default multi-select dropdown states](images/dropdown-style-multiselect-default-states.png)

</Tab>

<Tab label="Fluid">

![Fluid multiselect dropdown states](images/dropdown-style-multiselect-fluid-states.png)
