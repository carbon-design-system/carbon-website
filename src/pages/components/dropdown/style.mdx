...
![Normal and opened dropdowns](images/dropdown-style-1.jpg)
...
![Structure and spacing for a closed dropdown](images/dropdown-style-2.jpg)
...
![Structure and spacing for a multi-select dropdown](images/dropdown-style-3.jpg)
...
![Structure and spacing for inline dropdown](images/dropdown-style-5.jpg)
...
![Hover and focus states for inline dropdown](images/dropdown-style-6.jpg)
...
![Spacing for multi-select dropdown with filtering](images/dropdown-style-7.jpg)
...
![Interaction states for multi-select dropdown with filtering](images/dropdown-style-8.jpg)
