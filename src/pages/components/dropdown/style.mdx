...
### Interactive states (by state)

| State    | Element            | Property         | Color token          |
| -------- | ------------------ | ---------------- | -------------------- |
| Focus    | Field              | border           | `$focus`             |
| Disabled | Field              | text color       | `$disabled-02`       |
|          | Field              | background-color | `$disabled-01`       |
...
| Invalid  | Field              | svg              | `$support-01`        |
|          | Field              | border-bottom    | `$support-01`        |
|          | Field              | text-color       | `$text-error`        |
| Active   | Field              | background-color | `$selected-light-ui` |
|          | Menu option        | background-color | `$selected-ui`       |
|          | Menu option: light | background-color | `$selected-light-ui` |
| Selected | Menu optioin       | background-color | `$selected-ui`       |
|          | Menu option        | checkmark        | `$icon-01`           |
|          | Tag                | background-color | `$inverse-02`        |
...
The field height and menu option height should always match.
