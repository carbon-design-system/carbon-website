...
| List               | box-shadow       | `0 2px 6px 0 rgba(0,0,0,.2)` |

### Interactive states

| Element          | State    | Property         | Color token          |
| ---------------- | -------- | ---------------- | -------------------- |
| Input field      | Focus    | border           | `$focus`             |
| List item        | Hover    | background-color | `$hover-ui`          |
...
| List item: light | Hover    | background-color | `$hover-light-ui`    |
|                  | Active   | background-color | `$selected-light-ui` |
| Checkmark        | Selected | svg              | `$icon-01`           |
| Label            | Disabled | text color       | `$disabled-02`       |
| Input field      | Disabled | background-color | `$disabled-01`       |
