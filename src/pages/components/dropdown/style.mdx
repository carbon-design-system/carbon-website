...
| Invalid        | Warning icon       | svg              | `$support-01`        |
...
<Caption>Multi-select dropdown states</Caption>
...
| Element            | State    | Property         | Color token          |
| ------------------ | -------- | ---------------- | -------------------- |
| Field              | Enabled  | background-color | `transparent`        |
|                    | Hover    | background-color | `$hover-ui`          |
| Field text         | Enabled  | text color       | `$text-01`           |
| Chevron            | Enabled  | svg              | `$icon-01`           |
| Menu option        | Enabled  | text color       | `$text-02`           |
|                    | Enabled  | background-color | `$field-01`          |
|                    | Hover    | background-color | `$hover-ui`          |
|                    | Hover    | text color       | `$text-01`           |
|                    | Active   | background-color | `$selected-ui`       |
|                    | Selected | background-color | `$selected-ui`       |
|                    | Selected | checkmark        | `$icon-01`           |
| Menu option: light | Enabled  | background-color | `$field-01`          |
|                    | Hover    | background-color | `$hover-light-ui`    |
|                    | Active   | background-color | `$selected-light-ui` |
| Error              | Invalid  | svg              | `$support-01`        |
...
|          | Menu option         | background-color | `$hover-ui`          |
|          | Menu option         | text color       | `$text-01`           |
|          | Menuo option: light | background-color | `$hover-light-ui`    |
| Active   | Menu option         | background-color | `$selected-ui`       |
|          | Menu option: light  | background-color | `$selected-light-ui` |
| Selected | Menu option         | background-color | `$selected-ui`       |
|          | Menu option         | checkmark        | `$icon-01`           |
