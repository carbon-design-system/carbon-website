...
| `.bx--dropdown-item` | text color | `$text-02` | | `.bx--dropdown-list` |
background-color | `$field-02` | | `.bx--dropdown__arrow` | svg | `$icon-01` | |
...
| Input text            | text color       | `$text-01`                   |
| Prompt text           | text color       | `$text-05`                   |
| Input field           | background-color | `$field-01`                  |
|                       | border-bottom    | `$ui-04`                     |
| Input field: light    | background-color | `$field-02`                  |
| Chevron               | svg              | `$icon-01`                   |
| List item             | text color       | `$text-02`                   |
|                       | background-color | `$field-01`                  |
| Checkbox              | background-color | `$field-01`                  |
| Checkmark             | background-color | `$field-01`                  |
