...
>
  <ComponentVariant
    id="default-dropdown"
    knobs={{
      Dropdown: ['size', 'disabled', 'invalid', 'warn'],
    }}
    links={{
      React:
  ...
  <ComponentVariant
    id="combo-box"
    knobs={{
      ComboBox: ['size', 'disabled', 'invalid', 'warn'],
    }}
    links={{
      React:
  ...
  <ComponentVariant
    id="multiselect"
    knobs={{
      MultiSelect: ['size', 'disabled', 'invalid', 'warn'],
    }}
    links={{
      React:
...
**disabled**, **skeleton**, and **read-only**.

| State       | When to use                                                                                                                                                                                                                                                                                     |
| ----------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _Enabled_   | When the component is live and a user is not directly interacting with it. This is commonly referred to as the default or normal state of the component.                                                                                                                                        |
| _Hover_     | When a user's mouse cursor is hovering over the field.                                                                                                                                                                                                                                          |
| _Focus_     | When a user tabs to or clicks on the component field, the field becomes focused, indicating the user has successfully navigated to the component.                                                                                                                                               |
| _Error_     | When the required component value has not been selected. It can also be triggered due to a system error. This state requires a user response before data can be submitted or saved.                                                                                                             |
...
| _Disabled_  | When the user cannot interact with the component and all interactive functions have been removed. Unlike read-only states, disabled states are not focusable, are not read by screen readers, and do not need to pass visual contrast, making them inaccessible if they need to be interpreted. |
...
![Default style states for dropdown and combo box](images/dropdown-combobox-usage-default-states.png)

</Tab>

<Tab label="Fluid">

![Fluid style states for dropdown and combo box](images/dropdown-combobox-usage-fluid-states.png)
...
![Default style states for multiselect](images/dropdown-multiselect-usage-default-states.png)

</Tab>

<Tab label="Fluid">

![Fluid style states for multiselect](images/dropdown-multiselect-usage-fluid-states.png)
