...
5. **Menu:** A list of options to choose from, displayed as an open state.
   from.
...
- A combo box is a combination of a standard list box or a dropdown list that
  lets users type inside the input field to find an option that matches
  their inputted value.
