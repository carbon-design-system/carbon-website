...
_Dropdowns_ present a list of options that can be used to filter or sort existing content.

They can also be used as menus. Their use as menus can be seen in [tabs](/components/tabs/code). At a smaller screen size, the tabs collapse into a dropdown.
...
![multiselect dropdown](images/dropdown-usage-1.jpg)
...
![clear all on multiselect dropdown](images/dropdown-usage-2.jpg)
...
![filter dropdown interactions](images/dropdown-usage-3.jpg)
...
![multiselect filter dropdown interactions](images/dropdown-usage-4.jpg)
