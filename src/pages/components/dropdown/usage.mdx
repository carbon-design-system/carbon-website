...
| State       | When to use                                                                                                                                                                                                                                                                                   |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| _Enabled_   | When the dropdown or combo box is live and a user is not directly interacting with it. This is commonly referred to as the default or normal state of the component.                                                                                                                          |
| _Hover_     | When a user's mouse cursor is hovering over the field.                                                                                                                                                                                                                                        |
| _Focus_     | When a user tabs to or clicks on the dropdown or combo box field, the field becomes focused, indicating the user has successfully navigated to the component.                                                                                                                                 |
| _Error_     | When the required dropdown or combo box value has not been selected. It can also be triggered due to a system error. This state requires a user response before data can be submitted or saved.                                                                                               |
