...
elements, they should not be introduced between non-interactive elements like error
states or other non-interactive icons, buttons.

A divider will also be present to the left of the leftmost interactive item set
even if its next to a non-interactive item.

<DoDontRow>
  <DoDont caption="Do introduce vertical divider between two interactive elements in an input field.">

![Do introduce vertical divider between two interactive elements in an input field.](images/usage-combobox-vertical-divider-do-1.png)

  </DoDont>
  <DoDont type="dont" caption="Do not introduce vertical divider between interactive and non-interactive items in an input field.">

![Do not introduce vertical divider between interactive and non-interactive items in an input field.](images/usage-combobox-vertical-divider-dont.png)
...
![Do introduce a vertical divider to the left of the leftmost interactive set in an input field.](images/usage-combobox-vertical-divider-do-3.png)
  ...
  <DoDont type="dont" caption="Don't use vertical dividers inconsistently in the same icon set where some icons have vertical dividers, and some don't.">

![Don't use vertical dividers inconsistently in the same icon set where some icons have vertical dividers, and some don't.](images/usage-combobox-vertical-divider-dont-4.png)
