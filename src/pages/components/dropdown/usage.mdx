...
- It is best practice not to use a dropdown if there are two options to choose from. In this case, use a [radio button](https://www.carbondesignsystem.com/components/radio-button/code) group instead.
...
- Users trigger a dropdown menu to open by clicking the chevron icon or clicking anywhere within the field. Users can close the menu by clicking the chevron icon or clicking outside of the menu. Note: You can only open a combobox by clicking the chevron icon or by typing in the field.
