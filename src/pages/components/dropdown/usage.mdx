...
- Consider using a select dropdown if most of your experience is form based or frequently used on mobile platforms. Custom dropdowns can be used in these situations, but the native select works more easily with a native form when submitting data and is also easier to use on mobile platforms. See the [select dropdown](https://www.carbondesignsystem.com/components/select/usage) component for more information.
...
- Use a select dropdown component if your experience will be frequently used on a mobile platform. The native select dropdown uses the native control for the platform which makes it easier to use.
