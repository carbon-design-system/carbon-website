...
![Do introduce vertical divider between two interactive elements in an input field.](images/usage-combobox-vertical-divider-do-1.png)
  ...
  <DoDont type="dont" caption="Do not introduce vertical divider between two non-interactive elements in an input field.">

![Do not introduce vertical divider between two non-interactive elements in an input field.](images/usage-combobox-vertical-divider-do-2.png)
