...
>>>>>>> 0179a5762121c297dda8245fc573c0f083d7d476
---
...
There are three different types of dropdowns that support various kinds of functionality. \*\*
...
- Multiselect field receives focus:
...
`Return`: Once an option in the dropdown menu receives focus, pressing `return` selects or deselects that option.

- Recommended selection model -- holding modifier keys is not necessary:
  - Space: opens and closes the dropdown menu.
