...
factors. For more information, see the form component usage guidance.
...
- By default, the dropdown displays placeholder text in the field when closed.
  Activating a closed field opens a menu of options.
...
select zero, one, or any number of items. For further guidance, see Carbon’s
[checkbox](/components/checkbox/code).
