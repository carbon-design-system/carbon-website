...
The width of an uploaded file varies based on the content and layout of a design. Refer to the [button](/components/button/code) guidelines for styling and usage of the “Add files” button.
...
![Structure and spacing measurements for file uploader](images/file-uploader-style-1.jpg)
