...
3. **Button or drop zone label:** The name of the button that selects a file to upload.
4. **Uploaded file:** A file that has been selected.
...
- Informs users about the purpose of the upload section. "Upload files" is the default text that appears with the file
  uploader.
...
To remove an uploaded file, click the "x” (or clear) icon.
