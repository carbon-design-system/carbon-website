...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="React"
    href="https://v10-react.carbondesignsystem.com/?path=/story/components-form--default"
    >
...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
      ...
      href="https://web-components.carbondesignsystem.com/?path=/story/components-input--form-item"
      >
...
>
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-form--default',
      Angular:
