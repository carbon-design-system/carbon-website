...
Refer to the [text input](/components/text-input/usage), [dropdown](/components/dropdown/usage), [checkbox](/components/checkbox/usage), [radio button](/components/radio-button/usage), [toggle](/components/toggle/usage), and [button](/components/button/usage) pages for specific typography details on each component.
...
Form headings and labels should be set in sentence case with the first letter of the first word capitalized. Refer to the [text input](/components/text-input/usage), [dropdown](/components/dropdown/usage), [checkbox](/components/checkbox/usage), [radio button](/components/radio-button/usage), [toggle](/components/toggle/usage), and [button](/components/button/usage) pages for specific typography details on each component.
