...
<DoDontRow>
  <DoDont type="do" caption="Do align fixed form inputs and labels to the grid columns using the wide grid mode.">

![An example showing a properly aligned fixed inputs](images/number-input-usage-4.png)

  </DoDont>
  <DoDont type="dont" caption="Don’t hang fixed inputs into the grid gutters. Doing so will cause labels to misalign with other form elements.">

![An example showing incorrectly aligned fixed inputs](images/number-input-usage-5.png)
...
![An example showing a properly stacked fluid inputs](images/number-input-usage-4.png)
...
![An example showing incorrectly arranged fluid inputs](images/number-input-usage-5.png)
...
information is need to assist the user in correctly completing a field, such as
...
or references may also be include if needed. In certain situations where complex
...
Fluid inputs are an exception. Due to their architectural nature, fluid inputs
do not provide the allotted space under the field needed for helper text. All
assistive text wither pertinent or additional is provided through a tooltip when
using fluid inputs.

<Row>
<Column colLg={8}>

![Example of a fluid input using a tooltip for help](images/form-usage-5b.png)
...
| Type                                                         | Overview                                                                                                                                                                                                            |
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Free form inputs](/patterns/forms-pattern/#text-inputs)     | Free-form text inputs are the most commonly used components in forms. They allow a user to enter any configuration of a letters or numbers. Common free form inputs include: text input and text area.              |
...
found here on the form component page. Below is a list of key sections available
in the pattern.
...
| Form layout                                                    | Additional guidance around layout, spacing, columns in a form.                                                  |
| Designing for longer forms                                     | Techniques to help make longer forms less overwhelming, including guidance for accordion and multistep forms.   |
| Form variants                                                  | Forms may be presented as dedicated pages, side panels, or dialogs depending on the use case and the situation. |
