...
in the entire container. The AI variants of a form function the same as the
...
When the entire form is styled for AI, it indicates to the user that AI is
present in all aspects of the form. If only a limited amount of the form content
is generated by AI, then only those components should receive the AI presence
styling, not the entire form.
