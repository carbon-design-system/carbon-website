...
The Link React Carbon Component has been tested against the latest [W3C
...
- [W3C WAI-ARIA Authoring Practices Link Design Pattern](https://www.w3.org/TR/wai-aria-practices/#link) covers the usage of ARIA names, state and roles, as well as the expected keyboard interactions.
- [IBM Accessibility Checklist - Checkpoint 2.4.4 Link Purpose (In Context)](https://www.ibm.com/able/guidelines/ci162/link_purpose.html)(WCAG Success Criteria [2.4.4](https://www.w3.org/TR/UNDERSTANDING-WCAG20/navigation-mechanisms-refs.html))
      ...
      <StructuredListBody>
        ...
        <StructuredListRow>
          <StructuredListCell>
            - Microsoft Windows 10
            <br />
            - Chrome Version 71.0.3578.9 (Official Build) (64-bit)
            <br />
