...
- If your design uses generic link names such as “read more,” consider making
  them unique. See
  [accessibility](https://carbondesignsystem.com/components/link/accessibility)
...
- Ensure links are understandable but not excessively long, especially if they
  wrap unless they are used inline.
...
and disabled. Learn more about states on the style tab.
...
![Standalone and inline link with their clickable areas](images/link-usage-clickable.png)

</Column>
</Row>

<Caption>Standalone and inline link with their clickable areas</Caption>
...
**Code unaivailibility** The following specs are not developed for the link
component but are recommended by design as the proper distance between grouped
links. View [style](https://carbondesignsystem.com/components/link/style/) tab
for details.
