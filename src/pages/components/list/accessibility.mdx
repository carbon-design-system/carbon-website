          ...
          <StructuredListCell>
            ...
            <OrderedList>
              <ListItem>
                ...
                announces, that there are 3 items in the list, then reads the
                item number, position and text.
              </ListItem>
              <ListItem>
                Control-Option-Right Arrow to read the next item and VO
                announces you are in another list that contains 2 items.
              </ListItem>
              <ListItem>
          ...
          <StructuredListCell>
            ...
            <OrderedList>
              <ListItem>
                Control-Option-Right Arrow to read the first list item. VO
                announces, that there are 3 items in the list, then reads the
                item number, position and text. (Note: Safari displays the first
                list item as 0)
              </ListItem>
              <ListItem>
                Control-Option-Right Arrow to read the next item and VO
