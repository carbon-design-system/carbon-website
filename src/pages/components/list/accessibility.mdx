...
- Carbon uses native [HTML](https://www.w3.org/WAI/tutorials/page-structure/content/#lists) ordered (`ol`) and unorder (`ul`) lists and list items (`li`), then styles them with CSS.
