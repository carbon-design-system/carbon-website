...
| ------------------------- | -------------------- | ------------- | --------------- |
| Item                      | 14 / 0.875           | Regular / 400 | `$body-long-01` |
| Item: nested              | 14 / 0.875           | Regular / 400 | `$body-long-01` |
| Item (expressive)         | 16 / 1               | Regular / 400 | `$body-long-02` |
| Item: nested (expressive) | 16 / 1               | Regular / 400 | `$body-long-02` |
