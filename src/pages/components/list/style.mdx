...
only the first word in a phrase and any proper noun capitalized. **Line height**
...
| `.bx--list--lg--item`   | 16 / 1             | Regular / 400 | `$body-short-02` |
| `.bx--list--lg--nested` | 16 / 1             | Regular / 400 | `$body-short-02` |
