...
Generally, lists should be used to present simple pieces of information. For more complex sets of data, consider using a [data table.](/components/data-table/code)
...
![Example of a list](images/list-usage-1.jpg)
