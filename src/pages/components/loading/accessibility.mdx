...
The loading component has no keyboard accessibility considerations since it is intentionally not operable or navigable. However, design annotations are needed for specific instances shown below.
...
![annotation indicates what item takes focus after loading completes](images/loading-accessibility-2.png)

<Caption>
  If a component can be given focus after loading completes, annotate that.
</Caption>
