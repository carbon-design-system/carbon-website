...
Where no content changes happen as the loading icon disappears, the information can be surfaced to users through a non-displayed status message, such as "finished" or "loading complete," that can be conveyed to users through assistive technology. 
