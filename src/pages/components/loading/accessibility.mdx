...
The Carbon inline loading component is used to notify user’s that the page content is loading. W3C WAI-ARIA `role="alert"` and `aria-live="assertive"` are used to ensure screen reader users are also provided the same information.
