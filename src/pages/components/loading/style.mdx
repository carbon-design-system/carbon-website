...
Text is not included with the loading indicator by default. If including text,
it is recommended to use `body-compact-01` with the large indicator or with the
small indicator. See more specific typography guidance on the inline loading
[Style](/components/inline-loading/style) tab.
...
![Loading indicator sizes](images/loading-style-size.png)

</div>

<Caption>Loading indicator sizes</Caption>
