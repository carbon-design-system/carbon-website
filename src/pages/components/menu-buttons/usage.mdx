...
about size specifications on the [Style](/components/menu-buttons/style/) tab. When
...
Menu button comes in three different button types: primary,
tertiary, and ghost. For detailed visuals, visit the [Style](/components/menu-buttons/style/#menu-button-color) tab.
