...
Menu buttons come in three sizes: small, medium, and large. See more
...
height of the button being used.
...
Menu (/components/menu/usage/) items come in four sizes: extra small, small, medium, and large. See more
...
Menu button comes in three different button types: [primary](/components/menu-buttons/style/#menu-button-color),
[tertiary](/components/menu-buttons/style/#menu-button-color), and [ghost](/components/menu-buttons/style/#menu-button-color).
