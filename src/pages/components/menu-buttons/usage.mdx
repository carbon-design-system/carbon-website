...
| Variant                         | Purpose                                                                                                                                                      |
| ------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [Menu button](#menu-button)     | Use a menu button when all actions in the menu list share the same level of importance. Usually used in the page header.                                     |
...
| [Overflow menu](#overflow-menu) | Use an overflow button when additional options are available to the user and there is a space constraint. They are usually used in tiles or data table rows. |
...
- Menu buttons come in three different button types: primary, tertiary, and
  ghost.
- Overflow button is treated as the ghost button, displaying only an icon and
