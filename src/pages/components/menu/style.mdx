...
![Default menu option structure](images/style-menu-structure-action-items-menu.png)

</div>

<div className="image--fixed">

![Selected menu option structure](images/style-menu-structure-action-items-submenu.png)
