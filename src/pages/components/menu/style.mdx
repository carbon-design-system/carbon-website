...
![Menu default state](style-menu-default-state.png)
...
![Menu interactive states](style-menu-interactive-states.png)
...
![Selected menu option item structure](style-menu-structure-action-items-submenu.png)
...
a fixed minimum width of 160px, to ensure menu items have sufficient horizontal
space, while also having a fixed maximum width of 288px.
