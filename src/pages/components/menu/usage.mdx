...
defined list of options in a menu is a defined list of options in a menu that
appears above all other content on a page and is related to the selected content
or element it was triggered from.
...
![Do match the width when the menu or combo button labels become longer](images/usage-menu-width-do-2.png)

  </DoDont>
  <DoDont type="dont" caption="Do not make the menu appear shorter than the menu or combo buttons">

![Do not make the menu appear shorter than the menu or combo buttons](images/usage-menu-width-dont-2.png)
...
![Menu alternative alignments](images/usage-menu-alignment-menu-buttons-alternatives.png)
...
menus used under [menu buttons], keep the list smaller with under 5 action
items.
