...
![Modal anatomy diagram](images/modal-usage-anatomy.jpg)
...
![Passive modal example](images/modal-usage-passive.jpg)
...
![Two button modal example](images/modal-usage-two-buttons.jpg)
...
![Three button modal example](images/modal-usage-three-buttons.jpg)
...
![danger modal](images/modal-usage-danger.jpg)
...
![One button modal example](images/modal-usage-one-button.jpg)
...
![Progress modal example](images/modal-usage-progress.jpg)
...
![Modal sizes](images/modal-usage-sizes.jpg)
...
![Modal sizes](images/modal-usage-title.jpg)
...
![Modal sizes](images/modal-usage-max-heights.jpg)
