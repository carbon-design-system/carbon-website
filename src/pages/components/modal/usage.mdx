...
Modal has a modification that takes on the AI visual styling when the AI slug is
present in the input. The AI variant of a modal functions the same as the normal
