...
does not interrupt the users current task and queues the notification until
...
interrupts the users current task. These are considerably more disruptive to
