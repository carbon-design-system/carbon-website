...
Products can choose whether to use the high contrast or low contrast notification style. Inline and toast notifications can use different styles but you should never mix styles within the variations.

The high contrast style is more attention grabbing and should be used for high impact messaging. The low contrast notifications have a more supplemental connotation and are less visually disruptive to users. When in doubt, use the low contrast style.
