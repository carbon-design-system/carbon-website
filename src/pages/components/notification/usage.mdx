...
![Examples of inline notification placements across different UI layouts](images/02_notification_format_608.png)
...
![Example of inline notification  supporting an error message on a form](images/notification-usage-placement.png)
...
![Examples of toast notification placements across different UI layouts](images/04_toast_format_608.png)
