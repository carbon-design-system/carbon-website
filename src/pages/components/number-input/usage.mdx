...
![Anatomy of a fixed number input](images/number-input-usage-2.png)

</Tab>

<Tab label="Fluid">

![Anatomy of a fixed number input](images/number-input-usage-2-fluid.png)
...
There are two styles of number inputs, fixed and fluid. They share the same
...
![An example of a fixed and fluid number input](images/number-input-usage-11.png)
...
Number input has three sizes fixed input heights: **small**, **medium**, and
...
![Fixed number input sizes](images/number-input-usage-3.png)
...
![Fixed number input interactive states](images/number-input-usage-6.png)
...
![Fixed number input mouse and keyboard interactions](images/number-input-usage-7.png)
