...
![Overflow menu text hover example](images/overflow-menu-style-1.jpg)
...
![Structure and spacing measurements for an overflow menu](images/overflow-menu-style-3.jpg)
