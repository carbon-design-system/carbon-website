...
![An overflow menu icon button interactive states](images/overflow-menu-style-2.png)
...
![An open overflow menu interactive states](images/overflow-menu-style-3.png)
