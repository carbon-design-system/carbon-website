...
| Danger option:hover  | background-color | `$button-danger-hover` |
| Menu option:disabled | text color       | `$text-disabled`       |

<Row>
<Column colLg={8}>

![An overflow menu icon button interactive states](images/overflow-menu-usage-2.png)
...
![An open overflow menu interactive states](images/overflow-menu-usage-3.png)
