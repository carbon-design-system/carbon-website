...
default, this feature is turned off, but can be toggled on to enable the feature
flag.
...
Additionally, when clicking on the "**components details**" (C) in the
properties panel, a description of what a feature flag is and a link to the
components usage guidance is provided for more information in the "**Component
