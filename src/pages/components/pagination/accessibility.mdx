...
`Space` or using arrow keys activates the menu to choose an available page to
navigate to. Arrow keys navigate between page options in the menu. `Space` or
`Enter` selects a page from the menu and closes it. The menu can also be closed
by pressing `Esc`.

<Row>
<Column colLg={12}>

![The menu opens by pressing Space or using arrow keys and pressing Space or Enter selects a page from
  the menu and closes it.](images/pagination-a11y-4.png)

<Caption>
  The menu opens by pressing Space or using arrow keys and pressing Space or
  Enter selects a page from the menu and closes it.
</Caption>
