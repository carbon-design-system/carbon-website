...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="React"
    href="https://v10-react.carbondesignsystem.com/?path=/story/components-pagination--pagination"
    >
...
>
  <ComponentVariant
    ...
    links={{
      React:
        'https://v10-react.carbondesignsystem.com/?path=/story/components-pagination--pagination',
      Angular:
        'https://angular.carbondesignsystem.com/?path=/story/components-pagination--basic',
      Vue: 'http://vue.carbondesignsystem.com/?path=/story/components-cvpagination--default',
