...
![Spacing measurements for pagination](images/pagination-style-structure-pagination.png)
...
![Structure measurements for pagination nav](images/pagination-style-structure-pagination-nav.png)

</div>

<Caption>Structure measurements for pagination nav | px / rem</Caption>
