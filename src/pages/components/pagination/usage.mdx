...
- Do not use it to display linear journeys, for example, in a form progression.
  Instead, use the [progress
  bar(https://carbondesignsystem.com/components/progress-bar/usage/)] or
  [button](https://carbondesignsystem.com/components/button/usage/) components
...
The select component's text is in number form by default. It shows the number of
