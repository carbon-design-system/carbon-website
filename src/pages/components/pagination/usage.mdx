...
3. **Current page:** Shows the current page the user is on and lists the total
   amount of pages. 4.**Previous and next buttons:** Buttons that take you to
   the previous or next page.
4. **Container:** The container bar of the whole pagination component.
...
which it is paginating and related to. When using the pagination nav variant on
a page, float it below the content to which it is paginating and related to. The
pagination can be right aligned or left aligned to the content above it. When it
doubt, choose right alignment.
...
The select components text is in number form by default. It shows the number of
