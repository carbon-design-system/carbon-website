...
browser edges to properly place themselves in view without cutoff.
Alternatively, popovers can also specify distinct directions. Direction options
vary depending on the popover variant.
