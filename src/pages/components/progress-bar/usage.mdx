...
![Determinate progress bar](/images/progress-bar-usage-4.gif)
...
![Indeterminate progress bar](/images/progress-bar-usage-5.gif)
...
helper text. However, the indeterminate can’t provide the exact, quantiative
...
space is restricted and can be placed within cards, data tables, or side panels.
...
![Don’t embed text into the progress bar](images/progress-bar-usage-13.png)
...
<GifPlayer>![Progress bar RTL](/images/progress-bar-usage-11.gif)</GifPlayer>
