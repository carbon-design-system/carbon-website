...
three ways for text alignment: default, inline, and indented. As long as the
text is placed close to the progress bar, it’s up to designers to provide the
best judgement that fits the context.
