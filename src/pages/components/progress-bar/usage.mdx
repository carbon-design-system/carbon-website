...
translated into a bar indicator which fills from the track 0% to 100% and never
...
- Label text should never be changed as the progress bar is loading. It also does not need to be updated when the process ends, since the success or error information is provided by the bar indicator color and an icon, along with any helper text. 
