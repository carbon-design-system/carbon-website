...
4. **Helper text (optional):** Assistive text to show additional information
   about the process taking place. Not optional for an error. For determinate, the information is usually
...
<Caption>
  ...
  confirmation inside the image tile. Another upload is initiated. The progress bar shows the upload success and then is automatically dismissed.
</Caption>
