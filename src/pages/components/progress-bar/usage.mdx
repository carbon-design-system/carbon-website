...
<<<<<<< HEAD decrease in value. The entire animation moves from the left to the
right — with ======= decreases in value. The entire animation moves from the
left to the right – with

> > > > > > > bd3e870ea9e25ae9a4701968d64950b7f38457d2 no back and forth motion.
