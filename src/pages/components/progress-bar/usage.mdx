...
4. **Helper text (optional):** Assistive text to show additional information
   ...
   the information is usually values of number or percentage. Sometimes, a
...
- Label text should not be changed as the progress bar is loading or when it completes. The success or error information is provided by the bar indicator color and an icon, along with any helper text. 
