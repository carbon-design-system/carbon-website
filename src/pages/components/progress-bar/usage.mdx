...
![Determinate progress bar](/images/progress-bar-usage-4.png)
...
![Indeterminate progress bar](/images/progress-bar-usage-5.png)
...
![Determinate progress bar](/images/progress-bar-usage-11.gif)

![Determinate progress bar](/images/progress-bar-usage-11.png)
...
![The example shows the progress bar with error remains persistent as confirmation inside the image tile](images/progress-bar-usage-17.png)
...
![The example shows thep progress bar is automatically dismissed once it’s done uploading](images/progress-bar-usage-18.png)
...
![An indeterminate bar can change to a determinate indicator](/images/progress-bar-usage-21.png)
