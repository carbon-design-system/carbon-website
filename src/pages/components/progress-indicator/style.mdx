...
| `.bx--progress-step--current` <br/> `.bx--progress-line`    | background-color | `$interactive`    |
| `.bx--progress-step--incomplete` <br/> `.bx--progress-line` | background-color | `$layer-accent`   |
