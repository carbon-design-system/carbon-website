...
Use validation to confirm that a previous step has been completed. If the user cannot proceed onto another step without first completing a task, use an [Inline Notification](/components/notification/code#inline-notification) to inform them.

<Row>
<Column colLg={8}>

![Example of the progress indicator in a payment UI](images/progress-indicator-usage-1.jpg)
