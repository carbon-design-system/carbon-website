...
_Progress indicator_ is a visual representation of a users progress through a
set of steps. They guide the user through a number of steps in order to complete
a specified process.
...
are performing a multi-step process, and show the direction of movement. Allow
