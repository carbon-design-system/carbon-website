...
1. **Icon:** Communicates what needs to be selected below.
2. **Active step line:** Indicates these states–current and completed
3. **Label:** A checkbox input indicating the appropriate state. By default it
   is unselected.
4. **Inactive step line:** Indicates these states–incomplete, error, disabled,
   and skeleton
5. **Optional label or error label:** Describes the information you want to
   select or unselect.
