...
### Labeling
Carbon surfaces the labelling of radio buttons and groups to screen readers and other assistive technologies.  Carbon also provides guidance on ways of accessibly surfacing required fields, and programmatically indicates those where the [forms guidance](https://carbondesignsystem.com/components/form/usage#optional-versus-required-fields) is followed.

<Row>
<Column colLg={8}>

![group and radio button labels are identified](images/radio-button-accessibility-1.png)

<Caption>
  Carbon provides radio button labels and group labels to assistive technologies.
</Caption>
