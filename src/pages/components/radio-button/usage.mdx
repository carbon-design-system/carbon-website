...
**Forms** Can be used in forms on a full page, in modals, or on side panels.

**Settings** Used to change from one setting to another in a menu, page, or
component.

**Selection in lists** Used to choose a singular item within data tables or
lists.
