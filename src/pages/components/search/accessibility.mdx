...
<Column
colMd={4} colLg={4}
caption="A variation where the search input is revealled when the magnifying glass receives focus.">

![putting focus on the magnifying glass causes the search input to be revealed](images/search-accessibility-4.png)
...
![data table narrow ](images/search-accessibility-3.png)
...
![two illustrations showing the search icon being activated, via Enter or Space, or focused to reveal the search input](images/search-accessibility-3.png)

<Caption>
   Two variations, where the search input is revealled through interaction with the magnifying glass icon.
</Caption>
...
![](images/search-accessibility-4.png)
...
Carbon contains a [search](https://carbondesignsystem.com/patterns/search-pattern/) pattern that outlines three search types: basic, active, and focused. Each of these types starts with the basic search input mechanism provided by Carbon’s search component. However, each search type displays suggestions or results in different ways, which have accessibility considerations. There are three broad areas that designers need to consider and annotate for accessibility:
...
-	The label for the input has a default value of “Search”
