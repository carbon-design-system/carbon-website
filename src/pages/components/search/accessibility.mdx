...
colMd={4} colLg={4}>
<Caption>
  A variation where the search input is revealled by activating the magnifying glass icon."
</Caption>
...
colMd={4} colLg={4}>
<Caption>
  A variation where the search input is revealled when the magnifying glass receives focus."
</Caption>
