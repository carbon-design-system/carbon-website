...
![Do use the default end icon alignment to keep accordion text aligned with other content on the page.](images/search-accessibility-3.png)
...
![Do place icons on the start side for tree like functionality.](images/search-accessibility-4.png)
