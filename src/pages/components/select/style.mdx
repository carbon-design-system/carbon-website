...
![Enabled state of default select with AI presence](images/select-AI-default-style.png)

</Tab>

<Tab label="Fluid">

![Enabled state of fluid select with AI presence](images/select-AI-fluid-style.png)
