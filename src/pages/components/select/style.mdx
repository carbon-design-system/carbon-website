...
![Enabled state of default select with AI presence](images/select-usage-AI-presence-default-style.png)

</Tab>

<Tab label="Fluid">

![Enabled state of fluid select with AI presence](images/select-usage-AI-presence-fluid-style.png)
...
![Structure and spacing measurements for default select with AI presence | px / rem](images/select-usage-AI-presence-default-style.png)
