...
![Example of select](images/select-style-color.png)

</div>

<Caption>Example of select</Caption>
...
![Structure and spacing measurements for fixed default select](images/select-style-2.png)
...
| Element      | Property                    | px / rem | Spacing token |
| ------------ | --------------------------- | -------- | ------------- |
| Input text   | padding-left                | 8 / 0.5  | `$spacing-03` |
| Chevron icon | padding-left, padding-right | 8 / 0.5  | `$spacing-03` |

<div className="image--fixed">

![Structure and spacing measurements for fixed inline select](images/select-style-6.png)
