...
![Default and new selection state examples for Select](images/select-style-1.jpg)
...
![Open, disabled, and more information/help state examples for Select](images/select-style-3.jpg)
...
![Structure and spacing measurements for select](images/select-style-2.jpg)
...
![Structure and spacing measurements for small select](images/select-style-4.jpg)
...
![Structure and spacing measurements for Inline Select](images/select-style-6.jpg)
