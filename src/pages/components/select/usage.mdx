...
![Enabled state of default select with AI presence](images/select-AI-presence-default-usage.png)

</Tab>

<Tab label="Fluid">

![Enabled state of fluid select with AI presence](images/select-AI-presence-fluid-usage.png)
...
![Enabled state of default select with AI presence](images/select-revert-to-AI-default-usage.png)

</Tab>

<Tab label="Fluid">

![Enabled state of fluid select with AI presence](images/select-revert-to-AI-fluid-usage.png)
