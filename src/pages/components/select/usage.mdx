...
![Example of a small select](images/select-usage-3.jpg)
...
![Example of a small select](images/select-usage-4.jpg)
...
![Example of a small select](images/select-usage-1.jpg)
