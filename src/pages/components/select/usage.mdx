...
[AI presence](/components/select/usage/#ai-presence) section for more details.
...
<StorybookDemo
  ...
  variants={[
    ...
    {
      label: 'With AI slug',
      variant: 'experimental-unstable-slug-examples--select',
    },
  ]}
/>

<A11yStatus layout="cards" components={['Select', 'Fluid select']} />
...
![Default select with AI presence](images/select-AI-presence-default-usage.png)

</Tab>

<Tab label="Fluid">

![Fluid select with AI presence](images/select-AI-presence-fluid-usage.png)
...
![Default select with AI revert](images/select-revert-to-AI-default-usage.png)

</Tab>

<Tab label="Fluid">

![Fluid select with AI revert](images/select-revert-to-AI-fluid-usage.png)
