...
<AnchorLink>Other guidelines</AnchorLink>
...
Small selects are commonly used in [data tables](/components/data-table/usage). When using a small select for a number selection, the increments in the select should be 10, 25, 50 and 100. The maximum amount of items a user can see per page is 100.
