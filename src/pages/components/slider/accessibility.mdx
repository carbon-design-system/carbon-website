...
- [W3C WAI-ARIA Authoring Practices Slider Design Pattern](https://www.w3.org/TR/wai-aria-practices/#slider) covers the usage of ARIA names, state and roles, as well as the expected keyboard interactions.
