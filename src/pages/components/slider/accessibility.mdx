...
<Caption>Both the slider and input are in the tab order and keyboard operable.</Caption>
...
<Caption>The slider label is programmatically associated with both the slider and input.</Caption>
...
* See the [ARIA authoring practices](https://www.w3.org/TR/wai-aria-practices-1.2/#slider) for more considerations.