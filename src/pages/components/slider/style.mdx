...
![Structure and spacing measurements for slider enabled state](images/slider-style-structure-default-enabled.png)

</div>

<div className="image--fixed">

![Structure and spacing measurements for slider error state](images/slider-style-structure-default-error.png)
