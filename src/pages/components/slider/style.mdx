...
| `.bx--slider__thumb:active`        | fill             | `$interactive` |
| `.bx--slider__filled-track:active` | background-color | `$interactive` |
| `.bx--label:disabled`              | text color       | `$text-disabled`    |
| `.bx--slider__thumb:disabled`      | fill             | `$icon-disabled`    |
| `.bx--slider__track:disabled`      | background-color | `$border-disabled`    |

## Typography

_Slider_ labels should be set in sentence case, with only the first word in a
