...
![Default structured list color background](images/structured-list-style-color-default-background.png)

<Caption>Default structured list color background</Caption>
...
![Selectable structured list color with feature flag enabled](images/structured-list-style-color-selectable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Selectable structured list color with feature flag disabled](images/structured-list-style-color-selectable-flag-disabled.png)
...
![Selectable structured list color background with a feature flag](images/structured-list-style-color-selectable-background.png)

<Caption>
  Selectable structured list color background with a feature flag
</Caption>
...
![Selectable structured list interactive states with feature flag enabled](images/structured-list-style-interactive-color-selectable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Selectable structured list interactive states with feature flag disabled](images/structured-list-style-interactive-color-selectable-flag-disabled.png)
...
![Selectable structured list interactive state color background with a feature flag](images/structured-list-style-interactive-color-selectable-background.png)

<Caption>
  Selectable structured list interactive state color background with a feature
  flag
</Caption>
