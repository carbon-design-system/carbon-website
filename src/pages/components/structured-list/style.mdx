...
| Header (transparent option) | background-color | transparent          |
| Header (background option)  | background-color | `layer` \*           |
| Row text                    | text-color       | `$text-secondary` \* |
| Row divider                 | border-bottom    | `$border-subtle` \*  |
| Row (transparent option)    | background-color | transparent          |
| Row (background option)     | background-color | `$layer` \*          |
...
| Element             | State             | Proptery         | Color token                |
| ------------------- | ----------------- | ---------------- | -------------------------- |
