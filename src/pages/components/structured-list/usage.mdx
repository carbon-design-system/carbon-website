...
![data table anatomy](images/structured-list-usage-1.png)
...
Row height varies based on content and can expand to fit multiple lines. In a
single list, all rows do not have to be the same height. Column widths can
either be equally proportional or proportioned based on content.
