...
- Nesting items is not recommended, as structured lists are used to present
  simple data. If you have more than 25 rows or more complex content that needs
  to be shown, consider using a
...
These lists usually consist of read-only information and rows can not be
selected.
...
**focus**, **selected**, **disabled**, and **skeleton**. For more information on
...
<Caption>
  {' '}
  Example of the background color option modifier applied to structured list{' '}
</Caption>
