...
accessibility and changes its visual appearance, not its functionality. For
...
![Selectable tructured list with feature flag enabled](images/structured-list-usage-selectable-flag-enabled.png)
