...
![A user reaches the tablist with the Tab key then changes the selected tab item with left and right arrow keys. Pressing the Tab key again moves focus to a link inside the tabpanel's content.](images/tab-accessibility-1.png)
...
Automatic and manual tablists differ in how they are activated. The following
