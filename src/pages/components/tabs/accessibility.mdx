...
<Caption>
  After pressing the right arrow key, the second tab is selected in an automatic
  tablist. For the manual tablist, Details has focus but Overview is still
  selected. Pressing the Space or Enter key will select Details.
</Caption>
