...
<Caption>
  Examples of selected close hover and selected focus states for dismissible line
  tabs.
</Caption>
...
<Caption>
  Examples of hover, unselected-focus, focus-selected, and disabled states for
  contained tabs.
</Caption>
