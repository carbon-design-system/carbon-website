...
![Examples of hover, focus-unselected, focus-selected, and disabled states for line tabs.](images/tab-style-2.png)
...
<Caption>
  Examples of selected close hoverand  selected focus states for dismissible line tabs.
</Caption>
...
![Examples of hover, unselected-focus, focus-selected, and disabled states for contained tabs.](images/tab-style-8.png)

</Column>
</Row>

<Caption>
  Examples of hover, unselected-focus, focus-selected, and disabled states for contained tabs.
</Caption>
