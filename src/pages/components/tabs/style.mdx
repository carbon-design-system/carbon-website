...
![Examples of hover, focus-unselected, focus-selected, and disabled states for dismissible line tabs](images/tab-style-11.png)
...
<Caption>Examples of selected and unselected dismissible contained tabs.</Caption>
...
![Hover, focus-enabled, focus-selected, and disabled states for dismissible contained
tabs.](images/tab-style-12.png)

</div>

<Caption>
  Hover, focus-enabled, focus-selected, and disabled states for dismissible contained tabs.
</Caption>
...
<Caption>Structure and spacing measurements for line tabs without icons (top) and with icons (bottom) | px / rem</Caption>
