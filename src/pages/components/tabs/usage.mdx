...
![Example how automatic tabs content switches when focus moves tabs using the arrow keys](/images/tab-usage-12a.gif)
...
![Example how manual tabs content switches when focus moves tabs using the arrow keys and then enter](/images/tab-usage-12b.gif)
