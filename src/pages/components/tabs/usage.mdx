...
![Example how automatic tabs content switches when focus moves tabs using the arrow keys](/images/tab-usage-12a-animated.gif)

![Example how automatic tabs content switches when focus moves tabs using the arrow keys](/images/tab-usage-12a.png)
...
Example of automatic tabs. Tab panel updates automatically when the user
navigates focus with the right and left arrow keys.
...
navigate through the tablist without having to wait for content to load.

<Row>  
<Column colLg={8}>  
<GifPlayer color='dark'>

![Example how manual tabs content switches when focus moves tabs using the arrow keys and then enter](/images/tab-usage-12b-animated.gif)

![Example how manual tabs content switches when focus moves tabs using the arrow keys and then enter](/images/tab-usage-12b.png)
...
Example of manual tabs. The tab panel updates after the user navigates focus
with the right and left arrow key and then presses enter or space. The above
examples uses the enter key.
