...
arrows to a tab, it becomes selected, and the tabpanel under the tab is updates
automatically.

Manual tablists allow the user to arrow between the tab items without updating
the tabpanel underneath. When the user navigates using arrows, the selected tab
...
![Example of the responsive behavior of the content switcher](/images/tab-usage-12a-animated.gif)

![Example of the responsive behavior of the content switcher](/images/tab-usage-12a.png)
...
![Example of the responsive behavior of the content switcher](/images/tab-usage-12b-animated.gif)

![Example of the responsive behavior of the content switcher](/images/tab-usage-12b.png)
...
Automatic and manual tab keyboard interactions.
...
![Dismissible tabs](images/tabs-usage-18.png)
...
![Dismissible tabs](images/tabs-usage-19.png)
