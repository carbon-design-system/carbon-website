...
![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-4.png)
...
![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-5.png)
...
A. Label <br /> B. Indicator <br /> C. Icon (optional) <br /> D. Container

<br /> E. Secondary label (optional)
...
alignment of tabs depend on where they appear and whether or not they're
...
![Do left-align text in a button, even if the button is wide.](images/tab-usage-6-do.png)

  </DoDont>
  <DoDont type="dont" caption="Do not align tab container with the grid">

![Do not center text in a button, even if the button is wide.](images/tab-usage-6-dont.png)
...
have have consistent padding on each side of the label. The first label,
selected by default, should align to the grid. Where the tabs end will vary and
may not end on the grid. If needed, you may also use a rule to help balance tabs
with other components on the page.

<Row>
<Column colLg={12}>

![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-7.png)
...
![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-8.png)
...
depending on the containers margins. To add hierarchical clarity and balance the
tabs with the other content, a line may be added from the end of the last tab to
edge of the content area.

<Row>
<Column colLg={8}>

![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-9.png)
...
![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-10.png)

</Column>
</Row>

<Caption>
  Example of selected, unselected, and diabled states in line tabs (top) and
...
![Examples of line tabs (top) and contained tabs (bottom)](images/tab-usage-11.png)
...
spaces and in components. Always use a tool tip for an icon description on hover
to add clarity.
