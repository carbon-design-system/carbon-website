...
<Caption>
  {' '}
  Example of automatic tab automatically updating when users changes focus with the
  arrow keys.{' '}
</Caption>
...
<Caption>
  {' '}
  Example of manual tabs updating after the user presses enter (like the example)
  or space.{' '}
</Caption>
