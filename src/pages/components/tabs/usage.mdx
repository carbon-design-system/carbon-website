...
may not end on the grid. If needed, you may also use a line to help balance tabs
...
[tab accessibility](https://carbondesignsystem.com/components/tabs/accessibility).
