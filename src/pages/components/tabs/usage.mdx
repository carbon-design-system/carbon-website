...
<Caption>Note: The close icon to the left of the tab is an example of a pattern. It is not currently implemented in the component.</Caption>
...
<Caption>Note: The icon to the left of the tab  and the secondary label is an example of a pattern. It is not currently implemented in the component.</Caption>
...
<Caption>
  ...
  implemented by default in the component.
</Caption>
