...
Read-only tags are not in the tab order and are not interactive and do not
receive focus unless the tags title is truncated.

<Row>
<Column colLg={8}>

![Read-only tag within the tab order displaying a tooltip activated on focus to reveal overflow tag title text.](images/tag-accessibility-read-only.png)

</Column>
</Row>

<Caption>
  Read-only tag within the tab order displaying a tooltip activated on focus to
  reveal overflow tag title text.
</Caption>
...
disclosed in a tooltip on focus. Truncation should be set at the title's start,
middle, or end, depending on what is best for the given use case.

<Row>
<Column colLg={8}>

![A tag with a truncated title, disclosing the full title on focus in a tooltip.](images/tag-accessibility-overflow.png)

</Column>
</Row>

<Caption>
  A tag with a truncated title, disclosing the full title on focus in a tooltip.
</Caption>
