...
The four tag variants, read-only, dismissible, selectable, and operational, have
differences in color tokens.

#### Read-only, dismissible, and operational tag color
...
#### Selectable tag interactive states
