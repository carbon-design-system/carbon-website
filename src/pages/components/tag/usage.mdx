...
are now available. Though we are not deprecating the current tags, we encourage
all design teams to use the new dismissible, operational, and selectable tag
variants in their products moving forward.
