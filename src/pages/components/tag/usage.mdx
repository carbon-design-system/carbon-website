...
| [Dismissible tag](#dismissible) | Tags that can be dismissed, closed, or removed. These tags are typically used for filtering and creating user-generated content.                                                                    |
| [Selectable tag](#selectable)   | Tags that can be selected or deselected and are frequently used as selections that filter data in the context of a page. They also can be used in chat flows to make decisions to advance the chat. |
| [Operational tag](#operational) | When interacted with, these tags can disclose additional or overflow tags, like in a toggletip, popover, modal, or breadcrumb detail view.                                                          |
