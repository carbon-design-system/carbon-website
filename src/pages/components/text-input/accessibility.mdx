...
Carbon programmatically surfaces both the input's label and any helper text to assistive technologies such as screen readers. Any error messages for text inputs also accessibly revealed.

<Row>
<Column colLg={8}>

![Date label and date input requirement are shown as being accessibly provided](images/text-input-accessibility-3.png)
