...
<ComponentDemo
  ...
  <ComponentVariant
    ...
    links={{
      ...
      "Web Components": 'https://web-components.carbondesignsystem.com/?path=/story/components-input--default',
    }}>{`
    <div>
      <TextInput
  ...
  <ComponentVariant
    ...
    links={{
      ...
      Vanilla: 'https://the-carbon-components.netlify.com/?nav=text-input',
      "Web Components": 'https://web-components.carbondesignsystem.com/?path=/story/components-textarea--default',
    }}>{`
    <div>
    <TextArea
      cols={50}
