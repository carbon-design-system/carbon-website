...
![Example of an enabled text input in the default style](images/text-area-style-color-fixed.png)

</Tab>

<Tab label="Fluid">

![Example of an enabled text input in the fluid style](images/text-area-style-color-fluid.png)
...
![Examples of text input states in the default style](images/text-area-style-states-fixed.png)

</Tab>

<Tab label="Fluid">

![Examples of text input states in the fluid style](images/text-area-style-states-fluid.png)
