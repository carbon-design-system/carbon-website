...
![Default and user input states for text input in both field colors](images/text-input-style-1.jpg)
...
![Structure and spacing measurements for text input](images/text-input-style-2.jpg)
...
![Active, help, error or disabled states for text input](images/text-input-style-3.jpg)
