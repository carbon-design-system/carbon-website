...
characters is reached the text area should prevent the user from entering any
...
![Example showing a word counter in text area](images/text-area-word-counter.jpg)
