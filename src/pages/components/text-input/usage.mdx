...
| Style | Purpose                                                                                                                                                                                                                                            |
| ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fixed | Fixed is the most commonly used text area style with the label and helper text outside the field. Use when white space is needed between input components or in productive moments where space is at a premium, and smaller components are needed. |
...
<DoDontRow>
  <DoDont caption="Align fixed input containers to the grid so the input label aligns with other type on the page.">

![Do align field containers to the grid.](images/text-input-usage-4-do.png)

  </DoDont>
  <DoDont caption="Hang fluid input containers into the gutters so the input label aligns with other type on the page.">
...
circumstance. For more guidance on requirement labeling, see the
[form pattern](/patterns/forms-pattern/#optional-vs.-mandatory).
