...
[AI presence](/components/text-input/usage/#ai-presence) section for more
details.
...
<StorybookDemo
  ...
  variants={[
    ...
    {
      label: 'Text Area with AI slug',
      variant: 'experimental-unstable-slug-examples--text-area',
    },
    {
      label: 'Text Input with AI slug',
      variant: 'experimental-unstable-slug-examples--text-input',
    },
  ]}
/>
