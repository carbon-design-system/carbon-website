...
![An example of a text input.](images/text-input-header-usage.jpg)
...
![Validation text example](images/text-input-usage-2.jpg)
...
![An example of a text area.](images/text-area-usage-1.jpg)
...
![Placeholder text example](images/text-input-usage-1.jpg)
...
![Help text example](images/text-input-usage-3.jpg)
