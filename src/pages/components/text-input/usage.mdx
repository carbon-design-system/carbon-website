...
![Anatomy of a text input in the fixed style](images/text-input-usage-anatomy-fixed.png)
...
![Fixed text input heights](images/text-input-usage-size.png)
...
![Anatomy of a text area in the fixed style](images/text-area-usage-anatomy-fixed.png)
...
![Do use proportional widths](images/text-input-usage-width-do.png)

  </DoDont>
  <DoDont type="dont" caption="Do not make text inputs excessively wide just to fill in space. ">

![Do not make inputs excessively wide.](images/text-input-usage-width-dont.png)
...
![Example showing click target areas for text input in the fixed style](images/text-input-usage-mouse-fixed.png)
