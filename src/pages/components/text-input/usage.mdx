...
There is only one fluid input height and it is visually larger than the defaults
...
![Do align field containers to the grid.](images/text-input-usage-4-do-fixed.png)
...
![Text input states in the fixed style](images/text-input-states-fixed.png)

</Tab>

<Tab label="Fluid">

![Text input states in the fluid style](images/text-input-states-fluid.png)
