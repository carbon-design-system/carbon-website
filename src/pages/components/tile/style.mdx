...
![Clickable tile color feature flag enabled](images/tile-style-color-clickable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Clickable tile color feature flag disabled](images/tile-style-color-clickable-flag-disabled.png)
...
Clickable tiles has three interactive states: hover, focus, and disabled.
...
![Clickable tile interactive color feature flag enabled](images/tile-style-interactive-color-clickable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Clickable tile interactive color feature flag disabled](images/tile-style-interactive-color-clickable-flag-disabled.png)
...
![Selectable tile color feature flag enabled](images/tile-style-color-selectable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Selectable tile color feature flag disabled](images/tile-style-color-selectable-flag-disabled.png)
...
Selectable tiles have five states for both the single-select and multi-select
types: hover, hover selected, selected, focus, and disabled.
...
![Selectable tile interactive color feature flag enabled](images/tile-style-interactive-color-single-select-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Selectable tile interactive color feature flag disabled](images/tile-style-interactive-color-single-select-flag-disabled.png)
...
![Expandable tile color feature flag enabled](images/tile-style-color-expandable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Expandable tile color feature flag disabled](images/tile-style-color-expandable-flag-disabled.png)
...
Expandable tile has three interactive states: hover, focus, and disabled.
...
![Expandable tile interactive color without interactive elements feature flag enabled](images/tile-style-interactive-color-expandable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Expandable tile interactive color without interactive elements feature flag disabled](images/tile-style-interactive-color-expandable-flag-disabled.png)
...
![Expandable tile interactive color with interactive elements feature flag enabled](images/tile-style-interactive-color-expandable-element-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Expandable tile interactive color with interactive elements feature flag disabled](images/tile-style-interactive-color-expandable-element-flag-disabled.png)
...
![Structure and spacing measurements for clickable tile with a feature flag | px / rem](images/tile-style-structure-clickable.png)

</div>

<Caption>
  Structure and spacing measurements for clickable tile with a feature flag | px
  / rem
</Caption>
...
<Caption>
  Structure and spacing measurements for selectable tile with feature flags | px
  / rem
</Caption>
...
![Structure and spacing measurements for expandable tile with a feature flag | px / rem](images/tile-style-structure-expandable.png)

</div>

<Caption>
  Structure and spacing measurements for expandable tile with a feature flag |
  px / rem
</Caption>
