...
The base tile doesn't have a border. It's not interactive, but can have
...
The clickable tile has states: enabled, hover, and focus.
...
The selectable tiles have four states: enabled, hover, focus, and selected.
...
The expandable tiles have three states: enabled, hover, and focus.
