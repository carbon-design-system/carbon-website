...
[Feature flags](https://carbondesignsystem.com/components/overview/feature-flag/)
have been added to the clickable, selectable, and expandable variants of tile to
...
![Interactive tiles with feature flag enabled](images/tile-usage-feature-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Interactive tiles with feature flag disabled](images/tile-usage-feature-flag-disabled.png)
...
- `Shift` + `Tab` moves focus backward through interactive elements within base
  tile in a logical order. — `Enter` activates the base tiles interactive
  elements.
...
[feature flag](https://carbondesignsystem.com/components/overview/feature-flag/).
...
![Clickable tile with feature flag enabled](images/tile-usage-clickable-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Clickable tile with feature flag disabled](images/tile-usage-clickable-flag-disabled.png)
...
![Single-select tile with feature flag enabled](images/tile-usage-selectable-single-select-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Single-select tile with feature flag disabled](images/tile-usage-selectable-single-select-flag-disabled.png)
...
![Multi-select tile with feature flag enabled](images/tile-usage-selectable-multi-select-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Multi-select tile with feature flag disabled](images/tile-usage-selectable-multi-select-flag-disabled.png)
...
<Caption>Anatomy of selectable tile with feature flags</Caption>
...
![Clickable areas of selectable tile with feature flags](images/tile-usage-selectable-clickable-areas.png)

<Caption>Clickable areas of selectable tile with feature flags</Caption>
...
![Expandable tile without interactive elements feature flag enabled](images/tile-usage-expandable-non-interactive-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Expandable tile without interactive elements feature flag disabled](images/tile-usage-expandable-non-interactive-flag-disabled.png)
...
![Expandable tile with interactive elements feature flag enabled](images/tile-usage-expandable-interactive-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Expandable tile with interactive elements feature flag disabled](images/tile-usage-expandable-interactive-flag-disabled.png)
...
![Anatomy of expandable tile with a feature flag](images/tile-usage-expandable-anatomy.png)

<Caption>Anatomy of expandable tile with a feature flag</Caption>
...
![Clickable areas of expandable tile with a feature flag](images/tile-usage-expandable-clickable-areas.png)

<Caption>Clickable areas of expandable tile with a feature flag</Caption>
...
![Base, clickable, and selectable tiles with AI presence and feature flags](images/tile-usage-AI-presence.png)
