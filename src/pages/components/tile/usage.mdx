...
![Single-select tile feature flag enabled](images/tile-usage-selectable-single-select-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Single-select tile feature flag disabled](images/tile-usage-selectable-single-select-flag-disabled.png)
...
![Multi-select tile feature flag enabled](images/tile-usage-selectable-multi-select-flag-enabled.png)

</Tab>

<Tab label="Flag disabled">

![Multi-select tile feature flag disabled](images/tile-usage-selectable-multi-select-flag-disabled.png)
...
Selectable tiles have **enabled**, **hover**, **focus**, **hover selected**,
**selected**, and **disabled** states. For more information about base tile
states, see the [Style](https://carbondesignsystem.com/components/tile/style/)
tab.
...
Use the container expansion functionality to expand the tile when there are no
...
Use the button expansion functionality to expand the tile when including
interactive elements.
...
Selectable tiles have **enabled**, **hover**, **focus**, and **disabled**
states. For more information about base tile states, see the
[Style](https://carbondesignsystem.com/components/tile/style/) tab.
...
- Without interactive elements: The tile is expanded by clicking anywhere within
  the tile container.
- With interactive elements: The tile is expanded by clicking on the ghost icon
  button in the bottom right of the tile.

#### Keyboard

- `Tab` moves focus forward through tiles. If there are interactive elements,
  `Tab` moves focus forward in a logical order. — `Shift` + `Tab` moves focus
  backward through tiles. If there are interactive elements, `Tab` moves focus
  forward in a logical order. — `Enter` expands the tile.

### Clickable areas

Expandable tiles can be expanded by clicking anywhere on the tiles container. If
the tile has interactive elements, it can be expanded by clicking on the ghost
icon button in the bottom right corner. Interactive elements within the tile can
be clicked on.
