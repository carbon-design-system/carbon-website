...
![Example image of how tiles are built on the narrow grid.](images/tile-usage-27.png)
...
![Example image of how tiles are built on the condensed grid.](images/tile-usage-28.png)
...
<Caption>
  ...
  only if they are given their own click targets. In these cases, the tile’s
  click target is reduced to only the icon button.
</Caption>
