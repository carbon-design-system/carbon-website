...
[experimental tiles](https://react.carbondesignsystem.com/?path=/docs/experimental-feature-flags-tile--overview).We
encourage teams to start using these tiles, although current tiles are still
supported.
...
![Tile with AI presence](images/tile-AI-presence-usage.png)

</Column>
</Row>

<Caption>Tile with AI presence</Caption>
