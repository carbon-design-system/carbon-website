...
<AnchorLink>Overview</AnchorLink>
 ...
 - Guiding user to take actions or navigate.
 - Presenting options for single or multiple selections.
 - Hiding or showing large amounts of content.

 ## Live demo

 @@ -222,18 +251,27 @@ for the most important action a user can take on the page.
   `}</ComponentVariant>
 </ComponentDemo>
 ...
 selectable, or expandable. These variation of tiles are flexible enough to
 ...
 | [Clikckable](#clickable)   | For prompting an action, navigating or directing to other pieces of information about the subject matter. |
 ...
 <Row>
 <Column colLg={8}>
 @@ -247,7 +285,8 @@ content. These tiles can have internal calls-to-action (CTAs), such as a
 ...
 <Row>
 <Column colLg={8}>
 @@ -259,38 +298,372 @@ contain separate internal CTAs.
 ...
 <Caption>Selectable radio-button / single select tiles.</Caption>

 ![Selectable checkbox / multi-select tiles](images/tile-usage-4.png)

 <Caption>Selectable checkbox / multi-select tiles. </Caption>
 ...
 There are three basic layouts for tiles: **standard**, **vertical mansory**, and
 **horizontal masonry**. The standard layout will be the most commonly used
 ...
 the users main workstream and are envoked on screen to reveal secondary
 ...
 For **clickable tiles**, don’t highlight text or icons to avoid confusion as if
 they’re links and clickable.
