...
![illustration showing the large and small versions of toggle, with the large including the “on” text and the small, positioned in a cell grid, adding the tick mark in place of text](images/toggle-accessibility-2.png)
...
<DoDont
colMd={4} colLg={4}
caption="Keep the label consistent. Only change the state text between On and Off.">

![the same 'Alerts' toggle keeping its label in both states](images/toggle-accessibility-3.png)

</DoDont>
<DoDont
colMd={4} colLg={4}
caption="Do not change the label text as a way of indicating the toggle's on/off state.">

![the toggle changing its label from 'Alerts on' to 'Alerts off'](images/toggle-accessibility-4.png)
