...
**Use labels with a toggle so the action is clear.** Labels should be three words or less and appear on the side of a toggle. Use adjectives rather than verbs to describe labels and the state of the object affected.
