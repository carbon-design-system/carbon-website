...
and state text. Default toggles are required to display a component label and
...
state text must be three words or less and is displayed on the side of a toggle.
state text is optional for small toggle.
