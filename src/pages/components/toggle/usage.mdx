...
| Variant        | Purpose                                                                                                                                                         |
| -------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Default toggle | Use the default toggle when you need to specify a heading in addition to the toggle label. Default toggles appear in forms or within full pages of information. |
| Small toggle   | Use the small toggle when you do not need to specify a heading or a label. Small toggles are more compact in size and are used inline with other components.    |
...
Heading text must accompany a toggle to further clarify the action that the
toggle performs.

#### Label text

Use label text to describe the binary action of toggle so that the action is
clear. Label text must be three words or less and is displayed on the side of a
toggle.
...
space. Default toggles are required to display a visible heading and label.
...
small toggle is smaller in size and displays a checkmark tick in the on state to
ensure the toggle is still accessible without requiring a visible heading or a
label.
