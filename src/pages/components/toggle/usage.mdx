...
Label text can accompany a toggle to further clarify the action that the toggle
performs.

#### Action text

Use text to describe the binary action of toggle so that the action is clear. Action text must be three words or
less and is displayed on the side of a toggle.
