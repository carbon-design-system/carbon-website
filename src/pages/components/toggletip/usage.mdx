...
2. **Caret tip:**  Visually connects the content container to its trigger, indicating where the content originates.
...
columns. See more details on the [Style](/components/toggletip/style/#structure) tab.
...
default, the toggletip is hidden and inactive. For more details on toggletip states, see the
...
additional keyboard interactions, see the [Accessibility](https://carbondesignsystem.com/components/toggletip/accessibility/) tab.
