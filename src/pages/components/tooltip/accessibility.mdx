...
![the search icon-only button has a 'search' tooltip](images/tooltip-accessibility-3-do.png)

  </DoDont>

  <DoDont type="dont" caption="Do not use icon-only buttons with no tooltip or name annotated.">

![the icon-only button in the navigation does not have a tooltip or annotation](images/tooltip-accessibility-3-dont.png)
