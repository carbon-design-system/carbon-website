...
By default, Most components, like icon buttons, icon tabs, sliders, and copy
buttons, already have built-in tooltips, so you don’t need to add one
separately. However, if customization is needed, it’s allowed but not
recommended.
