...
![Image of tooltip that has an icon button paired with a container](images/tooltip-usage-6.png)
...
text to interactive elements. Further guidance on the toggle tip component
coming soon.
