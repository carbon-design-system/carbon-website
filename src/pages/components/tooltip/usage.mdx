---
title: Tooltip
description: Tooltips display additional information upon hover or focus. The information should be contextual, useful, and nonessential.
...
<AnchorLink>Component types</AnchorLink>
