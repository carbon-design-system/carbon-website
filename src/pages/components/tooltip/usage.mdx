...
that is not critical for a user to read to complete a task. — Standard tooltips
appear on hover and are not focusable or read by screen readers. If the content
is essential for the user to interpret concerning their workflow, use a
[toggletip](https://carbondesignsystem.com/components/toggletip/usage/) for this
information instead.

<Row>
<Column colLg={8}>

![Image of a standard tooltip](images/tooltip-usage-10.png)
