...
making the tooltip visible for certain components.
...
By default, components like icon buttons, icon tabs, icon content switchers,
slider, copy buttons, and more should come with integrated tooltips. Therefore,
there’s no need to include a separate tooltip within the component. Tooltips can
be exposed for the following reasons:
