...
![illustration showing keyboard interaction](images/tree-vew-2.png)
...
- See the [ARIA authoring practice Tree View pattern](https://www.w3.org/WAI/ARIA/apg/patterns/treeview/) for more considerations.
