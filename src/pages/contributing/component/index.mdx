...
<AnchorLink>Color</AnchorLink> <AnchorLink>Interactive states</AnchorLink>
<AnchorLink>Typography</AnchorLink> <AnchorLink>Structure</AnchorLink>
<AnchorLink>Size</AnchorLink> <AnchorLink>Feedback</AnchorLink>
...
<!--
Use a table to document properties and color tokens for interactive states. You can reference this [table generator](https://www.tablesgenerator.com/markdown_tables) for easy table creation. You may also choose to include images for default and flush alignment or other relevant variations.
...
<!--
Begin the structure section with a table to document states, pacing, and any other component-specific configurations. You can reference this [table generator](https://www.tablesgenerator.com/markdown_tables) for easy table creation.

Add supporting images to this section, with at least one image showing how color is applied within the component and another showing structure and spacing measurements. Images should be accompanied by a descriptive caption and relate to the spec charts. Note we used fixed images in the Structure section.

Variants: You main need to provide additional specs for component variants. For each variant, create an H3 section. The following are example section headers:
...
The following content shows example documentation from [Accordion](https://carbondesignsystem.com/components/accordion/style).
-->
