...
Choose from this list of possible behaviors that are *universal* across all types, and include them here as h headings.
-->
...
Variants: You may need to provide additional specs for component variants like default versus flush alignment. For each variant, make a new h3 section and give it a name. The following are example section headers:
