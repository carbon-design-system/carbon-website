...
- If a user is likely to read all of the content, then don't use an accordion as
 ...
 <!-- Consider including a DoDon't image to provide further guidance on common component misuses. -->

<DoDontRow>
  <DoDont type="do" caption="Do use accordion to reduce scrolling.">

![Do use accordion to reduce scrolling.](images/placeholder-do.png)

  </DoDont>
  <DoDont type="dont" caption="Don't use accordion for nested content.">

![Don't use accordion for nested content.](images/placeholder-dont.png)
...
<!--
How does the component work in groups or when paired with other similar components? What is their juxtaposition? This section seeks to clarify these alignment questions.

For example:

- When using both checkbox and radio button, what is their relationship horizontally and vertically?
- How do notifications stack together?
- What happens when there is more than one button?

Ensure that you link to the Structure section of the Style tab, where readers can find additional specs.
...
- Try for 1, 2, or 4 examples. If you only have 3 examples, keep the images on a 2x2 grid and leave the 4th quartile empty.-->
...
- Include a table that describes the user tasks associated with each state.
...
- Using flush alignment with [accordion] (https://carbondesignsystem.com/components/accordion/usage/#modifiers)
...
<!--
Did you reference other components or patterns? List them here and be sure to explain why these components are related. For example, if you provide alternative components, explain how their usage differs. This content may be similar to the 'What not to use' section.
-->
