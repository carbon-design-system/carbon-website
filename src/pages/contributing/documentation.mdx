...
<!--
Typically, variants use smiliar type styling and can be grouped together in one table.  If the type is different across variants then subdivide this section with H3 for each variant.
-->
