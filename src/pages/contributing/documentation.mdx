...
can see this template in use for [Dropdown](/components/dropdown/usage),
[Button](/components/button/usage), and
...
organize and group variant content. See the [Tile](/components/tile/usage)
component for an example of this approach.
...
Include a table with variants of components and their purpose. Include links on the variant names to the variants sections below. See the [Modal](/components/modal/usage/#variants) component for an example.
...
<!--
This section is only applicable to components that have visual feature flags. See the [Tile](/components/tile/usage/#feature-flags) and [Structured list](/components/structured-list/usage/#feature-flags) components feature flag sections for an example.

If displaying this section, remember to add a blue tag at the top of the Usage tab that says "Feature flag".
...
See the [Contained list](/contained-list/usage/#formatting) component for an example.
-->
...
*There are four responsive modal sizes: **xs**, **small**, **default**, and **large**. Choose a size that works best for the amount of modal content you have. Modals with short messages should use a xs or small modal to avoid long single lines; for complex components, like data table the default or large modal will be more accommodating.*
-->
...
See the [Checkbox](/components/checkbox/usage#content) and [Modal](/components/modal/usage#content) components for examples.
-->
...
*The accordion component has two main states: **collapsed** and **expanded**. The chevron icon at the end of the accordion indicates which state the accordion is in. The chevron points down to indicate collapsed and up to indicate expanded. For more For detailed visual information about the various states for this component, see the [Style](/components/accordion/style/#interactive-states) tab.*
...
See the [Content switcher](/components/content-switcher/usage/#interactions) component for an example.
-->

### Validation

<!--
Include any guidelines for data validation and accompanying messaging. See the [Form](/components/form/usage/#validation-and-errors) component for an example.
-->
...
<!--
Cover guidance around default settings and provide rationale. See the [Form](/components/form/usage/#default-values) and [Radio button](/components/radio-button/usage/#default-selection) components for examples.
-->
...
<!--
If applicable, use this section to cross reference to the specific loading type in the [Loading component](/components/loading/usage) and/or the [Loading pattern](/patterns/loading-pattern).
-->
...
For examples of how to lay out this kind of information, see the [Dropdown](/components/dropdown/usage/#dropdown) component.
-->
...
- adding a non-interactive icon to a [Contained list](/components/contained-list/usage/#non-interactive-icons)
- adding dividers to a [Menu](/components/menu/usage/#modifiers)
- styling a [Dropdown](/components/dropdown/usage/#modifiers) to appear inline with other content
- using high and low contrast styles for [Notifications](/components/notification/usage/#high-and-low-contrast)
-->
