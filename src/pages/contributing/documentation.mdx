...
Follow this template when possible; however, depending on the component's
variant complexity, you may need to deviate from this template structure. For
instance, this may occur when sections like formatting and behavior would be
better suited to be moved under individual variant sections to help organize and
group information. See the [Tile](/components/tile/usage/) component as an
example of this.
...
Include a table with variants of components and their purpose. Include links on the type names to the types sections below. See the [Modal](https://carbondesignsystem.com/components/modal/usage/#variants) component for an example.
...
Note: If displaying this section, remember to add a blue tag at the top of the Usage tab that says "Feature flag".
...
Include the tab image component to display the visual difference when the flag is enabled or disabled. Example:
...
See the [Contained list](https://carbondesignsystem.com/components/contained-list/usage/#formatting) component for an example.
-->
...
See the [Checkbox](https://www.carbondesignsystem.com/components/checkbox/usage#content) and [Modal](https://www.carbondesignsystem.com/components/modal/usage#content) components for examples.
-->
...
<!--
If there are states associated with a component include them here in a sentence. Do semi-bold each individual state in the sentence. Include a table below the sentence with each state of the component and when to use them. Do not italicize or semi-bold the state name in the table. Do not include an image here, instead link out to the Style tab for more information.

Example:

*The accordion component has two main states: **collapsed** and **expanded**. The chevron icon at the end of the accordion indicates which state the accordion is in. The chevron points down to indicate collapsed and up to indicate expanded. For more For detailed visual information about the various states for this component, see the Style tab.*
...
<!--
Include any guidelines for data validation and accompanying messaging. See the [Form](https://www.carbondesignsystem.com/components/form/usage/#validation-and-errors) component for an example.
-->
...
<!--
Cover guidance around default settings and provide rationale. See the [Form](https://www.carbondesignsystem.com/components/form/usage/#default-values) and [Radio button](https://www.carbondesignsystem.com/components/radio-button/usage/#default-selection) components for examples.
-->
