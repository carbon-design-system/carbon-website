...
<!--
Begin this section with any brief content guidelines. Link out to additional guidelines if needed. Typically, all variants use smiliar type styling and can be grouped together in one table.  If the type is different across variants then subdivide this section with H3 for each variant.
...
<!--
Use the same guidance as in the `Variant 1 strucutre` section.
-->
