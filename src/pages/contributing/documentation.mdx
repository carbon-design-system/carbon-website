...
Include a table with variants of components and their purpose. Include links on the variant names to the variants sections below. See the [Modal](https://carbondesignsystem.com/components/modal/usage/#variants) component for an example.
