...
**Valerie Garza**<br /> Gantt chart<br /><br /> **Michael Gower**<br />
Accessibility<br /><br /> **Mark Judy**<br /> Typescript<br /><br /> **Chris
Knabe**<br /> React Testing Library

</Column>

<Column className="one" colSm={2} colMd={2} colLg={3}>

**Marcin Lewandowsk**i<br /> Typescript<br /><br /> **Jessica Lin**<br />
Accessibility<br /><br /> **Amaya Mali**<br /> Gantt chart<br /><br /> **Tom
Roach**<br /> Community support<br /><br />

</Column>

<Column className="one" colSm={2} colMd={2} colLg={3}>

**Eugene To **<br /> Figma<br /><br /> **Shankar Venkatachalam** <br /> Create
React App<br /><br /> **Colleen Yates**<br /> llustration Guild
