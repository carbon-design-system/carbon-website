...
Many thanks to our 2025 Carbon champions for making significant contributions to
the design system.

<Row className="mobile-columns">
<Column className="one" colSm={2} colMd={2} colLg={3}>

**Drew Glapa**<br /> Carbon Labs animated header<br /><br /> **Manuel Ramos Gonzalez
**<br /> Carbon MCP Baseline Participant<br /><br /> **Ryan Downs**<br />
...
**Juan Encalada**<br /> Future-focused Carbon Figma strategy<br /><br /> **Mudita Bhatia**<br />
Carbon MCP Baseline Participant
