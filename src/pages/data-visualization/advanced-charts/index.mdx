...
"Trheat" maps combine the divergent color scale of a heat map and a tree map. The "trheat" map is identical in terms of structure to the basic tree map, but the countries can be colored independently accordingly to an additional indicator (which could be the variation of an indicator).
