...
Symbols driven by data are overlayed on geographical region. A common symbol used is bubble with the area of the circle proportional to its value in the dataset.
