...
Heat maps can leverage the full range of the palette (from 10-100) to maximize contrast. When there is no inflection point in the data (for example, a 0 value midway between -100 and +100), a one directional, sequential heat scale such as light cyan to dark cyan is the best visualization practice.
