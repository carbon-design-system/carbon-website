...
"Trheat" maps combine the divergent color scale of a heat map and a tree map. The "trheat" map is identical in terms of structure to the basic tree map, but the countries can be colored independently accordingly to an additional indicator or variation of an indicator. Again, the diverging palette shows color progression in either direction from an inflection point (for example, a 0 value midway between -100 and +100),
