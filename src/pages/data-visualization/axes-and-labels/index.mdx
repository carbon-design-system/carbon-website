...
To start at zero, or not to start at zero. This is a potentially history’s longest debate. As a charting library, we would like to support both directions, with the following recommendation.
