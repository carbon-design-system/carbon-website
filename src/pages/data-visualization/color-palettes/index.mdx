...
<ImageGalleryImage col={6} title="Donut chart in action" alt="exmaple of a donut chart">

![exmaple of a donut chart](images/color_gallery_3.png)

</ImageGalleryImage>

<ImageGalleryImage col={6} title="Stream chart in action" alt="exmaple of a stream chart">

![exmaple of a stream chart](images/color_gallery_4.png)

</ImageGalleryImage>

<ImageGalleryImage col={12} title="Heat map in action" alt="exmaple of a heat map">

![exmaple of a heat map](images/color_gallery_5.png)

</ImageGalleryImage>

<ImageGalleryImage col={12} title="Proportional diagram in action" alt="exmaple of a proportional diagram">

![exmaple of a proportional diagram](images/color_gallery_6.png)

</ImageGalleryImage>

<ImageGalleryImage col={12} title="Alluvial diagram in action" alt="exmaple of an alluvial diagram">

![exmaple of an alluvial diagram](images/color_gallery_7.png)
