...
Prioritize the importance of data, then assign clear visual hierarchy to them. The most important data should have the highest contrast and occupy the largest area.
