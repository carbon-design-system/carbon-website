...
For Carbon to incorporate additional frameworks, the work needs clear, guaranteed, and ongoing resources for maintenance and support. If a team builds a product using a new implemenation of Carbon Charts but has no plans to support the solution outside of the product, it will not become part of the Carbon Design System.
