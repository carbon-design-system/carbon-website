...
Additional options available vary by chart type. For more examples see the [data demo](https://github.com/carbon-design-system/carbon-charts/tree/master/packages/core/demo/demo-data).
