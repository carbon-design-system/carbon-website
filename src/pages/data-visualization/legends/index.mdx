...
If information can be communicated directly without resolving to creating visual associations, it is a better experience for the user. Legends can be avoided in the following situations:
