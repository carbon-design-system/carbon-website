...
created to help you get up and running. For a comrehensive list of kits, explore
the [design kit catalog](https://next.carbondesignsystem.com/design-kits).
...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="Gatsby theme Figma kit"
...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="Image production guideline Figma kit"
