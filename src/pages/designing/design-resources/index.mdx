...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="Carbon Mid-Fidelity kit"
    href="https://www.figma.com/file/R7HjxsLFktFKMzfLzXUgSd/(Beta)-Mid-Fidelity---Carbon-Design-System?type=design&node-id=58-2763&mode=design&t=DPUHXK0kaDhzVr0G-0"
    actionIcon="launch">
    <MdxIcon name="figma" />
  </ResourceCard>
</Column>
...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    ...
    actionIcon="launch">
![Bee icon](src/pages/designing/design-resources/images/Bee.svg)
