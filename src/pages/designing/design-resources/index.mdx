...
Carbon UI Builder is a visual builder tool that allows users to assemble product
pages and layout modules using Carbon Components in a fraction of the time it
usually takes.
...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    ...
    href="https://ibm.github.io/carbon-components-builder/"
    actionIcon="launch">
