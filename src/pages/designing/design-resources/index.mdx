...
<AnchorLinks>
  ...
  <AnchorLink>Theme libraries</AnchorLink>
...
version** of [Sketch](<(https://www.sketch.com/)>) installed. If you’re new to
the design kit, visit the [Design kits](designing/kits/sketch) page.
