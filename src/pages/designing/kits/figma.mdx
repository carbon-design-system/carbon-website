...
The `(v11) All themes - Carbon Design System` library, used to be known as the
White theme library, includes all four Carbon themes, including two light (White
and Gray 10) and two dark (Gray 90 and Gray 100). We have deprecated the Gray
10, Gray 90, and Gray 100 theme library files and will no longer be maintaining
them. In the meantime, you can still use the deprecated theme libraries until we
remove them at a future date.
