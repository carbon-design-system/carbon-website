...
**V11 themes now available!** All themes for the v11 libraries are available to
IBM's internal users and the public community. We have leveraged Figmas latest
...
If you are using Carbon v11, all themed libraries are now available to IBM's
internal users and the public community. We have leveraged Figmas latest
features in this release which may result in breaking changes to some of our
components.
...
for example the `(v11) White theme - Carbon Design System` to on (D).
