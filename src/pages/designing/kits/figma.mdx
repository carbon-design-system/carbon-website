...
**v11 White theme Beta:** The v11 White theme Beta library and Text styles
library are now available. The other v11 theme libraries will be available in
Figma at the end of July 2022.
...
If you are using Carbon v11, the v11 White theme Beta library and Text styles
library are now available. The other v11 theme libraries will be available in
Figma at the end of July 2022.
...
for example the `(v11) White Theme Beta - Carbon Design System` to on (D).
...
To preview the Carbon v11 White theme Beta library and Text styles library,
visit the view-only link.

<Row className="resource-card-group">
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    onClick={() => fathom.trackGoal('P0OEN9TS', 0)}
    subTitle="v11 White theme Beta"
...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    ...
    href="https://www.figma.com/file/U4WVJl6j1jOT8eBkKNbhPf/(v10)-Text-Styles---IBM-Design-Language?node-id=129%3A2"
    actionIcon="launch">
...
To preview the Carbon v11 White theme Beta library and the Text styles library,
visit the view-only link.
