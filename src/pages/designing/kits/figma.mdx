...
us to combine all four themes into one library. As a result, the v11 White theme
library has been renamed to "(v11) All themes - Carbon Design System" to reflect
this change. We have deprecated the Gray 10, Gray 90, and Gray 100 theme
libraries and will no longer be maintaining them. In the meantime, you can still
use the deprecated libraries; however, we will be removing them at a future
date.
