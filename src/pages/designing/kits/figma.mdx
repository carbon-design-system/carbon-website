...
`(v11) Carbon Design System` library to on (D).
...
To preview the Carbon Design System library, visit the following view-only link.
To access the v10 Figma theme libraries, see
...
The `(v11) Carbon Design System` library (previously referred to as (v11) White
theme - Carbon Design System) includes all four Carbon themes, including two
light (White and Gray 10) and two dark (Gray 90 and Gray 100).
