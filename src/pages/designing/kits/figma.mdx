...
through a private Figma organization.
...
We have implemented Figma modes and theming variables, allowing us to combine all four themes into one library file. The (v10) All themes - Carbon Design System library (previously referred to as (v10) White theme - Carbon Design System) includes all four Carbon themes, including two light (White and Gray 10) and two dark (Gray 90 and Gray 100).
...
`IBM Design Systems` (C) and switch the toggle beside the `(v10) All themes - Carbon Design System` library to on (D).
...
To preview the All themes library, visit the following view-only link

<Row className="resource-card-group">
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    onClick={() => fathom.trackGoal('P0OEN9TS', 0)}
    subTitle="v10 All themes"
    href="https://www.figma.com/file/Vzz8k68Pqk5HfaTdQOQrGu/(v10)-All-themes---Carbon-Design-System"
    actionIcon="launch">
...
Under the same team `IBM Design Systems` you can also turn on the
following libraries:

- Color styles - IBM Design Language
- v10 Text styles - IBM Design Language
