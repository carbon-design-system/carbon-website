...
**All themes are now available in one Figma library!** We have upgraded our
Carbon theme libraries by utilizing Figma theming modes and variables, allowing
us to combine all four themes into one library file. As a result, the v11 White
theme library has been renamed to "(v11) All themes - Carbon Design System" to
reflect this change. We have deprecated the Gray 10, Gray 90, and Gray 100 theme
library files and will no longer be maintaining them. In the meantime, you can
still use the deprecated theme libraries until we remove them at a future date.
...
The `(v11) All themes - Carbon Design System` library includes all four Carbon
themes, including two light (White and Gray 10) and two dark (Gray 90 and Gray
100). All four themes live in a single Figma library. We have leveraged Figmas
latest features of modes and theming variables to combine all of our themes into
a single file.
...
following view-only link. To access the v10 Figma theme libraries, see
