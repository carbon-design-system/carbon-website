...
**v11 Beta White theme:** The v11 Beta White theme library and Text styles
...
If you are using Carbon v11, the v11 Beta White theme library and Text styles
library are now available. The other v11 theme libraries will be available in
Figma at the end of July 2022.
...
To preview the Carbon v11 Beta White theme library and Text styles library,
visit the view-only links.
...
Navigate to the **Community** tab in the left panel (A).
...
#### 3. Duplicate the file to your workspace

#### 4. Publish as a library to your workspace.

To preview the Carbon v11 Beta White theme library and the Text styles library,
