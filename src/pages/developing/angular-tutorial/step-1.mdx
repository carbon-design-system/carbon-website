...
Now let's import the icons from our `@carbon/icons` package. To not make our app very big, you don't need to import
all the icons just those you would like to use. To do so let's open the `header.component.ts` file and import `Notification20` icon like below.
