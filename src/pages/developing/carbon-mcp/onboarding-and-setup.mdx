...
Additionally, an `llms.txt` file is available [here](./files/llms.txt) — a
structured index of Carbon Design System documentation, components, and source
repositories for AI tools and LLMs.
