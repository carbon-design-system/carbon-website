...
- Search & select “View: Open MCP Settings”

<br />
![Cursor MCP Settings](./images/Cursor"Search-&-Select".png)
<br />
...
- Open your repository > Settings in GitHub
...
<br />
![GitHub Coding Agent](./images/Github"Coding-agent".png)
<br />
...
- Replace `<TOKEN>` and `<SESSION>` with your actual Carbon MCP auth
  credentials. Click _Save MCP Configuration_.
