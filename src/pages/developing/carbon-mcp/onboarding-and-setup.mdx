...
{/* prettier-ignore */}
```markdown
[mcp_servers.carbon_mcp]
enabled = true
url = "https://mcp.carbondesignsystem.com/mcp"
enabled_tools = ["code_search", "docs_search", "get_charts"]

[mcp_servers.carbon_mcp.http_headers]
Authorization = "Bearer <TOKEN>"
X-MCP-Session = "<SESSION>"
```
...
[carbon-builder skill](https://github.com/carbon-design-system/carbon-mcp/releases).
The zipped file is located under the release assets for the relevant version. The
...
- Download the
  [carbon-builder skill](https://github.com/carbon-design-system/carbon-mcp/releases).
  The zipped file is located under the release assets for the relevant version.
...
Download the
[carbon-builder skill](https://github.com/carbon-design-system/carbon-mcp/releases).
The zipped file is located under the release assets for the relevant version. No need
