...
<a
  href="/developing/carbon-mcp/files/carbon-builder.zip"
  download="carbon-builder.zip">
  carbon-builder skill
</a>
. The skill provides Carbon-specific context that guides AI agents to follow
...
- Download the
  <a href="/developing/carbon-mcp/files/carbon-builder.zip" download="carbon-builder.zip">carbon-builder
  skill</a> and unzip it.
...
Download the
<a href="/developing/carbon-mcp/files/carbon-builder.zip" download="carbon-builder.zip">carbon-builder
skill</a>. No need to unzip; Claude Desktop accepts the ZIP file directly.
