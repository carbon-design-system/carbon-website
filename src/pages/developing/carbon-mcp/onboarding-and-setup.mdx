...
- Start a new Make with Carbon MCP, using this as
  <a href="/developing/carbon-mcp/files/GUIDELINES.txt" download="GUIDELINES.txt">GUIDELINES.md</a>
  and this as the
  <a href="/developing/carbon-mcp/files/figma-make-user-prompt.txt" download="figma-make-user-prompt.txt">input
  user prompt</a> for best code generation results
