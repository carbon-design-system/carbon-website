...
Labs UIShell. See the
[Carbon Labs tool](/developing/carbon-mcp/carbon-labs-tool/) tab for details.
...
#### <CheckmarkFilled size={16} color={green[40]} /> Carbon Labs (`@carbon/labs-react`)

- Code examples and documentation
- Example: AnimatedHeader, Processing, Resizer, WhatsNew, Labs UIShell
- Full code examples
- Complete props and imports
