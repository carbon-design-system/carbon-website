...
## Overview Interactive maps put data in context to immediately provide users with
the information that is related to spacial orientation. These are basic usages of
interactive maps: - To indicate the average values of a property or quantity in those
areas - To identify data that is overlayed in geographical regions - To show connections
and relationships geographically
