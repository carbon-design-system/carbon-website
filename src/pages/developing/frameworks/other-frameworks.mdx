...
system in vanilla JS, Angular, Vue and Svelte. If you’re you’re using a
different framework, you can still build components by following the guidelines
below.
...
implemenation of Carbon, for example, but had no plan to support that solution
