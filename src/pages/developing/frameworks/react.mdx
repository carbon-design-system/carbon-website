...
4.  We recommend you have the following tools installed:

    Node.js v14 or above here or follow their installation through a package manager here) If you're on macOS, we recommend using nvm to help manage different versions of Node.js nvm as your version manager for Node.
    Git
    Yarn
