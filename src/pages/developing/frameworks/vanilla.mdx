...
| Scripts | URL                                                                  |
| ------- | -------------------------------------------------------------------- |
| CSS     | https://unpkg.com/carbon-components@10.56.0/css/carbon-components.min.css    |
| ES5     | https://unpkg.com/carbon-components@10.56.0/scripts/carbon-components.min.js |
