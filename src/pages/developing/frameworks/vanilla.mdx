...
[\_css--body.scss](https://github.com/carbon-design-system/carbon/blob/master/packages/components/src/globals/scss/_css--body.scss).
...
- When you set `$css--reset: true`, then the contents of
  [\_css--reset.scss](https://github.com/carbon-design-system/carbon/blob/master/src/globals/scss/_css--reset.scss)
...
is maintained in
[carbon-components/blog/master/packages/components/demo/polyfills/index.js](https://github.com/carbon-design-system/carbon/blob/master/packages/components/demo/polyfills/index.js).
