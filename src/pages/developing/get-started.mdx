...
The following diagram shows the relationships of assets and guidance across IBM,
from the foundations of Brand and the IBM Design Language, to the digital
implementation in the Carbon Design System that in turn provides the foundation
for our products and web pages.
