...
To begin, fork
[carbon-tutorial](https://github.com/carbon-design-system/carbon-tutorial-nextjs)
...
Next, in `globals.scss`, we'll import our `TutorialHeader` styles. Your file
...
And we pull this page into our root page:
