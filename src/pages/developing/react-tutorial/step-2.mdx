...
feaux row, and each tab within that row contains the actual column content. When
...
the expected `Grid` > `Col` DOM structure. Nested grids are officially supported
