...
Here's a
[preview](https://deploy-preview-6--carbon-tutorial-svelte.netlify.app/) of what
you will build:
...
This is a web development tutorial that uses the Carbon Svelte components. If
you're just getting started with Svelte and enjoy learning-by-doing, check out
the official Svelte [intro tutorial](https://svelte.dev/tutorial/basics). You'll
want to supplement that with their [example demos](https://svelte.dev/examples)
and [API documentation](https://svelte.dev/docs).

### ES6/ES2015

Svelte apps often use the latest and greatest from JavaScript (ES6/ES2015).
...
1. [**Installing Carbon**](/developing/svelte-tutorial/step-1)
   - Create a web app with the UI shell component.
2. [**Building pages**](/developing/svelte-tutorial/step-2)
   - Build out pages with the grid and various components.
3. [**Using APIs**](/developing/svelte-tutorial/step-3)
   - Populate the data table with an external data source.
4. [**Creating components**](/developing/svelte-tutorial/step-4)
   - Extend Carbon by creating your own components.
5. [**Deploying to IBM Cloud**](/developing/svelte-tutorial/step-5)
