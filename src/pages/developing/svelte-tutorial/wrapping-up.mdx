...
Svelte badge, see the
[Acclaim](https://www.youracclaim.com/org/ibm/badge/ibm-carbon-design-system-developer-essentials-svelte)
site.

### Badge process

This badge demonstrates knowledge about Carbon's Svelte components. To earn the
badge:

1. Complete steps 1 through 5 of the Carbon Svelte tutorial:
   - Step 1. [Installing Carbon](/developing/svelte-tutorial/step-1)
   - Step 2. [Building pages](/developing/svelte-tutorial/step-2)
   - Step 3. [Using APIs](/developing/svelte-tutorial/step-3)
   - Step 4. [Creating components](/developing/svelte-tutorial/step-4)
   - Step 5. [Deploying to IBM Cloud](/developing/svelte-tutorial/step-5)
2. Have approved pull requests for steps 1 through 5 in the
   [carbon-tutorial-svelte repository](https://github.com/carbon-design-system/carbon-tutorial-svelte).
...
[filter by author](https://github.com/carbon-design-system/carbon-tutorial-svelte/pulls?utf8=%E2%9C%93&q=author%3Ausername)
(e.g. `author:${username}`).
