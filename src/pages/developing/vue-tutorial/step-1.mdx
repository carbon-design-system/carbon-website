...
{/* The following section is outcommented because it is not working: the format script is missing from package.json */}
...
{/* Stephane: I can't see any files changed or commited from me in that directory, so I wonder if we should mention it. */}
