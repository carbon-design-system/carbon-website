...
In `index.html` remove the contents of the `<cds-table-body>` tag and return it to
`Table body goes here`.

Then before the end of the html tag and after the body closing tag add the following to define our table
row template.
