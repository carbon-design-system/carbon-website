...
<AnchorLink>Create templates</AnchorLink>
<AnchorLink>Use templates</AnchorLink>
...
<Preview
  ...
  src="https://carbon-tutorial-nextjs-git-step-5-carbon-design-system.vercel.app/"
  frameborder="no"
...
Now in `main.js` we add the script to create the info card elements. First
adding the data we will use to construct the info cards from.
...
[Step 1](</developing/web-components-tutorial/step-1#continuous-integration-(ci)-check>)
