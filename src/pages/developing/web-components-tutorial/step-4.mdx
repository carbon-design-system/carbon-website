...
<cds-grid full-width class="info-section">
```
...
```html path=index.html
<cds-column class="info-section__column page-landing__label" sm="4" md="8" lg="16" xlg="4">            
...
<template id="template--info-card">
  <cds-column class="info-card" sm="4" md="8" lg="5" xlg="4">
