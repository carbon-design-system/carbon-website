...
The tutorial, for simplicity, uses a single script file and a single repository
file. This is something you should not do in your real projects.
...
4. If you run the application again you are running with no dependency on
