...
Add styellint an carbon plugin as development dependencies.
...
Githb packages can use a branch called `gh-pages` to deploy to. In order to do
...
If personal Github it is likely your vite config will look like this:
...
<script
  type="module"
  src="https://1.www.s81c.com/common/carbon/web-components/version/v2.16.0/skip-to-content.min.js"></script>
<script
  type="module"
  src="https://1.www.s81c.com/common/carbon/web-components/version/v2.16.0/tabs.min.js"></script>
<script
  type="module"
  src="https://1.www.s81c.com/common/carbon/web-components/version/v2.16.0/breadcrumb.min.js"></script>
```
...
That is it you are done. Just one more push to save your completion of step 5.
