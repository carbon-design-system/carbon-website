...
**Heading component:** For React applications, consider using the
[Heading component](/components/heading/usage) which automatically infers the
...
[Heading component code documentation](/components/heading/code) for
