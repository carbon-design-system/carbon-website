...
**Using the Heading component:** Carbon provides a
[Heading component](/components/heading/usage) that automatically infers the
appropriate heading level based on the Section component. This helps maintain
proper document structure without manual specification, making it easier to
build reusable components with correct heading hierarchy. See the
[Heading component documentation](/components/heading/code) for implementation
