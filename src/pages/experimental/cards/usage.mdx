...
Alert the user of any unsaved changes if they're in the edit state and try to navigate away to a different page.
...
Cards can be generally used to block groups of related content even if it doesn't fit into the above models.
...
- Avoid using tables (use an [structured list](https://www.carbondesignsystem.com/components/structured-list/code) instead)
- Avoid scrolling
