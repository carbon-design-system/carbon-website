...
| ------------------------------------------- | ---------------------------------------- | ------------------------------------------------ |
| <Link href="#"> Chatbot Window </Link>      | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> Chatbot Header </Link>      | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> System Message </Link>      | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> User Message </Link>        | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> Structured Response </Link> | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> Chatbot Cards </Link>       | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> Chatbot Text Input </Link>  | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
| <Link href="#"> Launch Button </Link>       | <Tag type="green">Design available</Tag> | <Tag type="cool-gray"> Contribution Needed</Tag> |
