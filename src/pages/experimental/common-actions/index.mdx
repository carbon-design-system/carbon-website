...
<Caption>
  The current image example is not the best representation of add and should be
  replaced
</Caption>
...
Note: Will need feedback from our content team.
...
<Caption>
  The current image example is not the best representation of remove and should
  be replaced.
</Caption>
...
- Cloud Integration: https://pages.github.ibm.com/ide-design-guidelines/ide-design-guidelines-v2/patterns/deleting/usage
...
[TBD - Undo behavior. e.g. not really deleting an item for 15 seconds to give the user time to revert]

### Content Guidelines

Existing guidelines:

https://www.carbondesignsystem.com/patterns/common-actions/#delete

Visual Guidelines (if it applies)

[TBD - 'Deletion In Progress'/'Deleting Pending' States, Delete Animation for Table Rows & Other Items, Deletion Toasts, Deletion inline Notifications]

[TBD - Someone should figure out how to visually separate ERROR from DANGER from YOUR DELETION WAS SUCCESSFUL. Is a successful deletion green? Or neutral, or what?]
...
Guidance from Cloud Integration:
_https://pages.github.ibm.com/ide-design-guidelines/ide-design-guidelines-v2/patterns/creating/usage_

Work from the provisioning team

See also:
_Work around 'loading'_
...
[TBD - 'Creation In Progress'/'Creation Pending' States, Create Animation for Table Rows & Other Items, Creation Toasts, Creation inline Notifications]
