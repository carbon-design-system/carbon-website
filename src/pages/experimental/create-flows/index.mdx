...
![Example of a create pattern](images/1.jpg)
...
![Example of a standard creation modal](images/2.jpg)
...
![Example of a side panel creation flow](images/3.jpg)
...
![Example of a full-page creation flow](images/4.jpg)
...
![Example of a full-page creation flow](images/5.jpg)
...
![Example of side panels in a multi-step creation flow](images/6.jpg)
...
![Example of a side panel multi-step creation flow](images/7.jpg)
...
![Start of multistep creation flow](images/8.jpg)
...
![Multistep creation flow with view all options toggle](images/9.jpg)
...
![Button position in context](images/11.jpg)
...
![Button position in context when scrolling](images/12.jpg)
...
![Button position in context on mobile](images/13.jpg)
...
![Buttons should stick upon scrolling so they are always visible.](/images/14a.jpg)

</DoDont>
<DoDont colLg={6} caption="If an illustration or image is displayed, buttons should be displayed above the image.">

![If an illustration or image is displayed on the right, buttons should be displayed above the image.](/images/14b.jpg)
...
![Example of supporting image placement](images/15.jpg)
...
![Show all options off](images/16.jpg)
...
![Show all options on](images/17.jpg)
...
![Show all options off](images/18.jpg)
...
![Show all options on](images/19.jpg)
...
![Show all options on and grouped](images/20.jpg)
...
![Example of a successful creation confirmation](images/27.jpg)
...
![Example of a pre-create view](images/Precreate1.jpg)
...
![Example of pre-create with groups of tiles](images/Precreate2.jpg)
...
![Example of pre-create with a dropdown input](images/Precreate3.jpg)
