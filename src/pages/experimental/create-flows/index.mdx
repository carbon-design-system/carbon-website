...
Pre-create occurs before the normal create flow starts. A common pre-create is _create from template_, however there are many other uses.

Pre-create is usually combined with a full-page create flow. It can also be used in combination with a side panel create flow. Pre-create can be used in combination with single step or multistep create flows. A multistep flow starts **after** pre-create is complete.
