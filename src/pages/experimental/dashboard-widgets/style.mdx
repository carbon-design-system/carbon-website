...
![Small Widget Normal State](images/normal_state_small.jpg)
...
![Widget List](images/list_widget.jpg)
...
![Normal State](images/normal_state_small.jpg)

### Empty state

The empty state occurs when the user has no data to populate the widget.

![Empty State](images/empty_state_small.jpg)
...
![Permission State](images/permission_state_small.jpg)

### Error state

The error state occurs when data fails to load.

![Permission State](images/error_state_small.jpg)
...
![Permission State](images/loading_state_small.jpg)
...
![Widget Tile](images/widget_tile.jpg)
...
![Dashboard Illustration](images/small_empty_plain.jpg)
