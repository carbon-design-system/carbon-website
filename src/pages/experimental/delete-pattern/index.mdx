...
### _Removing_ is a non-destructive action. A user can remove an asset from a list or item without destroying it.
...
This is particularly useful when the deletion or removal doesn't happen immediately, or a request has to be sent to trigger that action. 
