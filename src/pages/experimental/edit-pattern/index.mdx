...
![Contextual image of an edit modal](images/Contextual.jpg)
...
![Example of an edit button in a table](images/02.jpg)
...
![Example of a low consequence edit action in a modal](images/03.jpg)
...
![Example of a low-impact edit action in a side panel](images/LowSidepanel.jpg)
...
When an object is created in a full-page flow and the majority of fields become editable, a full-page edit flow should be used. This is made possible by including a configuration/properties view.

<Row>
<Column colLg={8}>

![Example of a properties view in reading (top) and editing (bottom) views](images/05.jpg)
...
![Example of a high-impact editing modal and consequent warning modal](images/HighModal.jpg)
...
![Example of a high-impact edit action in a side panel](images/HighSidepanel.jpg)
...
![Example of a warning screen in a side panel before a user saves changes](images/08.jpg)
...
![Example of a full-page edit view](images/09.jpg)
...
![Example of a modal warning users of the consequences of saving after a full-page edit](images/10.jpg)
...
![Example of a summary of changes in a modal](images/12.jpg)
...
![Example of a single non-editable field](images/11.jpg)
...
![Example of a successful editing toast notification](images/13.jpg)
