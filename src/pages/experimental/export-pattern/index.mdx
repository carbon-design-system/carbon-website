...
![Example of an export modal in context](images/0.jpg)

<Caption>Example of an export modal</Caption>

![Example of a download modal in context](images/download0.jpg)
...
![Example of an export button on a data table](images/1.jpg)
...
![Example of a download button](images/download1.jpg)
...
![Example of an export modal](images/2.jpg)

![Example of validation errors](images/newimage1.jpg)

<Caption>Validate the edited name's extension.</Caption>

![Example of an export modal in its "Exporting" state](images/3.jpg)
...
![Example of specifying an export location](images/newimage2.jpg)
...
![Example of a passive success modal](images/newimage3.jpg)
...
![Example of an error state modal](images/newimage4.jpg)
...
![Example of a success notification](images/newimage5.jpg)
