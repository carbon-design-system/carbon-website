...
![Example of an API key being generated](images/1.jpg)
...
![Example of a generate button.](images/2.jpg)
...
![Example of a successfully created API key](images/3.jpg)
...
![Example of a hidden API key](images/4.jpg)
...
![Example of a revealed API key](images/5.jpg)
...
![Example of an API key with a custom name](images/6.jpg)
...
![Example of an API key destination selector](images/7.jpg)
...
![Example of a restricted API key generation](images/8.jpg)
