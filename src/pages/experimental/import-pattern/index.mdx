...
If additional actions (e.g. adding metadata) are required to be performed on the file(s) consider whether a it would be more appropriate to use a side panel or full page instead of a modal. 
