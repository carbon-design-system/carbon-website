...
![Example of a text skeleton state in a data table](/images/loading_skeleton.gif)
...
![Example of a dashboard using skeleton states to demonstrate progressive loading.](/images/Progressive-Loading.png)
...
![Example of a large loader in context.](/images/Large-Loader.png)
...
![Example of an inline loader in context.](/images/small-loading.gif)
