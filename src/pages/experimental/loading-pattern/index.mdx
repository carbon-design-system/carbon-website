...
<PageDescription>
  Loading is applied when additional information takes an extended amount of
  time to process and appear on screen. Skeleton states and the loading
  component are two interactions that communicate to users that data is
  currently loading and the screen is not frozen.
</PageDescription>
...
\*\* Caption: Example of a text skeleton state in a data table.
...
\*\* Caption: Example of a dashboard using skeleton states to demonstrate progressive loading
...
\*\* Caption: Example of a large loader in context.
...
\*\* Caption: Example of an inline loader in context.
...
\*\* Caption: Example of 'Load more' button in context.
