...
![Wireframe of a centered login form](images/login-background-Image.jpg)

<Caption>Wireframe of a centered login form</Caption>

![Example of a centered login form](images/login-pattern-example1.jpg)
...
![Example of a centered login form with illustration](images/login-pattern-example2.jpg)
...
![Wireframe of right-sided login form](images/login-split-screen.jpg)

<Caption>Wireframe of right-sided login form</Caption>

![Example of right-sided login form](images/login-pattern-example3.jpg)
...
![Wireframe of login page with product selector](images/login-landing-page-dropdown.jpg)

<Caption>Wireframe of login page with product selector</Caption>

![Example of login page with product selector](images/login-pattern-example4.jpg)
