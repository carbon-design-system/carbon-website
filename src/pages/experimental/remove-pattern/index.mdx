...
![The user enters the resource name in order to confirm deletion.](images/2.jpg)
...
![When the resource name is entered the Delete button is enabled.](images/3.jpg)
...
![Example of a medium impact delete modal](images/6.jpg)
...
![Example of delete options in context without warnings for low impact delete actions](images/LowImpactDelete.jpg)
...
![Example of a medium impact remove modal](images/first-view.jpg)
...
![Example of remove options in context without warnings for low impact remove actions.](images/LowImpactRemove.jpg)
...
![Example of a delete successful modal](images/Requested.jpg)
...
![Example of a remove successful modal](images/DoneMedium.jpg)
...
![Example of a successful delete notification](images/7_updated.jpg)
