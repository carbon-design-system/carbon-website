...
Require user confirmation for high impact removals. Communicate the consequences if the removal is completed, and let the user know if the removal is permanent.
