...
Visit the [Sketch library](https://sketch.cloud/s/ngV7z) page and choose
`Download Document` from the right-side panel.
...
See the [Sketch library](https://sketch.cloud/s/JaVzz/) page for an overview of
the kit.
...
See our [layout guidelines](/guidelines/2x-grid/basics/) for a more detailed
