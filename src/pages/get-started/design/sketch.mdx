...
Visit the [Sketch library](https://www.sketch.com/s/3a3f3f2d-94d7-4c16-8e2e-88ba80a6382e) page and choose `Download Document` from the right-side panel.
...
See the [Sketch library](https://www.sketch.com/s/557b75ff-67d3-41ab-ada5-fa25447218c1) page for an overview of the kit.
...
See our [layout guidelines](/guidelines/2x-grid/overview) for a more detailed walkthrough of the 2x Grid.
...
Carbon [components](/components/overview), [add-ons](/contributing/add-ons), and [icons](/guidelines/icons/library) live in the design kit as Sketch symbols.
