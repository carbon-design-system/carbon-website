...
The Vue library is maintained by members of the Carbon community. For support, contact the [Carbon Vue team](https://github.com/IBM/carbon-components-angular/issues/new).
