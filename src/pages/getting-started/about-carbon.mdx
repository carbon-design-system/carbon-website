...
The Carbon team encourages adoption through better guidance, training, community development, maintenance, and support. The system is primarily maintained by a core team and governed by an executive board of design advisors.
...
**In Experimental, duplicate patterns may exist.** Accompanying guidance may be minimal. Maintainers are not yet identified or committed. Inclusion in the shared library raises awareness and acts as a live audit so people can benefit from the collaboration.
