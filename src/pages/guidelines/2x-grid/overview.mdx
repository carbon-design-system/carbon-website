...
Within a design system, layouts often follow a common structure, especially with
...
content that lives within the responsive grid.
...
![Mini unit is the guide when needed. Spacer snaps to the text box and does not necessarily need to snap to the mini unit.](images/Layout_overview_Visual-rhythm-do.svg)
  ...
  <DoDont type="dont" caption="In Figma, always use Auto height resizing option under Type settings to ensure the text box is fitting with the content.">
