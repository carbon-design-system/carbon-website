...
[grid code package](https://github.com/carbon-design-system/carbon/tree/master/packages/grid)
...
leading section in a webpage, divided section for editorial content, modals, etc.
Check out the [breakpoints table](#breakpoints) for pixel sizings.
