...
Carbon strives to meet [WCAG AA standards](https://www.w3.org/TR/UNDERSTANDING-WCAG20/visual-audio-contrast-contrast.html) across all standard themes in the system, including color contrast ratios.
...
<Column colMd={4} colLg={4} noGutterSm>
<ResourceCard
    subTitle="IBM Accessibility quick guidance (IBM only)"
