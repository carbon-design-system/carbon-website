...
<ResourceCard
    subTitle="Carbon color contrast tool"
...
Refer to the [usage section](/guidelines/color/usage) of the Color guidelines to learn more about color contrast ratios. You can also use this color contrast tool to ensure your ratios pass WCAG AA standards.
