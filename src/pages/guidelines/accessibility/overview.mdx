...
- Carbon color themes adhere to universal color contrast guidelines. The color palette should ensure you avoid contrast issues when used correctly. If you're working in Sketch, we recommend the [Stark](http://www.getstark.co/) plugin.
