...
once it moves to stable in the near future.
...
_For IBMers only_: The chat component Figma library includes design assets,
components, and generals chat usage guidelines.
