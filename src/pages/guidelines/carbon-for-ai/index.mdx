...
title: Carbon for AI
description:
  Carbon for AI is an extension of the Carbon system, designed to give a
  visually and behaviorally distinct identity to AI instances in IBM products.
---

<PageDescription>

Carbon for AI is an extension of the Carbon system, designed to give a visually
and behaviorally distinct identity to AI instances in IBM products.
...
AI-recommended content distinctive and stands for users. To learn more about the
Carbon for AI styling, IBMers can go to
[IBM Design for AI: Style elements](https://w3.ibm.com/w3publisher/design-for-ai/carbon-for-ai/ai-style-elements).
...
unique visual characteristics that distinguishes it as AI while remaining true
to the greater IBM Design Language.
...
comprehensible to humans. IBMers can find more indepth information and guidance
on the topic of explainability at IBM Design for AI: Explainability.
...
**Formerly AI slug:** The AI slug component's name has been updated to AI label
to more accurately reflect the component's usage. This change will also be made
in the coded components in the near future.
...
that can mark these instances as presented in the interface.

#### The AI label provides a consistent visual reference point for AI
...
#### The AI label is a pathway to explainability
...
For more component usage, see the [AI label](/components/ai-label/usage/)
component.
...
**For internal IBM use only.** This chat component is only available to use for
IBM products and it not available through Carbon’s open-source repo.

</InlineNotification>

AI chat is a conversational framework between a user and an AI that can aid in
creating tasks, finding insights, tracking documents, and more. For more
guidance and information on chat IBMer can go to
[IBM Design for AI: Chat pattern](https://w3.ibm.com/w3publisher/design-for-ai/carbon-for-ai/ai-chat-patterns).
...
The chat component Figma library includes design assets, components, and
generals chat usage guidelines. It is only available to IBMers.
...
![AI dropown](images/mini-dropdown.png)
...
When designing an AI experience, ask does the user know AI is being used? The
...
leaving any other comments on GitHub. For IBMers, questions and feedback can be
directed to Slack in the channels
