...
layer 02, and layer 03. After each layer of color added you move up to the next
...
and `icon` work across layer sets. For a full list of the layer set tokens see
the [color usage](/guidelines/color/usage) tab.
