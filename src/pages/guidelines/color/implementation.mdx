...
level are the tiles in the sub-section, this includes the tile background
...
side panel uses an inline Gray 100 theme. This type of inline theme pairing
creates a high contrast moment that adds emphasis and focus to a work flow.
