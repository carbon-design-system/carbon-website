...
![Example of a color mode control](images/ccolor-modes-control.png)
...
**Coming soon:** More guidance and information on how to properly treat
illustrations, images, and pictograms in light or dark mode. For now, checkout
some helpful guidance around this topic on
