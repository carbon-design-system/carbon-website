...
![Layering model](images/color-layering-model-1.png)
...
![Interactive states](images/color-overview-interactive-3.png)
...
![Hover states](images/color-overview-interactive-hover.png)
...
![Active states](images/color-overview-interactive-active-2.png)
...
![Selected states](images/color-overview-interactive-selected-2.png)
