...
![Layering model for light themes](images/color-layering-model-light-2.png)

</Column>
</Row>

<Caption>
  White theme (left) and Gray 10 theme (right) color layering model.
</Caption>

<Row>
<Column colLg={12}>

![Layering model for dark themes](images/color-layering-model-dark-2.png)

</Column>
</Row>

<Caption>
  Gray 100 theme (left) and Gray 90 theme (right) color layering model.
</Caption>
