...
<Caption>
  Light theme layering model example in the shown in the White theme
</Caption>
...
<Caption>
  Dark theme layering model example in the shown in the Gray 100 theme
</Caption>
...
![Gray 10 dropdown on Gray 100 background.](images/Dark_theme_01_new.png)
...
![Dropdown showing incorrect color usage](images/Dark_theme_04_new.png)
...
| Layer       | Any container that sets on top of a background           |
...
Some components have explicit color tokens to be used only with that particular
component. These tokens are called _component tokens_. They are part of the
component packages and not part of the elements package like the core color
tokens. To find the tokens and values across the themes for each the components,
visit their component page.
