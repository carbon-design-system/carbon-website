...
<AnchorLink>Understanding color</AnchorLink>
...
by a set of well-defined rules on how to work with Carbon in the context of dark
and light themes.
...
depth and spacial associations. The layering model defines the logic of how
...
| Term                                                    | Definition                                                                                                                                                                                  |     |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --- |
| [Theme](/guidelines/color/overview/#themes)             | A collection of colors designed to create a specific aesthetic. Themes control the color value assigned to a token. For example, White theme, Gray 10 theme, Gray 90 theme, Gray 100 theme. |     |
| [Token](/guidelines/color/overview/#tokens)             | The role-based identifier that assigns a color. Used instead of a hex code. Tokens apply universally across themes. For example, `$layer`, `$border-subtle`, `$support-error`.              |     |
| [Role](/guidelines/color/overview/#color-roles)         | The systematic usage(s) of a color. Roles cannot be changed between themes.                                                                                                                 |     |
| [Value](/guidelines/color/overview/#interaction-states) | The unique visual attribute (hex code, rgba value) assigned to a token through the use of a theme.                                                                                          |
...
There are two light themes: White and Gray 10. In the light themes, layers
alternate between White and Gray 10. For enabled UI colors light themes
...
<DoDontRow>
  <DoDont caption="Gray 10 dropdown on White background." colLg={4}>

![Gray 10 dropdown on White background.](images/Light_theme_01.png)

  </DoDont>
  <DoDont colLg={4} caption="White dropdown on a Gray 10 background.">
...
<DoDontRow>
  <DoDont colLg={4} caption="White overflow menu on Gray 10 card.">

![White overflow menu on Gray 10 card.](images/Light_theme_03.png)

  </DoDont>
  <DoDont type="dont" colLg={4} caption="Avoid use of midtones.">
...
become one step lighter with each added layer. For enabled UI colors dark themes
primarily uses the color range of Gray 100 to Gray 70.
...
![Gray 10 dropdown on White background.](images/Dark_theme_01_new.png)
  ...
  <DoDont colLg={4} caption="Gray 80 dropdown on Gray 90 background.">
...
![White overflow menu on Gray 10 card.](images/Dark_theme_03_new.png)
  ...
  <DoDont type="dont" colLg={4} caption="Do not apply components that are darker than the background unless using high-contrast mode.">
