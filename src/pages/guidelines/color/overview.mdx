...
attention or create visual tension. Some high contrast moments are backed into
...
and Black sit outside those values. Black text is WCAG 2.0 AA accessible on
colors ranging from 10 to 50. White text is accessible on colors from 60 to 100.
