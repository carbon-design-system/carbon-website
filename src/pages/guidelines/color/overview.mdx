...
![Hover states example](images/color-overview-interactive-hover-3.png)

</Column>
</Row>

<Caption>Enabled color (1) and hover color (2).</Caption>
...
<Caption>Enabled color (1) and active color (2).</Caption>
...
<Caption>Enabled color (1) and selected color (2).</Caption>
...
![Focus states](images/color-overview-interactive-focus-03.png)
