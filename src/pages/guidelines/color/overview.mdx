...
![Gray 10 dropdown on White background.](images/Light_theme_01.jpg)

  </DoDont>
  <DoDont colLg={6} caption="White dropdown on a Gray 10 background.">

![White dropdown on a Gray 10 background.](images/Light_theme_02.jpg)
...
![White overflow menu on Gray 10 card.](images/Light_theme_03.jpg)

  </DoDont>
  <DoDont type="dont" colLg={6} caption="Avoid use of midtones.">

![Avoid use of midtones.](images/Light_theme_04.jpg)
...
![Gray 10 dropdown on White background.](images/Dark_theme_01_new.jpg)

  </DoDont>
  <DoDont colLg={6} caption="Gray 80 dropdown on Gray 90 background.">

![White dropdown on a Gray 10 background.](images/Dark_theme_02_new.jpg)
...
![White overflow menu on Gray 10 card.](images/Dark_theme_03_new.jpg)
...
![Do not apply components that are darker than the background unless using high-contrast mode.](images/Dark_theme_04_new.jpg)
...
![High contrast example in a light theme.](images/High_contrast_01.jpg)

  </DoDont>
  <DoDont colLg={6}>

![High contrast example in a dark theme.](images/High_contrast_02.jpg)
...
![interactive states light](images/Interactive_states_light_new.jpg)

<Caption>Light theme interactive tokens.</Caption>

![interactive states dark](images/Interactive_states_dark_new.jpg)
