...
Respect the users' time and make things quick and easy to read. Always trim back
to as few words as possible, although don't be terse.

Terms of politeness are superfluous, convey the wrong tone for technical
material, and are not regarded the same way in all cultures. Use please in a UI
only when the user is being inconvenienced.
...
Engage your readers by using second person (you, your) where appropriate. Avoid
the first person unless you have a compelling reason to use it. First person (I,
we, our) focuses on the writer rather than the audience, which is rarely
appropriate in UI or technical contexts.
...
customer data, for example “My account” or “My usage.” However, in explanatory
text for the heading or label, switch to second person. For example, “Your usage
is calculated from the 1st day of the month.”

Where appropriate, use first person ("we", "our") to refer to IBM.

For more detailed guidance about pronouns, refer to the
[Pronouns](https://www-03preprod.ibm.com/support/knowledgecenter/ibm_style/pronouns.html)
topic in IBM Style.
