...
[conversational style](https://www-03preprod.ibm.com/support/knowledgecenter/ibm_style/conversational-style.html).
...
"labor hours" or "person hours". Sometimes, you can rewrite a sentence to use
the second person ("you"). For example, instead of writing "The user can now
move his cursor in four directions", write "You can now move your cursor in four
directions". It is also acceptable to use "they" to refer to a singular subject.

If you're not sure about a particular word, you can search the
[IBM Terminology database](http://ibm.biz/termsearch). And anyone at
