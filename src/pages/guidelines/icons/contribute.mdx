...
- Review the
  [icon master file](https://github.com/carbon-design-system/carbon/tree/master/packages/icons/master)
...
4. Select any overlapping shapes and click the Union icon from the top
...
10. Name icon with the `#name--modifier` convention _(i.e._ `copy.svg`,
    `copy--glyph.svg`, `add.svg`, `add--glyph.svg`).
...
Would your icon be useful for other products? If so, please consider
contributing to the design system.

To submit, open an issue with your icon in the Carbon [GitHub repository](https://github.com/carbon-design-system/carbon/tree/master/packages/icons).
