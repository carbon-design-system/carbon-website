---
label: Layout is an important — and often overlooked — part of visual design. Carbon takes a lot of the guesswork out of spacing to help designers deliver clear, functional layouts.
title: Layout
description: Layout is an important — and often overlooked — part of visual design. Carbon takes a lot of the guesswork out of spacing to help designers deliver clear, functional layouts.
tabs: ["Overview", "Code"]
---
...
If you’re using carbon-components there’s no reason to install the layout package separately. See our [get started](/get-started/develop/react) guide to start building.
...
<Row className="resource-card-group">
  <Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      ...
      href="https://github.com/carbon-design-system/carbon/blob/master/packages/layout"
    >
