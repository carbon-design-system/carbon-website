...
<DoDontExample type="do" fullWidth caption="Productive moments are labeled in blue, and expressive moments are labeled in magenta.">
...
<Row>
<Column colLg="12">
<DoDontExample type="do" fullWidth caption="Elements on the screen speed up quickly and slow down smoothly, obeying the physics of a light-weight material.">
...
<Row>
<Column colLg="12">
<DoDontExample fullWidth caption="Do not use easing curves that suggest bounce, stretch, or sudden stops.">
...
<Row>
<Column colLg="8">
<DoDontExample type="do" caption="Duration contrast between a taller and a shorter component.">
