...
<DoDontExample type="do" caption="When removing an item from the grid, thumbnails on the edge existing and re-entering container create a smooth transition.">
...
<Column colLg={4} colMd={4} >
<DoDontExample caption="Thumbnails moving on diagonal paths feels sporadic and harsh.">
...
<Row>
<Column colLg={4} colMd={4}>
<DoDontExample type="do" caption="When sorting or shuffling items on the grid, always using rounded corner paths to visually organize the movements.">
...
<Column colLg={4} colMd={4} >
<DoDontExample caption="Criss cross sorting appears disorganized. Avoid this motion path.">
...
<Row>
<Column colLg={4} colMd={4}>
<DoDontExample type="do" caption="Use motion to reinforce meaning. Affirmative action here triggers a different exit motion for the modal than negation.">
