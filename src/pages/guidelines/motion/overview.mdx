...
The main specifications developers need to code animation are the element,
transformation (move, scale, fade, rotate), duration, delay and motion curve. We
suggest sending an animated prototype or video/gif as well as a detailed motion
specifications chart for your developer.
...
<MdxIcon name="github" />
  ...
  <Column colMd={4} colLg={4} noGutterSm>
    <ResourceCard
      subTitle="Motion Developer Translation"
      href="sketch://add-library/cloud/EXAMPLE"
    >
