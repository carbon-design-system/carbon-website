...
- Ungroup pictogram layers completely. The pictogram should be on the top-most layer in your artboard.
- Make sure to properly name layers and artboards (these names will also be exported into the code).

### Production-ready

To be considered production-ready, all pictogram submissions must be delivered in SVG format at 32 x 32 px.
...
![](images/iconography-contribution-exportsvgfromai.jpg)
