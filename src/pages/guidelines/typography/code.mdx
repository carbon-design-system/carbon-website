...
Type is a core part of any offering. Use the Carbon type package to leverage IBM Plex across your product.

</PageDescription>

<InlineNotification>

If you’re using carbon-components there’s no reason to install the type package separately. See our [get started](/get-started/develop/react) guide to start building.
