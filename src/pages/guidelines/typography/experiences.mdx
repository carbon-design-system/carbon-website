...
<Caption>
  The more compact productive type styles make it easier to scan the IBM website
  mega menu.
</Caption>

\*\* add productive tab image

<Caption>
  The productive tab component keeps content contained and easy to scan.
</Caption>
...
\*\* add product configuration image

<Caption>
  A productive moment on an input form during product configuration facilitates
  focus.
</Caption>
...
<Caption>
  A productive moment on an input form during checkout facilitates focus.
</Caption>

\*\* add filter panel image

<Caption>
  A productive moment in the filter panel keeps information contained and easy
  to scan.
</Caption>
