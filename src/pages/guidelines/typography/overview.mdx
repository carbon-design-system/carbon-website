...
There are two heading sets, and apart from sizing, the major difference between
them is in how they are implemented. Expressive uses a fluid type set and
productive uses fixed headings.

For more detail, see [Experiences](/guidelines/typography/experiences/) and
