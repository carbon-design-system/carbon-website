...
<Column colMd={4} colLg={4} noGutterSm>
  <ResourceCard
    ...
    href="https://github.com/carbon-design-system/plex/releases/latest"
    >
...
Carbon uses the open-source typeface **IBM Plex**. It has been carefully designed to meet IBM's needs as a global technology company and reflect IBM's spirit, beliefs, and design principles. IBM Plex can be accessed and downloaded from the [Plex GitHub Repo](https://github.com/carbon-design-system/plex).
