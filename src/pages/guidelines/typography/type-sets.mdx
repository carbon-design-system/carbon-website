---
label:
  Our two type sets support designers creating experiences for both IBM products
  and IBM.com website pages..
title: Typography
description:
  Our two type sets support designers creating experiences for both IBM products
  and IBM.com website pages.
...
The two IBM type sets support designers creating `expressive` and `productive`
