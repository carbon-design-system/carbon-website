...
together to work as a unified collection in v11. As a result of this
convergence, type token names have been renamed to better define their
relationship to one another and reflect its styling.

<br />
Helpful links: [v10 type tokens](https://v10.carbondesignsystem.com/guidelines/typography/overview)
