...
The small styles are for use with productive and expressive moments and include
...
## Fluid callout styles

These callout styles are part of the expressive set and being fluid, they will
adjust at different breakpoints.

<TypesetStyle typesets="fluidCallouts" breakpointControls={true} />
...
<InlineNotification kind="warning">
  Never use this style as the main headline.
</InlineNotification>

<TypesetStyle typesets="fluidDisplay" breakpointControls={true} />
