...
- pair `body-short-01` with the `heading-short-01`
- pair `body-long-01` with the `heading-long-01`
...
- pair `body-short-02` with the `heading-short-02`
- pair `body-long-02` with the `heading-long-02`
...
<Caption>
  ...
  and distinction and hierarchy with a blend of expressive and productive type
  styles.
</Caption>
