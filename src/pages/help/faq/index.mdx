...
breaking changes while staying on the current major version. They are currently
available on the Component Overview page under
the [Feature flags](https://carbondesignsystem.com/components/overview/feature-flags/)
tab.
