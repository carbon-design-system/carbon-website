...
the [IBM Design Language libraries](/resources#color-grid-and-icons).
...
Head over to [Design kits](/designing/kits/sketch) to
...
[motion standards](/guidelines/motion/basics), designed to bring unity and
cohesion to all motion in a user interface. All interactions that include motion
should abide by these standards.

### Layout, grid, and spacing

Carbon v10 uses the 16 column [2x Grid](/guidelines/2x-grid/overview). Carbon v10
