...
Use this template for documenting components with only one type, that is, no variants. You can see this template in use for [Accordion](https://www.carbondesignsystem.com/components/accordion/usage) and [Checkbox](https://www.carbondesignsystem.com/components/checkbox/usage).
...
Use this template for documenting components that have multiple types or variants. You can see this template in use for [Dropdown](/components/dropdown/usage), [Modal](/components/modal/usage), and [Notification](/components/notification/usage).
