...
These guidelines are to help you prepare a complete and comprehensive pattern
for submission to the IBM Design System. Depending on the pattern, you may need
to make some adjustments to the structure but your pattern should cover all of
the aspects outlined below.

We've also created a
[Markdown file](https://github.com/carbon-design-system/carbon-website/blob/master/docs/pattern-template.mdx)
that includes this guidance. Alternatively, you can provide your content to us
in a Box note.
