...
If there are variations that support different use cases, include those here with corresponding explanations and visuals. Be sure to explain the reasons for using one pattern over another.
...
Include any citations for research, books, and articles you found helpful. These help designers understand your decisions.
