...
| ------------------------------------ | ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Figma](/designing/kits/figma)       | Beta available – _IBMers only_ | The v11 Figma updates are available as new libraries. Teams need to swap out assets from v10 to v11 assets. The v10 Figma files will not receive a continuous update and will remain permanently on v10. Expected external release at then end of Q3 2022.                                                             |
