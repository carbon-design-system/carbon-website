...
![Example of layering token (left) versus contextual layering tokens (right).](images/color-implementation-compare-1.png)

</Column>
<Column colMd={6} colLg={6}>

![Example of layering token (left) versus contextual layering tokens (right).](images/color-implementation-compare-2.png)
