...
| [Figma](/designing/kits/figma)       | Expected release in May 2022 | The same Figma libraries that were used in v10 will be updated to include the v11 changes. Do not accept the library update until you are ready to work in v11.           |
