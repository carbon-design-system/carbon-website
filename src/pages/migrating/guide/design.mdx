...
and reflect its styling. For more information, see the
[Typography page](/guidelines/typography/styling-strategies).
...
For more information, see Carbon's [color overview](/guidelines/color/overview/)
guidance.
...
For more information, see Carbon's
[color implementation](/guidelines/color/implementation) guidance.
