...
token names have been renamed to better define their relationship to one another
and reflect its styling. For more information on the evolution of productive and
express, see the [Typography page](/guidelines/typography/styling-strategies).
