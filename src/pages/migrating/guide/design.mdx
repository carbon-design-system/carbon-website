...
Text and Color style migration:

1. Swap the library from v10 to v11.
2. Open the library panel.
3. Select the v10 library.
4. Click the `Swap library` button.
5. Take a screenshot of the styles that didn't swap.
6. Visit the v11 text or color styles file in IBM Design Systems.
7. Duplicate the file and move it to your team's space.
8. Rename the duplicate file to a temporary name.
9. Change the names of the text or color styles that didn't swap in Step 5 to
   match the name and organization of v10.
10. Swap to this temporary library.
11. Update the names back to v11.
12. Swap to the actual v11 library.
13. Check nested components for text style overrides.
