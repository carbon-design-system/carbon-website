...
See Carbon's guidance below for more information:

<Row className="resource-card-group">
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="Color tokens overview"
    href="https://v11.carbondesignsystem.com/guidelines/color/overview/#tokens">
...
<Column colLg={4} colMd={4} noGutterSm>
  <ResourceCard
    subTitle="Color implementation"
    href="https://v11.carbondesignsystem.com/guidelines/color/implementation">
