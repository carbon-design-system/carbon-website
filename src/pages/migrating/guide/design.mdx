...
| ------------------------------------ | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Sketch](/designing/kits/sketch)     | Update available                  | The same Sketch Cloud libraries that were used in v10 have been updated to include the v11 changes. Do not accept the library update until you are ready to work in v11. There is a new [v10 library](https://v10.carbondesignsystem.com/designing/kits/sketch#get-the-kit) available for teams that still need it. |
| [Figma](/designing/kits/figma)       | Expected release end of June 2022 | The v11 Figma update will be available as new libraries. Teams will need to swap out assets from v10 for v11 assets. The v10 Figma files will not receive a continuous update and will remain permanently on v10.                                                                                                   |
