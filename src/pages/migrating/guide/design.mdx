...
| ------------------------------------ | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Figma](/designing/kits/figma)       | White Theme Beta update available. Expected release of all themes is end of July 2022 | The v11 Figma update will be available as new libraries. Teams will need to swap out assets from v10 to v11 assets. The v10 Figma files will not receive a continuous update and will remain permanently on v10.                                                                                                       |
