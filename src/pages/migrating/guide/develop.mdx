...
_Note: if you see any references to `@carbon/styles` for style imports, you can
safely replace the beginning of the path with `@carbon/react` for the same
import in this package._
...
_Note: the default size in v11 is `md` (`40px`)._
