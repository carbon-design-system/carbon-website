...
| -------------------------- | ------------------------------------- | ---------------------------------------- | --------------------------------------------------------------------------------------- |
| `@carbon/react`            | <Tag type="cyan">Breaking</Tag>       | [Components](#components-breaking)       | `@carbon/react` `carbon-icons` `carbon-components`                                      |
...
| `@carbon/react`            | <Tag type="red">Deprecated</Tag>      | [Components](#components-breaking)       |                                                                                         |

## Components <Tag type="cyan">Breaking</Tag>

We have deprecated `@carbon/react`, `carbon-icons` and `carbon-components` in
favor of our new package `@carbon/react`. All of the component usage and API
remains the same. The big change with this is to avoid having to install three
separate packages that you have to keep in sync.
...
```
npm uninstall carbon-components @carbon/react carbon-icons
```

```
yarn remove carbon-components @carbon/react carbon-icons
```
