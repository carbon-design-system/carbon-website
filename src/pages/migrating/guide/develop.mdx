...
<AnchorLink>
  Migrating an app using Angular, Svelte, Vue, etc. MISSING!
</AnchorLink>
<AnchorLink>Migrating a library MISSING!</AnchorLink>
...
codemod [above](#step-4:-update-icon-sizes-and-imports) will make short work of
these changes.
