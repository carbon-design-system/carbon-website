...
update until you are ready to work with v11. We have created separate v10
libraries due to team migration preferences. If you are still on v10, migrate to
the v11 libraries when you are ready to do so.

#### Figma

All v11 theme libaries are now available in Figma to IBM's internal users and
the public community. We have leveraged Figmas latest features in this release
which may result in breaking changes to some of our components. Like with
Sketch, we have separate v11 and v10 libraries due to team migration
preferences. If you are still on v10, migrate to the v11 libraries when you are
ready to do so.
