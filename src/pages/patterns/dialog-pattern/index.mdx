...
3. **Actions:** The main actions needed to complete or cancel the modal task. Button groupings change based on modal variant.
...
3. **Actions:** Contains any action needed to preform the dialog task. Content varies based on dialog type.
