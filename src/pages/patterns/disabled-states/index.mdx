...
![Default disabled example on the right](images/disabled-1.jpg)
...
![Default disabled style examples](images/disabled-2.jpg)
...
![Additional warning with default disabled example](images/disabled-3.jpg)
...
![Example of hidden disabled content on the right](images/disabled-4.jpg)
