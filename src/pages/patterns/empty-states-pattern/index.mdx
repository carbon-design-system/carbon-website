...
In situations where there could be multiple empty states showing at once, we recommend using a tertiary button for the call to action. This is in order to avoid scenarios with multiple primary action buttons in the UI.
