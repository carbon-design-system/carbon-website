...
| _Multiple categories_                   | The user has the option to select attributes within multiple data categories.   |
| _Multiple filters with batch updates_   | The user initiates the filtering after they have selected multiple filters.     |
