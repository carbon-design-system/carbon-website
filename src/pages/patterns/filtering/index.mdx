...
![Example of a single selection filter in an inline dropdown](images/filter-1.jpg)
...
![Example of a milti-selection filter in a checkbox set](images/filter-2.jpg)
...
![Example of multiple filter categories](images/filter-3.jpg)
...
![Example of batch filtering](images/filter-4.jpg)
...
![Example of hidden filters not applied](images/filter-5.jpg)
...
![Example of hidden filters applied](images/filter-6.jpg)
...
![Filter reset example](images/filter-7.jpg)
