...
Use a multiselect filter when the user has the option to pick more than one attribute to modify the data results. Under the hood, multiselects behave like [checkboxes](components/checkbox/usage). Types of multiselect filters include:
