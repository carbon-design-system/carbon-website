...
| Key term          | Definition                                                                                                                                                                                                                                                                    |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Fixed width       | The width of an element is set to a specific value and does not change as the browser resizes.change.                                                                                                                                                                         |
...
container. Fluid buttons cannot ever be embedded in the middle of a flow/layout.
They must hug at least on edge of a container. Use fixed buttons if additional
...
64px spacer to the right. Only the left side of the button aligns to the grid.
Additionally, there is a hybrid scenario where a default-style button can span a
designated number of columns on the responsive column grid, giving it a fluid
width. For more guidance on default versus fluid buttons, see the
...
guidance on fixed versus fluid forms, see the
...
- Default and fluid components can be used together in certain hybrid scenarios.
  The most common is pairing is default input components, with fluid buttons in
  a contained form, like a modal or side panel.
