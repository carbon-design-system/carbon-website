...
| [Combobox](components/combobox/usage)           | To select a single item (with typeahead functionality from a longer list | Choosing a state, country or language preference                         |
| [Multiselect](components/multiselect/usage)     | To select multiple items from a longer list                              | Add a product example for MultiSelect                                    |
...
| [Time picker](components/time-picker/usage)   | To input time in hours/minutes                                          | Scheduling meetings and travel times               |
...
<Caption>
  \* A dialog form would normally have a minimum of two buttons.
</Caption>
