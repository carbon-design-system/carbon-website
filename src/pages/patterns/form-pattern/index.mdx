...
![Do consider multi-step forms when faced with](images/do_placeholder.png)
...
![Do not overload the user with too many input controls](images/dont_placeholder.png)
