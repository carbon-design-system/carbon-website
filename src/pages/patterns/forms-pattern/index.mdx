...
![Basic form with anatomy callouts](/images/Elements.jpg)
...
![Example of labels](/images/labels.jpg)
...
![Example of input field with optional label](/images/optional_v_mandatory.jpg)
...
![Example of text input types](/images/Text_inputs.jpg)
...
![Example of selection controls](/images/Selection_controls.jpg)
...
![Example of bound entry controls](/images/Bound_entry_controls.jpg)
...
Tooltips can be very useful for providing additional explanation to users that may be unfamiliar with a particular form field. They can also offer rationale for what may seem like an unusual request. However, [research suggests](https://www.nngroup.com/articles/tooltip-guidelines/) that users should not have to dig around for a tooltip to access information that’s essential for the completion of their task.
...
![Tooltip appears on hover (desktop) and on click (tablet and mobile).](/images/Tooltip.jpg)
...
![Input field with help text](/images/Help_text.jpg)
...
![Example of input field alignment](/images/Help_text_alignment.jpg)
...
![Example of placeholder text](/images/Placeholder_text.jpg)
...
![Example of dedicated page forms](/images/dedicated_pg_buttons.jpg)
...
![Dialog and side-panel forms](/images/dialog_and_panel_buttons.jpg)
...
![Do arrange primary and secondary buttons at the bottom of the form](./images/do_bottom_buttons.jpg)
...
![Do not top align primary and secondary action buttons in your layouts](./images/do_not_top_align_buttons.jpg)
...
![Do use task-specific language in your buttons](./images/Content_do.jpg)
...
![Do not use vague language to describe an action](./images/Content_do_not.jpg)
...
![Example of client-side error message](/images/Inline_error_message.jpg)
...
In-line editing enables users to edit form text in situ instead of taking users to another page to edit their entry. This saves users from having to refresh the whole form in order to make an edit.
...
![Example of progressive disclosure](/images/progressive_disclosure.jpg)
...
[Research suggests](https://www.lukew.com/ff/entry.asp?1190) that accordion forms can greatly enhance completion speed and page load times. However the same research also suggests that confusion can arise for users when it comes to primary action buttons and whether they apply only to sections vs. the full form.
...
![A multi-step form with a horizontally oriented progress indicator.](/images/horiztonal_prog_indicator.jpg)
...
![A multi-step form with a vertically oriented progress indicator.](/images/vertical_prog_indicator.jpg)
...
![Example of form spacing](/images/form_spacing.jpg)
...
![Do consider multi-step forms when faced with](images/do_multi_step_form.jpg)
...
![Do not overload the user with too many input controls](images/do_not_columns.jpg)
