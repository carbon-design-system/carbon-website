...
A global navigation is always present in the UI. In this example, the [UI shell header](https://www.carbondesignsystem.com/components/UI-shell-header/code) is used as a global navigation with two system level links (A) in the header and four system level links in the switcher.
...
<Caption>
  The global header in this example contains both product and system navigation
  elements.
</Caption>
