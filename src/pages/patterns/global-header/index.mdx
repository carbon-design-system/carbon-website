...
The global header is essential to a product’s UI. Similar to the menu bar in macOS, it represents the structure of a system and allows access to areas and system functions. This pattern aims to answer the foundational questions to how the UI Shell components can be used for product navigation, align on terms, and introduce techniques to achieve consistency in products.

### Header and panel persistence

Global and local describes the location and persistence of header elements in your UI.
...
| Local       | A local navigation exists in a product's context and provides the means to accomplish product level processes. Local elements may differ, sometimes dramatically, from one product to another.                                   |
...
| **Local persistence**  | Detailed system-wide settings, such as user rights management, notification preferences.                                                           | Commenting in a text doc, navigating from one peer resource to another (for example from one container, data base, or document to another), selecting modalities within your product.            |
