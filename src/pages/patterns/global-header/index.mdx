...
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Global      | A global UI element is preset everywhere in your UI. It contains system and product items your user may need at any time: navigation, authentication, notifications, and more. Global elements remain consistent from one context to another. |
...
[Breadcrumbs](https://www.carbondesignsystem.com/components/breadcrumb/code) let your user see where they are in the hierarchy of the application and gives users a way to navigate back up.
