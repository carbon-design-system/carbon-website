...
A global navigation is always present in the UI. In this example, the [UI shell header](https://www.carbondesignsystem.com/components/UI-shell-header/usage) is used as a global navigation with two system level links (A) in the header and five system level links in the switcher.
...
[Breadcrumbs](/components/breadcrumb/usage) let your user see where they are in the hierarchy of the application and gives users a way to navigate back up.
