...
![Example of a text skeleton state in a data table](images/skeleton.jpg)
...
![Example of a progress indicator in an application](/images/larger-loader.jpg)
...
![First phase of a dashboard using skeleton states to demonstrate progressive loading](/images/prog-loading-1.jpg)
...
![Second phase of a dashboard using skeleton states to demonstrate progressive loading](/images/prog-loading-2.jpg)

</Column>
<Column colLg={4}>

![Third phase of a dashboard using skeleton states to demonstrate progressive loading](/images/prog-loading-3.jpg)
...
![Example of Load more](/images/load-more.jpg)
