...
Logging in to a product, property, or system is a fundamental interaction users encounter whenever access to those resources is based on their identity.
...
This guidance describes three variants of login pattern: A discrete page login; a modal dialog login, and a menu item login.
...
<tbd> other than that which lives in my head :)
