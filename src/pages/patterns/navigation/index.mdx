...
Some users may use a keyboard to navigate your site. Starting focus in the main nav lets them quickly get to another area in your UI, but could block them from the main content if there is a large number of nav items to tab through first.
...
Landmark regions let users navigating with assistive technologies quickly get around your site by navigating between sections of your site rather than each individual elements.
