...
Navigating between sites or platforms is made easy through the app switcher. The items and order of a global navigation should remain unchanged when switching between these different sites.
...
<Caption>The header links assuming the role of global navigation.</Caption>
