...
description:
Read-only states are applied to components that users can review but not modify. Read-only states limit or completely remove a component’s interactive functions.
---
