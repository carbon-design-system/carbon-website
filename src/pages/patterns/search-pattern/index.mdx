...
![Anatomy of a basic search](/images/anatomy.jpg)
...
![Provide useful placeholder text and include a search icon](./images/2_do.jpg)
...
![Don't include a label for search fields.](./images/2_dont.jpg)
...
![Flip the layout of the search box for languages that read right to left instead of left to right](./images/do_hebrew.jpg)
...
![Flip the layout of the search box for languages that read right to left instead of left to right](./images/dont_hebrew.jpg)
...
![Example of a scope filter on a search field](/images/5.jpg)
...
![Example of basic search](/images/basic_search.jpg)
...
![Example of recent search suggestions](/images/6.jpg)
...
![Example of type-ahead suggestions](/images/7.jpg)
...
![Example of an active search field](./images/active_search.jpg)
...
![Example of an active search field](./images/11.jpg)
...
![Example of focused search](/images/focused_search_full.jpg)
...
![Example of focused search](/images/11_focused_search.jpg)
