...
1. **Text entry field:** Where a user enters their search query.
1. **Placeholder text:** Short phrase, hinting at what the user can search for. 
...
<Caption>
  Example of a search box for languages that read right to left
...
<Caption>The search icon is recognized and acceptable across languages and countries.</Caption>
...
If you are using active search for a catalog or library, don't show a panel below the search field. The items on the page should update as the user enters and refines their search.
