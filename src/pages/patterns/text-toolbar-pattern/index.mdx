...
**Note:** Some concepts included in this pattern, like searching key words, are not available for production use. This guidance reflects our current understanding of these topics. This pattern is currently open for Code contributions.
