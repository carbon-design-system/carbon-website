...
<AnchorLink>When to use text toolbars</AnchorLink>
...
- Attach files or embedding links within text.
...
The typeface and type size menus adopt the [dropdown](https://www.carbondesignsystem.com/components/dropdown/usage/#dropdown) component style. The user can easily choose any typeface and type size to customize their text.
...
The text color and paragraph alignment controls open a menu that display different options to choose from.
...
Key words can be searched within the text area.

<Row>
<Column colLg={8}>

![Searching text key words.](/images/text-toolbar-search-flow.png)
...
![Search key word matches within the text area.](/images/text-toolbar-search-highlight.png)
...
| sm         | A compact two row view displaying common editing functionality with collapsed controls in an overflow menu.    |
