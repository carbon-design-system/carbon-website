...
To use Sketch libraries you must have the **most recent version** of [Sketch](https://www.sketchapp.com/) installed. If you're new to the design kit, visit the [Get started](/get-started/design/sketch) guide.
