...
```javascript path=src/app/tutorial-header/tutorial-header.module.ts
...
<!-- prettier-ignore-start -->
```javascript path=src/app/tutorial-header/tutorial-header/tutorial-header.component.spec.ts
...
<!-- prettier-ignore-start -->
```javascript path=src/app/tutorial-header/tutorial-header.module.ts,src/app/tutorial-header/tutorial-header/tutorial-header.component.spec.ts
...
<!-- prettier-ignore-start -->
```html path=src/app/tutorial-header/tutorial-header/tutorial-header.component.html
...
<!-- prettier-ignore-start -->
```javascript path=src/app/app.module.ts,src/app/app.component.spec.ts
...
```scss path=src/app/app.component.scss
.main {
  margin: 40px 0 0 -7px;
}
```
...
```html path=src/app/tutorial-header/tutorial-header.component.html
...
<!-- prettier-ignore-start -->
```scss path=src/app/repositories/repo-page/repo-page.component.ts
@import "~carbon-components/scss/globals/scss/typography";
