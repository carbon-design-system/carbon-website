...
```bash
git fetch upstream
git checkout -b angualr-step-2 upstream/angular-step-2
```
...
├── tutorial-header-routing.module.ts
...
##### src/tutorial-header/tutorial-header.module.ts, src/tutorial-header/tutorial-header/tutorial-header.component.spec.ts
...
##### src/app/app.module.ts, src/app/app.component.spec.ts
...
##### src/home/home.module.ts, src/home/landing-page/landing-page.component.spec.ts
...
##### src/repositories/repositories.module.ts, src/repositories/repo-page/repo-page.component.spec.ts
