...
The Angular tutorial is maintained by members of the Carbon community. For support, contact the [Carbon Angular team](https://github.com/carbon-design-system/carbon-tutorial-angular/issues/new).
