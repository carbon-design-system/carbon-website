---
title: 3. Using APIs
tabs: ['Overview', '1', '2', '3', '4', '5', 'Wrapping up']
---
...
This tutorial has an accompanying GitHub repository called [carbon-tutorial](https://github.com/carbon-design-system/carbon-tutorial) that we'll use as a starting point for each step. If you haven't forked and cloned that repository yet, and haven't added the upstream remote, go ahead and do so by following the [step 1 instructions](/tutorial/react/1#fork-clone--branch).
...
You should see something similar to where the [previous step](/tutorial/react/2) left off. Stop your app with `CTRL-C` and let's get everything installed.
...
_Note: Having issues running the CI check? [Step 1](</tutorial/react/1#continuous-integration-(ci)-check>) has troubleshooting notes that may help._
...
_Note: Having issues pushing your changes? [Step 1](/tutorial/react/1#git-commit-and-push) has troubleshooting notes that may help._
