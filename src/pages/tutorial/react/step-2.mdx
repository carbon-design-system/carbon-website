...
Now that we have a React app using the UI Shell, it's time to build a few
...
**Note:** You may be wondering where `core-js`came from because it's not a Carbon package and we haven't explicitly installed it. Run `yarn why core-js` and you'll see there are a number of packages that have brought it in as a dependency.
...
![Landing page grid](../shared/step-2/images/landing-layout.jpg)
...
![Banner vertical spacing](../shared/step-2/images/landing-r1-spacing.jpg)
...
![Banner heading type](../shared/step-2/images/landing-r1-type.jpg)
...
![Row 2 vertical spacing](../shared/step-2/images/landing-r2-spacing.jpg)
...
![Row 3 vertical spacing](../shared/step-2/images/landing-r3-spacing.jpg)
...
Then, let's create the `RepoTable` component and export it at the very bottom of `RepoTable.js`.
...
**Note:** Having issues running the CI check? [Step 1](</tutorial/react/step-1#continuous-integration-(ci)-check>) has troubleshooting notes that may help.
...
**Note:** Having issues pushing your changes? [Step 1](/tutorial/react/step-1#git-commit-and-push) has troubleshooting notes that may help.
