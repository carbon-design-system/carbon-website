...
```
**Note:** 
If you are using a **Lite account** the cf/cli won't be able to target thre default org, in this case you should use the **ibmcloud/cli**, here is the [ibmcloud/cli installation page](https://cloud.ibm.com/docs/cli?topic=cloud-cli-getting-started).
