...
The Vue tutorial is maintained by members of the Carbon community. For support, contact the [Carbon Vue team](https://github.com/carbon-design-system/carbon-tutorial-vue/issues/new).
