...
1. Complete steps 1 through 5 of the Vue Carbon tutorial
   - Step 1. [Installing Carbon](/tutorial/vuew/step-1)
   - Step 2. [Building pages](/tutorial/vuew/step-2)
   - Step 3. [Using APIs](/tutorial/vuew/step-3)
   - Step 4. [Creating components](/tutorial/vuew/step-4)
   - Step 5. [Deploying to IBM Cloud](/tutorial/vuew/step-5)
...
3. Complete the [badge application](/tutorial/vuew/wrapping-up#application)
