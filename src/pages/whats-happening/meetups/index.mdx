...
description:
  ...
  Find meetups for learning what’s new, tips and tricks, and leveling up your
  skills.
---
...
Find meetups for leveling up your skills, connecting with your peers, and
getting reviews on work in progress.
...
Join us to share, or come along to see other work in progress and learn that
way. For details, message
[Eliad Moosavi](https://ibm-studios.slack.com/archives/DU4G3QEKC).
...
_For IBMers only:_ A monthly meeting for developers in IBM product teams to come
together with other Carbon developers and designers. Talk through questions,
challenges, and share ideas for building products with Carbon. All topics
welcome.
