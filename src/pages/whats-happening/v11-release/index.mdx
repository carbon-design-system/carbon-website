...
description:
  ...
  and developers, and with no brand updates, you can update at your convenience.
---

<PageDescription>

The Carbon v11 release includes great quality of life updates for designers and
developers, and with no brand updates, you can update at your convenience.

</PageDescription>

<InlineNotification>

**Note:** The Carbon v11 release is currently an alpha release. Be on the
...
- We recommend updating as soon as possible to take advantage of v11’s features
- Assets that are deprecated in v10 will remain in v11 and will be removed in
  v12.

  ### What's breaking

  - For teams on v10, there are some things that will require your attention.
    For details about what's breaking, see
    [GitHub](https://github.com/carbon-design-system/carbon/tree/main/docs/migration).
  - Also, see our
    [April update](https://medium.com/carbondesign/carbons-2021-release-april-update-9d23242b3dea)
    for more information about what you can do to prepare ahead of time.
