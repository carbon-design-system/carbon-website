...
- No need to rebuild your UI
- Tokens that are changing will continue to work in v1
- There's no rush to update if what you have today works for you
...
### What is the rule for supporting deprecated things?

- Things that were deprecated from v9 to v10 will be removed in v11.

* Things that are deprecated in v10 will remain in v11 and will be removed in
  v12.
...
* Teams will need to update their Sass dependency since `node-sass` has been
  deprecated. They will also need to update how they bring in Carbon.
